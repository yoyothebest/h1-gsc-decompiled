...
_id_1241( var_0, var_1 )
{
    ...
    var_3 = "";
    var_4 = "";
    var_5 = _func_297( var_0, "zone_names", "zone_names;reverb_names;filter_names;occlusion_names;timescale_names;dynamic_ambience_names;components;loop_defs;whizby_preset_names;mix_names;healthfx_params" );
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        for ( var_7 = 1; var_7 < var_6; var_7++ )
        {
            ...
            var_3 = _func_298( var_0, 0, "zone_names", var_7, var_5[0], var_5[1] );
...
_id_123F( var_0, var_1 )
{
    ...
    var_6 = level._id_055B._id_25B3._id_0327["zone"].size;
