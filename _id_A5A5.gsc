...
_id_A05F( var_0 )
{
    ...
    {
        if ( var_1 == var_6 - 1 )
            var_5[var_5.size] = _func_0B5( var_0[var_1], var_0[var_1 + 1] );
...
new_color_being_set( var_0 )
{
    ...
    if ( isdefined( self._id_79E6 ) )
    {
        self._id_250C = level._id_250D[self._id_04A7][self._id_79E6];
...
_id_70CA( var_0 )
{
    ...
    level._id_0318 _id_A5A4::_id_69C4( level._id_78B9[var_0] );
...
_id_05CC( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        if ( isdefined( level._id_0349 ) && level._id_0349 || isdefined( level._id_034A ) && level._id_034A )
        {
            if ( _func_120( var_6, "southpaw" ) || var_5 && _func_120( var_6, "legacy" ) )
                return var_4;
            else
                return var_3;
        }
        else if ( _func_120( var_6, "southpaw" ) || var_5 && _func_120( var_6, "legacy" ) )
            return var_2;
        else
            return var_1;
    }
...
_id_05CD( var_0, var_1 )
{
    ...
    level._id_24EC _meth_80CC( var_3 );
}
...
_id_48FB( var_0 )
{
    level._id_0318 notify( "HintDisplayHandlerEnd" );
    level._id_0318 endon( "HintDisplayHandlerEnd" );
    level._id_0318 _id_A5A4::_id_32E4( "global_hint_in_use" );
    level._id_0318 _id_A5A4::_id_32E0( "global_hint_in_use" );

    while ( level._id_0318 _id_A5A4::_id_32D8( "global_hint_in_use" ) )
    {
        if ( !level._id_0318 common_scripts\utility::_id_5064() && isdefined( level._id_48D2[var_0]["pc"] ) )
            level._id_24EC _meth_80CC( level._id_48D2[var_0]["pc"] );
        else
        {
            var_1 = _func_096();

            if ( _func_120( var_1, "southpaw" ) && isdefined( level._id_48D2[var_0]["southpaw"] ) )
                level._id_24EC _meth_80CC( level._id_48D2[var_0]["southpaw"] );
            else
                level._id_24EC _meth_80CC( level._id_48D2[var_0]["gamepad"] );
        }
...
_id_8514( var_0 )
{
    ...
    var_5._id_0501 = "middle";
    var_5._id_0198 = 0;
    var_5._id_01EB = 1;
    var_5 _meth_80CC( var_0._id_8F53 );
    var_5.alpha = 0;
    var_5 _meth_8086( var_1 );
    var_5.alpha = var_3;
    _id_490E( var_1 );

    for (;;)
    {
        var_5 _meth_8086( var_2 );
        var_5.alpha = var_4;
        _id_490E( var_2 );
...
lerp_player_view_to_tag_smoothly_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_8 = self _meth_8184( var_1 );
    var_9 = self _meth_8185( var_1 );
    var_10 = var_0 _id_A5A4::lerp_player_view_to_position_leave_linked( var_8, var_9, var_2, var_3, var_4, var_5, var_6, var_7 );
    var_0 _meth_807F( self, var_1, var_3, var_4, var_5, var_6, var_7 );
    var_10 delete();
}
...
_id_5698( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_9 = self _meth_8184( var_1 );
    var_10 = self _meth_8185( var_1 );
    var_0 _id_A5A4::_id_5693( var_9, var_10, var_2, var_3, var_4, var_5, var_6, var_7, var_8 );

    if ( var_8 )
        return;

    var_0 _meth_807E( self, var_1, var_3, var_4, var_5, var_6, var_7, 0 );
}
...
_id_569A( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_0 _meth_807F( self, var_1, var_3, var_4, var_5, var_6, var_7, 0 );
}
...
_id_9724( var_0 )
{
    if ( isdefined( self._id_0199 ) )
    {
        var_1 = anglestoforward( var_0.angles );
        var_0._id_02E2 += var_1 * self._id_0199;
    }

    if ( isdefined( self._id_037B ) )
    {
        var_2 = anglestoright( var_0.angles );
        var_0._id_02E2 += var_2 * self._id_037B;
    }

    if ( isdefined( self._id_04E0 ) )
    {
        var_3 = anglestoup( var_0.angles );
        var_0._id_02E2 += var_3 * self._id_04E0;
    }

    if ( isdefined( self._id_A3B4 ) )
        var_0 _meth_82B6( self._id_A3B4 );

    if ( isdefined( self._id_6854 ) )
        var_0 _meth_82B5( self._id_6854 );

    if ( isdefined( self._id_759B ) )
        var_0 _meth_82B7( self._id_759B );
}
...
_id_2FE4( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        wait 0.05;
        var_9 = level._id_0323[0];

        foreach ( var_11 in level._id_0323 )
        {
            if ( _func_0F0( var_9._id_02E2, self._id_02E2 ) > _func_0F0( var_11._id_02E2, self._id_02E2 ) )
                var_9 = var_11;
        }

        var_13 = anglestoforward( self.angles );
        var_14 = _func_114( var_9._id_02E2 - self._id_02E2 );
        var_15 = _func_0F6( var_13, var_14 );
        var_16 = _func_0F0( self._id_02E2, var_9._id_02E2 );
        var_17 = var_16;

        if ( isdefined( var_4 ) )
        {
            var_18 = common_scripts\utility::_id_3F33( var_9._id_02E2, var_4 );
            var_17 = _func_0F0( var_18._id_02E2, var_9._id_02E2 );
        }
...
_id_8E78()
{
    ...
    {
        if ( _func_0CE( level._id_78AC["generic"]["DRS_run"] ) )
...
_id_2FE2( var_0 )
{
    ...
    switch ( var_0 )
    {
        case "sprint":
            ...
            if ( _func_0CE( level._id_78AC["generic"]["DRS_sprint"] ) )
        ...
        case "jog":
            ...
            {
                if ( _func_0CE( level._id_78AC["generic"]["DRS_combat_jog"] ) )
...
_id_3BC5()
{
    return _func_0BC( getdvar( "g_speed" ) );
}

_id_3BC6( var_0 )
{
    _func_0D6( "g_speed", _func_0BC( var_0 ) );
}

_id_3BC1()
{
    return level._id_0318 _meth_83F2();
}

_id_3BC2( var_0 )
{
    level._id_0318 _meth_83F3( var_0 );
}
...
_id_115D()
{
    ...
    notifyoncommand( "autosave_player_nade", "+smoke" );
    common_scripts\utility::_id_0D13( level._id_0323, ::_id_1159 );
}
...
_id_115C()
{
    ...
    {
        if ( isdefined( var_2._id_0142 ) && _func_1AD( var_2._id_0142 ) )
            return;
    }
...
_id_2D7B( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_0._id_03CB += var_5 * var_1;
        wait 0.05;
        var_0._id_03CB *= ( 1 - var_2 );
    }
}
...
_id_9AD8( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self._id_7676 ) )
            self._id_02E2 = self._id_7676._id_02E2 + ( 0, 0, var_3 );
        else
            self._id_02E2 = var_0 _meth_80AA() + ( 0, 0, var_3 );
...
{
    var_1 = spawnstruct();
    precachemodel( var_0._id_029C );
    var_1._id_948C = var_0._id_029C;
    var_1._id_02E2 = var_0._id_02E2;
    var_1.angles = var_0.angles;
    var_1._id_0398 = var_0._id_0398;
    var_1._id_7A26 = var_0._id_7A26;
    var_1._id_04A6 = var_0._id_04A6;
    var_1._id_04A4 = var_0._id_04A4;
    var_1._id_0117 = var_0._id_0117;
    var_1._id_7A7E = var_0._id_7A7E;
    var_0 _id_A5A4::_id_6EBA( var_0._id_0117 );
...
_id_20CB( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_4 = undefined;
        var_5 = _func_1D3( var_1 );

        for ( var_6 = 0; var_6 < var_5.size; var_6++ )
        {
            var_7 = _func_0EE( var_1[var_5[var_6]]._id_9C42["origin"], var_0 );
    ...
    var_5 = _func_1D3( var_1 );
    var_4 = var_1[var_5[0]];
    var_2 = _func_0EE( var_4._id_9C42["origin"], var_0 );
...
_id_62F4( var_0 )
{
    ...
    _func_104( "script_objective: objective %d, leveltime %d, deltatime %d", var_0, var_1, var_2 );
}
...
_id_5CD7( var_0 )
{
    if ( _id_A5A4::_id_5016() )
    {
        ...
        var_1 = _id_3DB8();
        var_2 = var_1;
        _func_104( "script_level: leveltime %d, deltatime %d, success %d", var_2, var_1, var_0 );
    }
}

_id_3DB8()
{
    return _func_101() * 0.05;
}
