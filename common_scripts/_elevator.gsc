    ...
    for (;;)
    {
        if ( self._id_3387 == "[A]" )
        {
            if ( level._id_304B && _id_3D1F() != _id_3DAC() )
            {
                ...
                if ( self._id_38F5 && isdefined( self._id_662A ) && _func_1AD( self._id_662A ) )
            ...
            for (;;)
            {
                ...
                if ( isdefined( var_3 ) && _func_1AD( var_3 ) && _func_1A1( var_3 ) )
                {
                    var_4 = var_3 _meth_80AB( var_2 );
                    var_5 = isdefined( var_2._id_5EF4 ) && var_3 _meth_80AB( var_2._id_5EF4 );
                    var_6 = var_4 || var_5;
...
_id_5D6C()
{
    for (;;)
    {
        ...
        if ( var_6 )
            self _meth_809C( "elev_bell_ding" );
    }
}
...
_id_3D73( var_0 )
{
    ...
    var_0 _meth_8320( "elevator_floor_selector" );
    var_0 _meth_82F9( "player_current_floor", _id_3D1F() );
...
_id_3051()
{
    ...
    if ( level._id_3044 && isdefined( var_0 ) )
        var_0 _meth_8077( "elev_musak_loop" );
...
_id_579F( var_0 )
{
    for (;;)
    {
        ...
        if ( _func_120( var_0, "closing_" ) )
            var_1 _meth_809C( "elev_door_close" );

        if ( _func_120( var_0, "opening_" ) )
            var_1 _meth_809C( "elev_door_open" );

        if ( var_0 == "elevator_moving" )
        {
            var_1 _meth_809C( "elev_run_start" );
            var_1 _meth_8077( "elev_run_loop" );
        }

        if ( var_0 == "interrupted" )
            var_1 _meth_809C( "elev_door_interupt" );

        if ( var_0 == "elevator_moved" )
        {
            var_1 _meth_80AD( "elev_run_loop" );
            var_1 _meth_809C( "elev_run_end" );
            var_1 _meth_809C( "elev_bell_ding" );
        }
    }
}
...
_id_3043( var_0 )
{
    ...
    self endon( "elevator_moving" );
    var_1 = _id_3D9C();
    var_2 = self._id_2FF4["floor" + var_0 + "_pos"] - var_1._id_02E2;
    var_3 = level._id_3052;
    var_4 = _func_0BE( _func_0EE( self._id_2FF4["floor" + var_0 + "_pos"], var_1._id_02E2 ) );
    var_5 = var_4 / var_3;
    var_1 _meth_82AA( var_1._id_02E2 + var_2, var_5, var_5 * level._id_302A, var_5 * level._id_3037 );

    foreach ( var_7 in _id_3D96() )
    {
        var_8 = var_7._id_02E2 + var_2;

        if ( !_func_120( var_7.classname, "trigger_" ) )
        {
            var_7 _meth_82AA( var_8, var_5, var_5 * level._id_302A, var_5 * level._id_3037 );
            continue;
        }
...
_id_1FD0()
{
    ...
    var_2 = _id_3D9C();
    var_3 = _id_3D97();
    var_4 = ( var_3[0], var_3[1], var_2._id_02E2[2] );
    var_5 = level._id_303E;
    var_6 = _func_0BE( _func_0EE( var_0._id_02E2, var_4 ) );
    var_7 = var_6 / var_5;
    var_0 _meth_82AA( var_4, var_7, var_7 * 0.1, var_7 * 0.25 );
    var_1 _meth_82AA( var_4, var_7, var_7 * 0.1, var_7 * 0.25 );
...
_id_6513()
{
    ...
    var_3 = _id_3D9B();
    var_4 = _id_3DA1();
    var_5 = ( var_3[0], var_3[1], var_2._id_02E2[2] );
    var_6 = ( var_4[0], var_4[1], var_2._id_02E2[2] );
    var_7 = level._id_303E;
    var_8 = _func_0BE( _func_0EE( var_5, var_6 ) * 0.5 );
    var_9 = var_8 / var_7 * 0.5;
    var_0 _meth_82AA( var_5, var_9, var_9 * 0.1, var_9 * 0.25 );
    var_1 _meth_82AA( var_6, var_9, var_9 * 0.1, var_9 * 0.25 );
...
_id_1FD3( var_0 )
{
    ...
    var_6 = _func_0BE( _func_0EE( var_3, var_4 ) );
    var_7 = var_6 / var_5;
    var_1 _meth_82AA( var_4, var_7, var_7 * 0.1, var_7 * 0.25 );
    var_2 _meth_82AA( var_4, var_7, var_7 * 0.1, var_7 * 0.25 );
...
_id_6516( var_0 )
{
    ...
    var_7 = _func_0BE( _func_0EE( var_3, var_5 ) );
    var_8 = var_7 / var_6 * 0.5;
    var_1 _meth_82AA( var_3, var_8, var_8 * 0.1, var_8 * 0.25 );
    var_2 _meth_82AA( var_4, var_8, var_8 * 0.1, var_8 * 0.25 );
...
_id_184A()
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_6 = [];
        var_6[0] = _func_0BF( var_4._id_02E2[0], var_5._id_02E2[0] );
        var_6[1] = _func_0E1( var_4._id_02E2[0], var_5._id_02E2[0] );
        var_6[2] = _func_0BF( var_4._id_02E2[1], var_5._id_02E2[1] );
        var_6[3] = _func_0E1( var_4._id_02E2[1], var_5._id_02E2[1] );
        var_7 = spawnstruct();
        ...
        foreach ( var_9 in var_1 )
        {
            if ( var_9 _id_5121( var_6 ) )
            {
                ...
                var_10 = getent( var_9._id_04A4, "targetname" );
                var_7._id_2FF4["housing"]["left_door"] = var_10;
                var_7._id_2FF4["housing"]["left_door_opened_pos"] = var_10._id_02E2;
                var_11 = getent( var_10._id_04A4, "targetname" );
                var_7._id_2FF4["housing"]["right_door"] = var_11;
                var_7._id_2FF4["housing"]["right_door_opened_pos"] = var_11._id_02E2;
                var_12 = ( var_10._id_02E2 - var_11._id_02E2 ) * ( 0.5, 0.5, 0.5 ) + var_11._id_02E2;
                var_7._id_2FF4["housing"]["door_closed_pos"] = var_12;
                var_13 = getent( var_11._id_04A4, "targetname" );
                var_7._id_2FF4["housing"]["door_trigger"] = var_13;
                var_14 = getent( var_13._id_04A4, "targetname" );
                var_7._id_2FF4["housing"]["inside_trigger"] = var_14;
                var_14 _id_5917();
                var_14._id_5EF4 = spawn( "trigger_radius", var_9._id_02E2, 0, 64, 128 );
            }
        }
        ...
        foreach ( var_17 in var_2 )
        {
            ...
            {
                var_18 = isdefined( var_17._id_0398 ) && var_17._id_0398 == "closed_for_lighting";
                var_19 = var_7._id_2FF4["outer_doorset"].size;
                var_7._id_2FF4["outer_doorset"][var_19] = [];
                var_7._id_2FF4["outer_doorset"][var_19]["door_closed_pos"] = var_17._id_02E2;
                var_20 = getent( var_17._id_04A4, "targetname" );
                var_7._id_2FF4["outer_doorset"][var_19]["left_door"] = var_20;
                var_7._id_2FF4["outer_doorset"][var_19]["left_door_opened_pos"] = var_20._id_02E2;
                var_21 = getent( var_20._id_04A4, "targetname" );
                var_7._id_2FF4["outer_doorset"][var_19]["right_door"] = var_21;
                var_7._id_2FF4["outer_doorset"][var_19]["right_door_opened_pos"] = var_21._id_02E2;

                if ( var_18 )
                {
                    var_22 = var_17._id_02E2 - var_20._id_02E2;
                    var_17._id_02E2 = var_20._id_02E2;
                    var_20._id_02E2 += var_22;
                    var_21._id_02E2 -= var_22;
                    var_7._id_2FF4["outer_doorset"][var_19]["door_closed_pos"] = var_17._id_02E2;
                    var_7._id_2FF4["outer_doorset"][var_19]["left_door_opened_pos"] = var_20._id_02E2;
                    var_7._id_2FF4["outer_doorset"][var_19]["right_door_opened_pos"] = var_21._id_02E2;
                }
        ...
        foreach ( var_24, var_33 in var_7._id_2FF4["outer_doorset"] )
        {
            ...
            var_31 = ( var_34._id_02E2[0], var_34._id_02E2[1], var_33["door_closed_pos"][2] );
            var_7._id_2FF4["floor" + var_24 + "_pos"] = var_31;

            if ( var_34._id_02E2 == var_31 )
            {
...
_id_183D()
{
    ...
    {
        var_1._id_2FF4 = [];
        var_2 = ( 0, 0, var_1._id_02E2[2] );
        var_3 = ( var_1._id_02E2[0], var_1._id_02E2[1], 0 );
        var_4 = [];
        ...
        foreach ( var_12, var_6 in level._id_305B )
        {
            foreach ( var_11, var_8 in var_6 _id_3E0D() )
            {
                ...
                if ( _func_0BE( _func_0EE( var_2, var_9 ) ) <= level._id_3033 )
                {
                    if ( _func_0BE( _func_0EE( var_3, var_10 ) ) <= level._id_3032 )
                    {
        ...
        var_1 _id_5917();
        var_1._id_5EF4 = spawn( "trigger_radius", var_1._id_02E2 + ( 0, 0, -32 ), 0, 32, 64 );
    }
}
...
_id_8140()
{
    foreach ( var_1 in level._id_305B )
    {
        ...
        if ( var_4 > 2 )
        {
            var_2 _meth_80DD( &"ELEVATOR_FLOOR_SELECT_HINT" );
            continue;
        }

        var_2 _meth_80DD( &"ELEVATOR_USE_HINT" );
    }

    foreach ( var_7 in level._id_3034 )
    {
        var_7 _meth_80DC( "HINT_NOICON" );
        var_7 _meth_80DD( &"ELEVATOR_CALL_HINT" );
    }
}
...
_id_30FF()
{
    if ( !self._id_310D )
    {
        ...
        if ( isdefined( self._id_5EF4 ) )
            self._id_5EF4._id_02E2 += ( 0, 0, 10000 );
    }
}
...
_id_3D9E()
{
    ...
    foreach ( var_3 in var_0 )
    {
        if ( isdefined( var_3._id_0398 ) && var_3._id_0398 == "play_musak" )
            var_1 = var_3;
    }
...
_id_5121( var_0 )
{
    var_1 = self._id_02E2[0];
    var_2 = self._id_02E2[1];
    var_3 = var_0[0];
    var_4 = var_0[1];
    var_5 = var_0[2];
    var_6 = var_0[3];
...
_id_5123( var_0 )
{
    ...
    var_7 = ( var_3 + var_4 ) / 2;
    var_8 = ( var_5 + var_6 ) / 2;
    var_9 = _func_0BE( _func_0EE( ( var_3, var_5, 0 ), ( var_7, var_8, 0 ) ) );
    return _func_0BE( _func_0EE( ( var_1, var_2, 0 ), ( var_7, var_8, 0 ) ) ) < var_9;
}
...
{
    return _func_0BC( _id_303C( var_0, var_1 ) );
}
    ...
    for (;;)
    {
        ...
        foreach ( var_9 in level._id_3034 )
        {
            foreach ( var_16, var_5 in var_9._id_2FF4 )
            {
                ...
                {
                    var_11++;
                    var_14 = var_9._id_02E2 + ( 0, 0, var_11 * -4 );
                }
            }
        }
