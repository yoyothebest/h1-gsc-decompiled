...
_id_378E( var_0 )
{
    var_0._id_9C42["angles"] = _func_115( var_0._id_9C42["origin"] + ( 0, 0, 100 ) - var_0._id_9C42["origin"] );
...
_id_4E7D( var_0 )
{
    for (;;)
    {
        ...
        if ( level._id_0318 _meth_8248( "escape" ) || level._id_0318 _meth_8248( "x" ) )
            break;

        var_1 = 0;

        if ( level._id_0318 _meth_8248( "-" ) )
            var_1 = -10;
        else if ( level._id_0318 _meth_8248( "=" ) )
            var_1 = 10;
        ...
        if ( var_1 != 0 )
        {
            foreach ( var_3 in level._id_0575._id_7C66 )
            {
                if ( isdefined( var_3._id_9C42["reactive_radius"] ) )
                {
                    ...
                    var_3._id_9C42["reactive_radius"] = _func_0E9( var_3._id_9C42["reactive_radius"], 10, 1000 );
                }
            }
        }
    }
...
_id_7C5A()
{
    ...
    {
        if ( _func_120( var_7._id_9C42["fxid"], var_1 ) )
