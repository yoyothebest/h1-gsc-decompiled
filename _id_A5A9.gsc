...
_id_4492( var_0, var_1 )
{
    ...
    else
    {
        ...
        var_0._id_02E2 = var_7;
        var_0.angles = var_8;
    }

    if ( var_5 == 0 && isdefined( var_3[0]._id_0108 ) )
...
_id_9C8A( var_0 )
{
    ...
    return var_1 _meth_8184( var_0._id_85AE );
}
...
_id_9C89( var_0 )
{
    ...
    return var_1 _meth_8185( var_0._id_85AE );
}
...
_id_451F()
{
    ...
    if ( isdefined( self._id_0398 ) && self._id_0398 == "ai_wait_go" )
        thread _id_0935();
...
_id_4487( var_0, var_1 )
{
    ...
    var_0 endon( "death" );
    var_0.allowdeath = 0;
    var_0._id_01E6 = 10150;

    if ( isdefined( var_0._id_7ADB ) )
        var_0._id_01E6 += var_0._id_7ADB;
...
{
    var_2 = gettime() + getanimlength( var_1._id_0108 ) * 1000;
    var_3 = var_0.angles;
    var_4 = var_0._id_02E2;
    var_0 = _id_21A2( var_0 );
    [[ level._id_422E ]]( "MOD_RIFLE_BULLET", "torso_upper", var_4 );
    _id_297A( var_0, "weapon_" );
    var_0 _meth_804F( self, var_1._id_85AE, ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_0 _meth_82BB();
    thread _id_0C74( var_0, var_1._id_85AE, var_1._id_0108 );
    ...
    while ( gettime() < var_2 && !var_0 _meth_81E3() )
    {
        var_0 _meth_8023();
        wait 0.05;
    }
...
_id_9D07( var_0 )
{
    if ( isdefined( var_0._id_04FF ) && isdefined( var_0._id_9D08 ) )
    {
...
_id_44AC( var_0, var_1, var_2, var_3 )
{
    ...
    else if ( !var_1._id_9BFD[0] )
    {
        ...
        var_7 = common_scripts\utility::_id_3F33( var_0._id_02E2, var_11._id_1174 );
    else
        var_7 = undefined;
    ...
    if ( isdefined( var_7 ) )
    {
        ...
        if ( isdefined( var_13._id_9CD3 ) )
            var_8 = var_1 _meth_8184( var_13._id_9CD3 );
        else
            var_8 = var_1._id_02E2;
...
_id_5781( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_3 && !isdefined( var_0._id_79AD ) )
        var_0 _meth_8050( var_6, var_1, 0 );
    else
        var_0 _meth_804F( var_6, var_1, var_2, ( 0, 0, 0 ) );
}
...
_id_44BB( var_0, var_1 )
{
    ...
    if ( isdefined( var_2._id_04CD ) )
    {
        if ( isdefined( var_2._id_9959 ) )
            _id_0C74( var_0, var_2._id_9959, var_2._id_04CD );
        else
            _id_0C74( var_0, var_2._id_85AE, var_2._id_04CD );
    }
...
_id_750C( var_0 )
{
    ...
    for ( var_1 = 0; var_1 < self._id_750A.size; var_1++ )
    {
        if ( !_func_1A1( self._id_750A[var_1] ) )
            continue;
...
_id_4072()
{
    ...
    while ( _func_1A1( self ) && self._id_9A44.size > 2 )
        wait 0.05;

    if ( !_func_1A1( self ) || isdefined( self._id_235D ) && self._id_235D )
        return;
...
_id_4070( var_0, var_1, var_2 )
{
    ...
    waitframe;
    var_0 _meth_8119( var_2, var_4 / var_3 );
    var_6 = self;
    ...
    for ( var_7 = 0; var_7 < self._id_750A.size; var_7++ )
    {
        ...
        if ( _func_1A1( self._id_750A[var_7] ) )
...
_id_7F22( var_0, var_1 )
{
    ...
    var_3 endon( "death" );
    var_3 _meth_8115( "vehicle_anim_flag", var_0, 1, 0, 1 );
    wait(var_2);
...
_id_406B( var_0, var_1, var_2 )
{
    ...
    var_6 = var_0 _meth_8184( level._id_9C8D[var_3][var_4._id_3680]._id_0428 );
    var_7 = var_0 _meth_8185( level._id_9C8D[var_3][var_4._id_3680]._id_0428 );
    self._id_3681[var_4._id_3680] = 1;
    var_8 = spawn( "script_model", var_6 );
    var_8.angles = var_7;
    var_8._id_02E2 = var_6;
    var_8 _meth_80B3( level._id_9C8D[var_3][var_4._id_3680]._id_029C );
    self._id_3680[var_4._id_3680] = var_8;
    var_8 _meth_8117( #animtree );
    var_8 _meth_804F( var_0, level._id_9C8D[var_3][var_4._id_3680]._id_0428, ( 0, 0, 0 ), ( 0, 0, 0 ) );
    thread _id_4073( var_4, var_8, level._id_9C8D[var_3][var_4._id_3680]._id_0428, level._id_9C8D[var_3][var_4._id_3680]._id_2F6D, var_2 );
    return var_8;
}
...
_id_44BF( var_0, var_1 )
{
    ...
    if ( _func_0CF( var_0 ) && _func_1A1( var_0 ) )
        var_0 endon( "death" );
    ...
    if ( isdefined( var_2._id_9CD5 ) )
    {
        ...
        if ( isdefined( var_2._id_9CD8 ) )
        {
            ...
            var_6 = var_4 _meth_8184( var_2._id_9CD8 );
        }
        else
            var_6 = var_4._id_02E2;
    ...
    if ( !var_9 )
    {
        ...
        if ( isdefined( var_0._id_6D23 ) && isdefined( var_2._id_6B2A ) )
            level._id_0318 thread common_scripts\utility::_id_6975( var_2._id_6B2A );

        var_0 notify( "newanim" );
        var_0 notify( "jumping_out" );
        var_13 = 0;

        if ( !_func_0CF( var_0 ) && !var_0 should_stay_drone() )
        {
            var_13 = 1;
        ...
        else if ( isdefined( var_2._id_667F ) )
        {
            ...
            var_15 = spawn( "script_model", self _meth_8184( var_10 ) );
            var_15.angles = ( 0, self.angles[1] + self._id_0B96, 0 );
            self._id_0B96 += 5;
            var_15 _meth_80B3( "tag_origin" );
            var_16 = _id_A5A4::_id_4417( self._id_02E2 ) + ( 0, 0, self._id_9A3A );
            var_15._id_02E2 = var_16 + ( _func_0B4( 10, 20 ), _func_0B4( 10, 20 ), 0 );
            var_17 = spawn( "script_model", var_15._id_02E2 );
            var_17.angles = var_15.angles;
            var_17 _meth_80B3( self._id_9A40 );
            var_17._id_0C72 = "parachute";
            var_17 _meth_8117( level._id_78B1["parachute"] );
            var_17 _meth_8056();
        ...
        if ( isdefined( var_0._id_6D23 ) && isdefined( var_2._id_6B2A ) )
            level._id_0318 thread common_scripts\utility::_id_8EA1( var_2._id_6B2A );

        if ( isdefined( var_2._id_406F ) )
            var_0 thread common_scripts\utility::_id_8EA1( var_2._id_406F );

        if ( isdefined( var_0._id_6D23 ) && isdefined( var_2._id_6B29 ) )
            level._id_0318 thread _id_A5A4::_id_69C4( var_2._id_6B29 );
    }
    ...
    if ( !_func_1A1( self ) && !isdefined( var_2._id_9A43 ) )
    {
        var_0 delete();
        return;
    }
    ...
    if ( _func_1A1( var_0 ) )
    {
        ...
        if ( isdefined( var_2._id_3680 ) && _func_1A1( var_0 ) )
...
{
    var_0 _meth_8051();
    var_5 = var_1 _meth_8184( "tag_driver" );
    var_6 = var_1 _meth_8185( "tag_driver" );
    var_0 _meth_81CA( var_5, var_6 );
    var_0 _meth_804F( var_1, "tag_driver" );
    var_1 _meth_8140( "parachute_unload", self._id_02E2, self.angles, var_2 );
    ...
    var_0 _meth_8140( "parachute_unload", var_0._id_02E2, var_0.angles, var_3 );
...
_id_667D( var_0 )
{
    ...
    var_2 = _func_114( common_scripts\utility::_id_38C8( var_1 ) );
    var_3 = self._id_02E2 + var_2 * 10000;
    thread _id_A5A4::_id_2DB9( self, var_3, 1, 0, 0, 10 );
    self _meth_82AA( var_3, 1 );
}
...
_id_0C74( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_7 = var_6 _meth_8184( var_1 );
        var_8 = var_6 _meth_8185( var_1 );
    }
    ...
    if ( isdefined( var_0._id_0BBC ) )
    {
        ...
        if ( !isdefined( var_0 ) || _func_29C( var_0 ) )
            return;
...
_id_7290()
{
    ...
    if ( isdefined( self ) && self._id_020C == 0 )
        self._id_020C = 80;
}
...
_id_0C75( var_0, var_1 )
{
    ...
    var_2 = undefined;
    var_3 = undefined;
    var_4 = var_1._id_01E6 <= 0;

    for (;;)
    {
        if ( !var_4 && !( isdefined( var_1 ) && var_1._id_01E6 > 0 ) )
            break;
...
_id_0C76( var_0, var_1, var_2 )
{
    ...
    {
        var_3 = _func_092( var_0._id_70DA, 0, 1 );
        var_4 = _func_08F( var_0._id_02E2 + ( 0, 0, 16 ), var_0._id_02E2 - ( 0, 0, 10000 ) );
        var_5 = _func_0EE( var_0._id_02E2 + ( 0, 0, 16 ), var_4 );

        if ( _func_0BE( var_3[2] + 16 ) <= _func_0BE( var_5 ) )
        {
            var_0 thread _id_A5A4::_id_69C4( "generic_death_falling" );
            var_0 _meth_8140( "fastrope_fall", var_0._id_02E2, var_0.angles, var_0._id_70DA );
    ...
    var_0 _meth_8054( var_2._id_02E2, var_2 );

    if ( isdefined( var_0._id_7AE0 ) || isdefined( var_0._id_2E3F ) )
    {
        var_0 _meth_82BB();
        var_6 = _func_043( var_0._id_0513 );
        var_7 = var_0._id_0513;

        if ( isdefined( var_6 ) )
        {
            var_0 _meth_802A( var_6, "tag_weapon_right" );
            var_8 = var_0 _meth_8184( "tag_weapon_right" );
            var_9 = var_0 _meth_8185( "tag_weapon_right" );
            level._id_4454 = spawn( "weapon_" + var_7, ( 0, 0, 0 ) );
            level._id_4454.angles = var_9;
            level._id_4454._id_02E2 = var_8;
        }
    }
    else
    ...
    if ( isdefined( var_0._id_2642 ) )
    {
        ...
        var_12 = _func_0F1( var_0._id_2642 );
        var_13 = _func_114( var_1 _meth_81B4( var_0._id_2642 ) - var_0._id_02E2 ) * var_12;
...
_id_0C77( var_0, var_1 )
{
    ...
    if ( !_func_29C( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) )
            var_0 _meth_8054( var_0._id_02E2, var_2 );
        else
            var_0 _meth_8054();
    }
}
...
_id_44C4( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        [[ level._id_422E ]]( "MOD_RIFLE_BULLET", "torso_upper", var_0._id_02E2 );
        var_0 delete();
    }
}
...
_id_4483( var_0 )
{
    ...
    while ( !var_0 _meth_81E3() && gettime() < var_7 )
    {
        var_9 = var_0._id_02E2;
        wait 0.05;
        var_8 = var_0._id_02E2 - var_9;
        var_0 _meth_8023();
    }
...
_id_21A2( var_0, var_1, var_2 )
{
    ...
    var_3 _meth_80B3( var_0._id_029C );
...
_id_9CCE( var_0, var_1, var_2 )
{
    ...
    var_4 = undefined;
    var_5 = undefined;
    var_6 = self _meth_8184( var_1 );
    var_7 = self _meth_8185( var_1 );
    var_4 = _func_06F( var_6, var_7, var_0 );
    var_5 = _func_070( var_6, var_7, var_0 );
...
_id_2807()
{
    var_0 = self _meth_8098();
    var_1 = self _meth_821A( 1, 0, 0 );
    var_2 = _func_0EE( var_1, var_0 );
    var_3 = _func_0DC();

    foreach ( var_5 in var_3 )
    {
        if ( _func_0EE( var_5._id_02E2, var_0 ) < var_2 )
            var_5 delete();
    }
}
