...
_id_29F3()
{
    ...
    level.launchfacility_a_price_bmp_nag_number = _func_0B4( 1, level.launchfacility_a_price_bmp_nag_max + 1 );
    ...
    level.launchfacility_a_price_ropenag_number = _func_0B4( 1, level.launchfacility_a_price_ropenag_max + 1 );
    ...
    level.dialoguesniperconfirm_number = _func_0B4( 1, level.dialoguesniperconfirm_max + 1 );
    ...
    level.dialoguegatehint_number = _func_0B4( 1, level.dialoguegatehint_max + 1 );
    ...
    level.dialoguerpghit_number = _func_0B4( 1, level.dialoguerpghit_max + 1 );
    ...
    level.dialoguerpggoodshot_number = _func_0B4( 1, level.dialoguerpghit_max + 1 );
    ...
    level.dialoguejavelingoodshot_number = _func_0B4( 1, level.dialoguejavelingoodshot_max + 1 );
