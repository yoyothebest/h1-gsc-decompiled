...
player_heli_ropeanimoverride()
{
    ...
    self._id_0DE8 = var_5;
    var_6 = spawn( "script_model", level._id_0318._id_02E2 );
    var_6 _meth_80B3( var_1 );
    var_6 _meth_804F( self, var_0, ( 0, 0, 0 ), ( 0, 0, 0 ) );
    var_6 _meth_8117( #animtree );
    thread player_heli_ropeanimoverride_idle( var_6, var_0, var_3 );
    self waittill( "unloading" );
    level._id_0318 thread _id_A5A4::_id_69C4( "scn_armada_intro_foley" );
