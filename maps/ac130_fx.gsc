...
main()
{
    level._id_058F["houseFire"] = loadfx( "fx/explosions/ac130_house_explosion" );
    level._id_058F["fire_bits"] = loadfx( "fx/explosions/ac130_house_fire_bits" );
    level._id_058F["fire_bits_sm"] = loadfx( "fx/explosions/ac130_house_fire_bits_sm" );
    level._id_058F["dust_line"] = loadfx( "vfx/map/ac130/ac130_crane_dust_line" );
    level._id_058F["smk_churn"] = loadfx( "vfx/map/ac130/ac130_house_smk_churn" );
    level._id_058F["heli_kickup"] = loadfx( "fx/treadfx/ac130_heli_kickup" );
