...
{
    self _meth_8117( #animtree );
    self _meth_809C( "seaknight_door_open" );
...
{
    self _meth_8117( #animtree );
    self _meth_809C( "seaknight_door_close" );
...
animated_palm_trees_setup()
{
    ...
    level._id_0BEC["qad_foliage_tree_palm_bushy_3"]["still"] = %palmtree_bushy3_still;
    level._id_0BEC["qad_foliage_tree_palm_bushy_3"]["strong"] = %palmtree_bushy3_sway;
    level._id_0BEC["qad_foliage_tree_palm_bushy_3"]["heli"] = %palmtree_bushy3_sway;
    level._id_0BEC["h1_foliage_backlot_palm_tree_heliwash"]["still"] = %h1_foliage_backlot_palm_tree_heliwash_still;
    level._id_0BEC["h1_foliage_backlot_palm_tree_heliwash"]["strong"] = %h1_foliage_backlot_palm_tree_heliwash_sway;
    level._id_0BEC["h1_foliage_backlot_palm_tree_heliwash"]["heli"] = %h1_foliage_backlot_palm_tree_heliwash_wash;
    level._id_0BEC["h1_mwr_foliage_tree_palm_tall_2_heliwash"]["still"] = %h1_foliage_backlot_palm_tree_02_hero_still;
    level._id_0BEC["h1_mwr_foliage_tree_palm_tall_2_heliwash"]["strong"] = %h1_foliage_backlot_palm_tree_02_hero_sway;
    level._id_0BEC["h1_mwr_foliage_tree_palm_tall_2_heliwash"]["heli"] = %h1_foliage_backlot_palm_tree_02_hero_heliwash;
}
