...
_id_7E68()
{
    ...
    level._id_0318 _id_A5A4::set_light_set_player( "sniperescape" );
    level._id_0318 _meth_848C( "clut_sniperescape", 1.0 );
}
...
handle_player_on_sniper_rifle()
{
    ...
    _func_0D6( "sv_znear", "100" );
    _func_0D6( "sm_sunShadowCenter", getent( "blood_pool", "targetname" )._id_02E2 );
    var_0 = getentarray( "zakhaev_light", "targetname" );

    foreach ( var_2 in var_0 )
        var_2 _meth_8494( "force_on" );

    level._id_0318 _id_A5A4::set_light_set_player( "sniperescape_scope" );
