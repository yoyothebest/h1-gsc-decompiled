...
_id_7E68()
{
    _func_0D6( "r_specularcolorscale", "2.3" );
...
update_fade_angle_lights()
{
    ...
    {
        var_2 = _func_124( self._id_0398, "-" );

        if ( isdefined( var_2[0] ) )
            var_0 = _func_0BD( var_2[0] );

        if ( isdefined( var_2[1] ) )
            var_1 = _func_0BD( var_2[1] );
    }
    ...
    var_7 = _func_114( ( var_6[0], var_6[1], 0.0 ) );

    for (;;)
    {
        var_8 = level._id_0318._id_02E2 - self._id_02E2 + var_6 * self._id_0351 * 0.75;
        var_8 = _func_114( ( var_8[0], var_8[1], 0.0 ) );
        var_9 = _func_0F6( var_7, var_8 );
        var_10 = ( _func_0E9( ( var_9 + 1.0 ) * 0.5, var_3, var_4 ) - var_3 ) / var_5;
        self _meth_81E2( 5000.0 * var_10 );
        wait 0.05;
    }
}
...
handle_flight_going_down()
{
    ...
    level._id_0318 _meth_80AF( "blackhawk_down_crash_rumble" );
...
handle_wakeup_done()
{
    ...
    level._id_0318 _id_A5A4::set_light_set_player( "heli_crash" );
}
...
handle_ac130_lighting_init()
{
    ...
    {
        if ( var_3._id_029C == "vehicle_t72_tank" )
        {
...
set_specular_scale( var_0, var_1 )
{
    ...
    {
        var_2 += var_4 / var_3;
        _func_0D6( "r_specularcolorscale", var_2 );
        wait 0.25;
    }

    _func_0D6( "r_specularcolorscale", var_0 );
}
...
visionset_trigger( var_0 )
{
    for (;;)
    {
        ...
        _id_A5A4::_id_7F00( self._id_0398, self._id_0392 );
...
apply_lighting_pass_hunted_outside( var_0 )
{
    ...
    level._id_0318 _id_A5A4::set_light_set_player( "hunted" );
    level._id_0318 _meth_848C( "clut_hunted", var_0 );
}

apply_lighting_pass_hunted_inside()
{
    _id_A5A4::_id_9E6E( "hunted_barn_interior", 2 );
    level._id_0318 _id_A5A4::set_light_set_player( "barn_interior" );
    level._id_0318 _meth_848C( "clut_hunted", 5 );
