...
anim_gen_human()
{
    ...
    _id_A510::_id_0805( "price", "bridge_breach", "kick_door", "wood_door_kick" );
    ...
    _id_A510::_id_0805( "alavi", "bridge_breach", "turn_wheel_start", "scn_cargoship_intro_breaching" );
    ...
    _id_A510::_id_0805( "generic", "signal_onme", "foley_sound", "foly_waving_go" );
    ...
    _id_A510::_id_080B( "generic", "dialog", "help_price", "cargoship_pri_gotcha" );
    level._id_78AC["generic"]["price_explosion"] = %cargoship_explosion_price;
    _id_A510::_id_080B( "generic", "dialog", "price_explosion", "cargoship_pri_weareleaving" );
    level._id_78AC["generic"]["grigsby_explosion"] = %h1_cargoship_explosion_gaz;
    _id_A510::_id_080B( "generic", "dialog", "grigsby_explosion", "cargoship_grg_shipssinking" );
    ...
    _id_A510::_id_0805( "generic", "breach2_price_breach", "sound_opendoor", "scn_door_cargoship_hatch_open" );
    ...
    _id_A510::_id_0807( "generic", "gun_2_chest", maps\cargoship_code::carogship_shotgunpulla, "breach2_grigsby_talk" );
    _id_A510::_id_0807( "generic", "shotgun_pickup", maps\cargoship_code::carogship_shotgunpullb, "breach2_grigsby_talk" );
    ...
    _id_A510::_id_0805( "generic", "package_doorR", "sound", "door_cargo_container_pull_open" );
    _id_A510::_id_080B( "generic", "dialog", "package_opendoor_price", "cargoship_pri_inarabic" );
    _id_A510::_id_080B( "generic", "dialog", "package_opendoor_price", "cargoship_pri_readytosecure" );
    _id_A510::_id_080C( "generic", "radio", "radiomessage_notime", "package_opendoor_price" );
    _id_A510::_id_080B( "generic", "dialog2", "package_opendoor_price", "cargoship_pri_getmanifestmove" );
    _id_A510::_id_080C( "generic", "animend", "package_orders", "package_opendoor_price" );
    _id_A510::_id_080B( "generic", "dialog", "package_grigs", "cargoship_grg_fastmovers" );
...
anim_player()
{
    ...
    _id_A510::_id_080C( "player_viewbody", "fade_in", "shellshock_blinking", "player_explosion" );
    _id_A510::_id_080D( "player_viewbody", "fade_out", "shellshock_blinking", "player_explosion" );
    _id_A510::_id_080C( "player_viewbody", "blur_in", "shellshock_blur", "player_explosion" );
    _id_A510::_id_080D( "player_viewbody", "blur_out", "shellshock_blur", "player_explosion" );
    _id_A510::_id_0805( "fastrope_intro", "opening", "scn_cgo_intro_player_fastrope", "scn_cgo_intro_player_fastrope" );
    _id_A510::_id_0805( "player_viewbody", "player_explosion", "scn_cargo_explosion_foley", "scn_cargo_explosion_foley" );
}
