...
dyndof_system_start( var_0 )
{
    ...
    if ( var_0 )
        _func_0D6( "r_dof_physical_bokehEnable", 1 );
    ...
    while ( level.player_dynamic_dof_settings.active )
    {
        ...
        if ( isdefined( level._id_0318._id_02E5 ) )
            var_2 = _func_11C( level._id_0318._id_02E5.angles, level._id_0318.angles );

        var_4 = anglestoforward( var_2 );
        var_5 = level._id_0318._id_02E2 + ( 0, 0, level._id_0318 _meth_82EF() );
        ...
        foreach ( var_8 in level.player_dynamic_dof_settings.settings_list )
        {
            ...
            {
                var_8.reference_point = var_8.reference_entity._id_02E2;

                if ( isdefined( var_8._id_90C3 ) )
                {
                    if ( !_id_A5A4::_id_4749( var_8.reference_entity._id_029C, var_8._id_90C3 ) )
                    {
                        if ( !isdefined( var_8.reference_entity._id_477D ) )
                        {
                    ...
                    var_8.reference_point = var_8.reference_entity _meth_8184( var_8._id_90C3 );
                }

                if ( isdefined( var_8._id_6379 ) )
                {
                    var_11 = _func_11E( var_8._id_6379, var_8.reference_entity.angles );
                    var_8.reference_point += var_11;
                }

                var_12 = _func_114( var_8.reference_point - var_5 );
                var_13 = _func_0F6( var_4, var_12 );
                var_9 = _func_0BA( var_13 );
                var_14 = var_8._id_5C33 * var_8._id_5C33;
                var_15 = var_8._id_5A13 * var_8._id_5A13;
                var_16 = _func_0F0( var_5, var_8.reference_point );
            ...
            if ( isdefined( var_8.reference_point ) && var_8.require_visible )
            {
                ...
                {
                    var_18 = _func_0F0( var_5, var_8.reference_point );
                    var_19 = _func_0F0( var_5, var_17["position"] );
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_6.should_autofocus )
            {
                ...
                var_21 = _func_0EE( var_5, var_17["position"] );
            }
            else if ( isdefined( var_6.reference_entity ) )
            {
                var_21 = _func_0EE( var_6.reference_point, var_5 );
            ...
            level._id_0318 _meth_84A7( var_6.fstop, var_24, var_6.focus_speed, var_6.aperture_speed );
            var_25 = var_6.fstop * var_6.view_model_fstop_scale;

            if ( var_25 > 512 )
                var_25 = 512;

            level._id_0318 _meth_84B8( var_25, var_24 );
            var_1 = var_6._id_02A7;
        }
...
__dyndof_bullet_trace_ignore_glass( var_0, var_1, var_2 )
{
    ...
    var_4 = var_0;
    var_5 = undefined;
    var_6 = level._id_0318;

    for ( var_7 = 0; var_3 && var_7 < 10; var_7++ )
    {
        var_5 = _func_06B( var_4, var_1, 1, var_6, 0, 1, 0 );
        var_8 = _func_0F0( var_4, var_1 );
        var_9 = var_5["entity"];
        var_10 = _func_114( var_1 - var_4 );
...
dyndof_system_end()
{
    ...
    _func_0D6( "r_dof_physical_bokehEnable", 0 );
...
__cinseq_activate_key( var_0 )
{
    ...
    if ( isdefined( var_0.gauss_blur_amount ) && isdefined( var_0.gauss_blur_duration ) )
        _func_074( var_0.gauss_blur_amount, var_0.gauss_blur_duration );
    ...
    if ( isdefined( var_0.fov_value ) && isdefined( var_0.fov_lerp_duration ) )
        level._id_0318 _meth_8032( var_0.fov_value, var_0.fov_lerp_duration );

    var_0 __cinseq_handle_dyndofs();

    if ( isdefined( var_0.slowmo_slow_scale ) )
        _func_0B1( gettimescale(), var_0.slowmo_slow_scale, var_0.slowmo_in_duration );
    else if ( isdefined( var_0.slowmo_out_duration ) )
        _func_0B1( gettimescale(), level._id_8637._id_8A53, var_0.slowmo_out_duration );

    if ( isdefined( self.rumble_name ) )
        self._id_767B _meth_80AF( self.rumble_name );
}

__cinseq_start_screen_shake( var_0 )
{
    level._id_0318 _meth_83FC( var_0.pitch_scale, var_0._id_A3B7, var_0.roll_scale, var_0._id_0136, var_0.duration_fade_up, var_0.duration_fade_down, var_0._id_0351, var_0.frequency_pitch, var_0.frequency_roll, var_0.frequency_yaw, var_0._id_3583 );
}
...
__cinseq_dyndof_verify_create_setting( var_0 )
{
    ...
    if ( !isdefined( self.dyndof_list[var_0] ) )
    {
        ...
        self.dyndof_list[var_0]._id_02A7 = var_0;
    }
