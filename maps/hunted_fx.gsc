...
main()
{
    level._id_058F["firelp_vhc_lrg_pm_farview"] = loadfx( "fx/fire/firelp_large_pm" );
    level._id_058F["lighthaze"] = loadfx( "vfx/lights/hunted/hunted_headlight" );
    ...
    level._id_058F["fog_hunted"] = loadfx( "fx/weather/fog_hunted" );
    level._id_058F["fog_hunted_a"] = loadfx( "fx/weather/fog_hunted_a" );
    level._id_058F["bird_pm"] = loadfx( "fx/misc/bird_pm" );
    level._id_058F["bird_takeoff_pm"] = loadfx( "fx/misc/bird_takeoff_pm" );
    level._id_058F["leaves"] = loadfx( "fx/misc/leaves" );
    level._id_058F["leaves_runner"] = loadfx( "fx/misc/leaves_runner" );
    level._id_058F["leaves_runner_1"] = loadfx( "fx/misc/leaves_runner_1" );
    level._id_058F["leaves_lp"] = loadfx( "fx/misc/leaves_lp" );
    level._id_058F["leaves_gl"] = loadfx( "fx/misc/leaves_gl" );
    level._id_058F["leaves_gl_a"] = loadfx( "fx/misc/leaves_gl_a" );
    level._id_058F["leaves_gl_b"] = loadfx( "fx/misc/leaves_gl_b" );
    level._id_058F["hunted_vl"] = loadfx( "fx/misc/hunted_vl" );
    level._id_058F["hunted_vl_sm"] = loadfx( "fx/misc/hunted_vl_sm" );
    level._id_058F["hunted_vl_od_lrg"] = loadfx( "fx/misc/hunted_vl_od_lrg" );
    level._id_058F["hunted_vl_od_lrg_a"] = loadfx( "fx/misc/hunted_vl_od_lrg_a" );
    level._id_058F["hunted_vl_od_sml"] = loadfx( "fx/misc/hunted_vl_od_sml" );
    level._id_058F["hunted_vl_od_sml_a"] = loadfx( "fx/misc/hunted_vl_od_sml_a" );
    level._id_058F["hunted_vl_od_dtl_a"] = loadfx( "fx/misc/hunted_vl_od_dtl_a" );
    level._id_058F["hunted_vl_od_dtl_b"] = loadfx( "fx/misc/hunted_vl_od_dtl_b" );
    ...
    level._id_058F["hunted_vl_white_eql"] = loadfx( "fx/misc/hunted_vl_white_eql" );
    level._id_058F["hunted_vl_white_eql_flare"] = loadfx( "fx/misc/hunted_vl_white_eql_flare" );
    level._id_058F["hunted_vl_white_eql_a"] = loadfx( "fx/misc/hunted_vl_white_eql_a" );
    level._id_058F["grenadeexp_fuel"] = loadfx( "fx/explosions/grenadeexp_fuel" );
    level._id_058F["hunted_fel"] = loadfx( "fx/misc/hunted_fel" );
    level._id_058F["waterfall_hunted_night"] = loadfx( "fx/misc/waterfall_hunted_night" );
    level._id_058F["stream_hunted"] = loadfx( "fx/misc/stream_hunted" );
    level._id_058F["light_godray_moonlight_a"] = loadfx( "vfx/lights/light_godray_moonlight_a" );
    level._id_058F["light_godray_moonlight_b"] = loadfx( "vfx/lights/light_godray_moonlight_b" );
    level._id_058F["light_godray_moonlight_sm"] = loadfx( "vfx/lights/light_godray_moonlight_sm" );
    level._id_058F["light_godray_dust_alone"] = loadfx( "vfx/lights/light_godray_dust_alone" );
    level._id_058F["light_godray_dust_alone_b"] = loadfx( "vfx/lights/light_godray_dust_alone_b" );
    level._id_058F["light_godray_dust_alone_c"] = loadfx( "vfx/lights/light_godray_dust_alone_c" );
    level._id_058F["heli_fire_small_streak_pm_v"] = loadfx( "vfx/map/hunted/heli_fire_small_streak_pm_v" );
    level._id_058F["heli_fire_small_streak_pm_h"] = loadfx( "vfx/map/hunted/heli_fire_small_streak_pm_h" );
    level._id_058F["heli_fire_med_streak_pm_h"] = loadfx( "vfx/map/hunted/heli_fire_med_streak_pm_h" );
    ...
    level._id_058F["leaves_night_gust_a"] = loadfx( "fx/misc/leaves_night_gust_a" );
    level._id_058F["leaves_night_gust_b"] = loadfx( "fx/misc/leaves_night_gust_b" );
    level._id_058F["moth_runner_night"] = loadfx( "fx/misc/moth_runner_night" );
    level._id_058F["birds_takeoff_night"] = loadfx( "vfx/animal/birds_takeoff_night" );
    ...
    level._id_058F["hunted_heli_crashsite_explosion_night"] = loadfx( "vfx/map/hunted/hunted_heli_crashsite_explosion_night" );
    level._id_058F["hunted_heli_crashsite_smoke_sim"] = loadfx( "vfx/map/hunted/hunted_heli_crashsite_smoke_sim" );
    level._id_058F["hunted_heli_crashsite_fire"] = loadfx( "vfx/map/hunted/hunted_heli_crashsite_fire" );
    level._id_058F["hunted_heli_crashsite_fire_sm"] = loadfx( "vfx/map/hunted/hunted_heli_crashsite_fire_sm" );
    ...
    level._id_058F["hunted_street_lights"] = loadfx( "vfx/map/hunted/hunted_street_lights" );
    level._id_058F["hunted_outdoor_light_fixture"] = loadfx( "vfx/map/hunted/hunted_outdoor_light_fixture" );
    level._id_058F["hunted_headlight_spotlight_alone"] = loadfx( "vfx/lights/hunted/hunted_headlight_spotlight_alone" );
    level._id_058F["hunted_headlight_spotlight_offset"] = loadfx( "vfx/lights/hunted/hunted_headlight_spotlight_offset" );
    level._id_058F["hunted_headlight_omni_offset"] = loadfx( "vfx/lights/hunted/hunted_headlight_omni_offset" );
    level._id_058F["light_red_tower_blinking_vista_sm"] = loadfx( "vfx/lights/light_red_tower_blinking_vista_sm" );
    level._id_058F["ripple_flow_distortion_single_no_geo"] = loadfx( "vfx/water/ripple_flow_distortion_single_no_geo" );
    ...
    level._id_058F["hunted_creek_fog"] = loadfx( "vfx/map/hunted/hunted_creek_fog" );
    level._id_058F["ripple_flow_distortion_single_med_slow"] = loadfx( "vfx/water/ripple_flow_distortion_single_med_slow" );
    level._id_058F["ripple_flow_distortion_strip_no_geo"] = loadfx( "vfx/water/ripple_flow_distortion_strip_no_geo" );
    level._id_058F["ca_gas_station_explosion_light"] = loadfx( "vfx/map/hunted/ca_gas_station_explosion_light" );
    level._id_058F["ca_gas_station_explosion_light_ground"] = loadfx( "vfx/map/hunted/ca_gas_station_explosion_light_ground" );
    level._id_058F["ca_gas_station_impact_spread_sims"] = loadfx( "vfx/map/hunted/ca_gas_station_impact_spread_sims" );
    level._id_058F["ca_gas_station_impact_dirt"] = loadfx( "vfx/map/hunted/ca_gas_station_impact_dirt" );
    level._id_058F["ca_gas_station_impact_spread"] = loadfx( "vfx/map/hunted/ca_gas_station_impact_spread" );
    level._id_058F["ca_gas_station_fireball"] = loadfx( "vfx/map/hunted/ca_gas_station_fireball" );
    level._id_058F["ca_gas_station_fireball_02"] = loadfx( "vfx/map/hunted/ca_gas_station_fireball_02" );
    ...
    level._id_058F["firelp_large_pm"] = loadfx( "fx/fire/firelp_large_pm" );
    level._id_058F["ca_gas_station_fires_med"] = loadfx( "vfx/map/hunted/ca_gas_station_fires_med" );
    level._id_058F["firelp_barrel_pm"] = loadfx( "fx/fire/firelp_barrel_pm" );
    level._id_058F["ca_gas_station_falling_fires"] = loadfx( "vfx/map/hunted/ca_gas_station_falling_fires" );
    level._id_058F["ca_intro_dizzy"] = loadfx( "vfx/map/hunted/ca_intro_dizzy" );
    level._id_058F["ca_intro_falling_fires"] = loadfx( "vfx/map/hunted/ca_intro_falling_fires" );
    level._id_058F["ca_intro_vista_lights"] = loadfx( "vfx/map/hunted/ca_intro_vista_lights" );
    level._id_058F["chimney_smoke"] = loadfx( "vfx/smoke/chimney_smoke" );
    level._id_058F["head_fatal"] = loadfx( "fx/impacts/flesh_hit_head_fatal_exit_night" );
    ...
    level._id_058F["truck_smoke"] = loadfx( "vfx/dust/veh_dust_kick_up_night" );
    level._id_058F["flashlight"] = loadfx( "fx/misc/flashlight_night_maps" );

    if ( getdvarint( "sm_enable" ) && getdvar( "r_zfeather" ) != "0" )
        level._id_058F["spotlight"] = loadfx( "fx/misc/hunted_spotlight_model_night_no_noise" );
    else
        level._id_058F["spotlight"] = loadfx( "fx/misc/spotlight_large_night" );

    level._id_3891["mi17"] = loadfx( "fx/misc/flares_cobra" );
    level._id_058F["gasstation_explosion"] = loadfx( "vfx/map/hunted/ca_hunted_gasstation_explosion" );
    level._id_058F["big_explosion"] = loadfx( "vfx/map/hunted/ca_gas_station_big_explosion" );
    ...
    level._id_058F["gas_pump_fire"] = loadfx( "vfx/map/hunted/ca_gas_pump_fire" );
    level._id_058F["thin_black_smoke_M"] = loadfx( "fx/smoke/thin_black_smoke_M" );
    level._id_058F["tire_fire_med"] = loadfx( "vfx/map/hunted/ca_tire_fire_med" );
    level._id_058F["heli_dlight_blue"] = loadfx( "vfx/map/hunted/ca_aircraft_light_cockpit_blue" );
    level._id_058F["heli_dlight_red"] = loadfx( "vfx/map/hunted/ca_aircraft_light_cockpit_red" );
    level._id_058F["missile_explosion"] = loadfx( "vfx/map/hunted/hunted_intro_heli_explosion" );
