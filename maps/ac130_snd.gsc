...
add_context_sensative_timeout( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        level.context_sensative_dialog_timeouts[var_0][var_1]._id_443E[_id_A5A4::_id_8F53( var_2 )]._id_9C42["timeoutDuration"] = var_3 * 1000;
        level.context_sensative_dialog_timeouts[var_0][var_1]._id_443E[_id_A5A4::_id_8F53( var_2 )]._id_9C42["lastPlayed"] = var_3 * -1000;
    }
    else
    {
        level.context_sensative_dialog_timeouts[var_0][var_1]._id_9C42["timeoutDuration"] = var_3 * 1000;
        level.context_sensative_dialog_timeouts[var_0][var_1]._id_9C42["lastPlayed"] = var_3 * -1000;
    }
}
