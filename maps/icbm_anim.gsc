...
uaz_overrides()
{
    ...
    var_0[0]._id_0108 = %uaz_rear_driver_death;
    var_0[1]._id_0108 = %uaz_passenger_death;
...
{
    var_0 thread common_scripts\utility::_id_69C2( "scn_icbm_relaxed_chair_fall", var_0._id_02E2 );
}

show_prices_knife( var_0 )
{
    level.price_knife _meth_8055();
}
