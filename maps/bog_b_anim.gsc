...
main()
{
    ...
    _id_A510::_id_0807( "alley_door_kicker_right", "kick", maps\bog_b::alley_dooropen );
    level._id_78AC["price"]["alley_breach"] = %h1_bog_b_vasquez_door_breach_vasquez;
    _id_A510::_id_0807( "price", "door_kick", maps\bog_b::alley_dooropen, "alley_breach" );
    ...
    _id_A510::_id_080B( "price", "dialog", "new_react", "bog_pri_niceshootingpig" );
    _id_A510::_id_0807( "price", "radio", maps\bog_b::docomingthroughaudio, "new_react" );
    level._id_78AC["guard"]["new_react"] = %h1_bog_b_cheers_soldier_left;
    _id_A510::_id_080B( "guard", "dialog", "new_react", "bog_gm1_wooyeah" );
    level._id_78AC["casualcrouch"]["new_react"] = %h1_bog_b_cheers_soldier_right;
    _id_A510::_id_080B( "casualcrouch", "dialog", "new_react", "bog_gm4_talkinabout" );
...
animated_model_setup()
{
    ...
    level._id_0BEC["h1_foliage_backlot_palm_tree_02_hero"]["still"] = %h1_foliage_backlot_palm_tree_02_hero_still;
    level._id_0BEC["h1_foliage_backlot_palm_tree_02_hero"]["strong"] = %h1_foliage_backlot_palm_tree_02_hero_sway;
    level._id_0BEC["h1_foliage_backlot_palm_tree_02_hero"]["heli"] = %h1_foliage_backlot_palm_tree_02_hero_heliwash;
    level._id_0BEC["h1_foliage_backlot_palm_tree_03_hero"]["still"] = %h1_foliage_backlot_palm_tree_03_hero_still;
    level._id_0BEC["h1_foliage_backlot_palm_tree_03_hero"]["strong"] = %h1_foliage_backlot_palm_tree_03_hero_sway;
    level._id_0BEC["h1_foliage_backlot_palm_tree_03_hero"]["heli"] = %h1_foliage_backlot_palm_tree_03_hero_heliwash;
}
