...
player_dof_attenuation()
{
    ...
    for (;;)
    {
        ...
        {
            var_0 maps\_cinematography::cinseq_key( "end_blur" ) maps\_cinematography::cinseq_key_time( _func_0B5( 2, 4 ) );
...
_id_7E68()
{
    _id_A5A4::_id_9E6E( "aftermath", 0 );
    level._id_0318 _id_A5A4::set_light_set_player( "aftermath" );
    level._id_0318 _meth_848C( "clut_h1_aftermath", 0.0 );
    thread set_level_lighting_default();
    thread set_level_lighting_pain();
    thread set_level_lighting_glow();
    _func_052( ( 10000, 10000, 10000 ), ( 0.5, 0.5, 0.5 ) );
}
...
set_level_lighting_default()
{
    for (;;)
    {
        ...
        level._id_0318 _id_A5A4::set_light_set_player( "aftermath" );
        level._id_0318 _meth_848C( "clut_h1_aftermath", var_0 );
    }
}
...
set_level_lighting_pain()
{
    for (;;)
    {
        ...
        level._id_0318 _id_A5A4::set_light_set_player( "aftermath" );
        level._id_0318 _meth_848C( "clut_h1_aftermath_pain", var_0 );
...
set_level_lighting_glow()
{
    for (;;)
    {
        ...
        level._id_0318 _id_A5A4::set_light_set_player( "aftermath_glow" );
        level._id_0318 _meth_848C( "clut_h1_aftermath_glow", var_0 );
    }
}
