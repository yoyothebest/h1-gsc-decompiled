...
_id_7E68()
{
    _func_0D6( "r_disablelightsets", 0 );
    _func_106( ( -50, 136, 0 ) );
...
update_fade_distance_lights()
{
    ...
    for (;;)
    {
        var_4 = _func_0F1( level._id_0318._id_02E2 - self._id_02E2 );
        var_5 = _func_0E9( ( var_4 - var_0 ) / ( var_1 - var_0 ), 0.0, 1.0 );
        self _meth_81E2( var_2 * var_5 );
        wait 0.05;
    }
}
...
apply_lighting_pass_bog_outside( var_0 )
{
    ...
    level._id_0318 _id_A5A4::set_light_set_player( "bog_b" );
    level._id_0318 _meth_848C( "clut_bog_b", var_0 );
}

apply_lighting_pass_bog_inside()
{
    _id_A5A4::_id_9E6E( "bog_b_interior", 2 );
    level._id_0318 _id_A5A4::set_light_set_player( "bog_b_interior" );
    level._id_0318 _meth_848C( "clut_bog_b", 5 );
}
