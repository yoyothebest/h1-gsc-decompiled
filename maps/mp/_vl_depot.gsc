...
sethasvisiteddepot()
{
    _func_308( level.depotcontroller, common_scripts\utility::getstatsgroup_common(), "hasEverVisitedDepot", 1 );
}
...
depothandlestickerfx( var_0 )
{
    ...
    if ( isdefined( level.depotcrate.laststickerfx ) && level.depotcrate.laststickerfx != var_1 )
        stopfxontag( level._id_058F[level.depotcrate.laststickerfx], level.depotcrate, "TAG_FX_STICKER" );

    level.depotcrate.laststickerfx = var_1;
    playfxontag( level._id_058F[level.depotcrate.laststickerfx], level.depotcrate, "TAG_FX_STICKER" );
}
...
depothandlecratemodel( var_0 )
{
    ...
    level.depotcrate _meth_80B3( var_1 );
}
...
playerenterdepot( var_0 )
{
    ...
    if ( !maps\mp\_utility::_id_5092( level.in_depot ) )
    {
        ...
        var_1 = maps\mp\_vl_base::_id_3F9E( var_0 );
        level._id_9EA2 = var_1;
        var_2 = self;
        depotsetupseasonal();

        if ( !maps\mp\_utility::_id_5092( level.depotinitialized ) )
        {
        ...
        var_6 = level._id_1A3E._id_1A13;
        var_6.depotpos = "dealer";
        var_6.depotsceneent _meth_8487( "h1_vlobby_armory_scene1_cam_idle", var_6.depotsceneent.scriptednode._id_02E2, var_6.depotsceneent.scriptednode.angles, "scene_node_anim" );
        ...
        {
            level.depotscene = level.depotscenes[_func_0B2( level.depotscenes.size )];
...
playerleavedepot( var_0 )
{
    ...
    level.depotagent.depotsceneent _meth_8276();
    level.depotlackey.sceneent _meth_8276();
    level.depotcrate _meth_8276();
...
depotnotifylootrarities( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < var_1.size; var_2++ )
        level.depotlootrarities[var_2] = _func_0BC( var_1[var_2] );
...
setupdepotpropent( var_0, var_1, var_2, var_3 )
{
    ...
    level.depotpropents[var_0._id_029C] = var_0;
}
...
spawnandinitdepotents()
{
    ...
    while ( !isdefined( common_scripts\utility::_id_40FB( "characterBM", "targetname" ) ) )
        wait 0.05;

    var_1 = common_scripts\utility::_id_40FB( "characterBM", "targetname" );
    var_0.depotsceneent = spawn( "script_model", var_1._id_02E2 );
    var_0.depotsceneent _meth_80B3( "genericprop" );
    var_0.depotsceneent.scriptednode = var_1;
    level.depotagent = playerspawndepotcharacter( self._id_1E2E, "vldepot_dealer_animclass", "body_graves_mp", "head_graves_lob" );
    level.depotagent.depotsceneent = spawn( "script_model", var_1._id_02E2 );
    level.depotagent.depotsceneent _meth_80B3( "genericprop_x10" );
    ...
    level.depotagent.props["pistol"] = spawndepotpropent( "wpn_h1_pst_m1911_npc", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_2" );
    level.depotagent.props["knife"] = spawndepotpropent( "wpn_h1_graves_combat_knife_npc", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_3" );
    level.depotagent.props["chair"] = spawndepotpropent( "prop_graves_folding_chair", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_4" );
    level.depotagent.props["cig"] = spawndepotpropent( "h1_prop_cigarette_dark_animated", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_5" );
    level.depotagent.props["phone"] = spawndepotpropent( "prop_graves_cellphone", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_6" );
    level.depotagent.props["ashtray"] = spawndepotpropent( "btr_ashtray_metal_01", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_7" );
    level.depotagent.props["whetStone"] = spawndepotpropent( "h1_sharpening_stone", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_8" );
    level.depotagent.props["laptop"] = spawndepotpropent( "h1_laptop_01_rig", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_9" );
    level.depotagent.props["cloth"] = spawndepotpropent( "h1_props_vl_depot_weapon_rag", var_1._id_02E2, level.depotagent.depotsceneent, "j_prop_7" );
    ...
    level.depotlackey = playerspawndepotcharacter( self._id_1E2E, "vldepot_lackey_animclass", var_3, var_2 );
    level.depotlackey.sceneent = spawn( "script_model", var_1._id_02E2 );
    level.depotlackey.sceneent _meth_80B3( "genericprop_x10" );
    ...
    level.depotlackey.props["redtoolbox"] = spawndepotpropent( "com_red_toolbox", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_1", 1 );
    level.depotlackey.props["firstaid"] = spawndepotpropent( "h1_cs_firstaid_kit", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_2", 1 );
    level.depotlackey.props["cardboardbox"] = spawndepotpropent( "h1_cs_box_cardboard_a_closed", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_3", 1 );
    level.depotlackey.props["toolbox"] = spawndepotpropent( "h1_fng_toolbox_01", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_4", 1 );
    level.depotlackey.props["crate"] = spawndepotpropent( "ch_crate48x64", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_5", 1 );
    level.depotlackey.props["ammo"] = spawndepotpropent( "h1_fng_shell_ammo_crate", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_6", 1 );
    level.depotlackey.props["plasticcase"] = spawndepotpropent( "com_plasticcase_beige_big", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_7", 1 );
    level.depotlackey.props["clipboard"] = spawndepotpropent( "com_clipboard_wpaper", var_1._id_02E2, level.depotlackey.sceneent, "j_prop_8", 1 );
    level.depotlackey.props["cards"] = spawn( "script_model", ( 0, 0, 0 ) );
    level.depotlackey.props["cards"] _meth_80B3( "h1_props_vl_depot_playcards" );
    ...
    level.depotprop = playerspawndepotcharacter( self._id_1E2E, "vldepot_props_animclass", "body_graves_lackey", "head_graves_lackey", 0 );
    maps\mp\_vl_avatar::_id_4842( level.depotprop );
    ...
    var_4 = common_scripts\utility::_id_40FB( "drop_crate", "targetname" );
    level.depotcrate = spawn( "script_model", var_4._id_02E2 );
    level.depotcrate.angles = var_4.angles;
    level.depotcrate _meth_80B3( "h1_supply_drop_crate_a_anim" );
    level.depotcrate.originalorigin = level.depotcrate._id_02E2;
    level.depotcrate.originalangles = level.depotcrate.angles;
    level.depotlootprop = spawn( "script_model", level.depotcrate._id_02E2 );
    level.depotlootprop.angles = level.depotcrate.angles;
    level.depotlootprop _meth_80B3( "genericprop_x3" );
    level.depotlootcards = [];

    for ( var_5 = 0; var_5 < 3; var_5++ )
    {
        level.depotlootcards[var_5] = spawn( "script_model", ( 0, 0, 0 ) );
        level.depotlootcards[var_5] _meth_80B3( "h1_props_vl_depot_playcards_single_crate" );
...
playerspawndepotcharacter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = maps\mp\gametypes\_class::_id_4009( self._id_0308["team"], var_0 );
    var_6 = common_scripts\utility::_id_40FB( "characterBM", "targetname" );
    var_7 = maps\mp\_vl_avatar::_id_88CE( self, var_6, var_5._id_6F84, self._id_2236, var_5._id_A7ED, undefined, undefined, var_4, 1, var_2, var_3 );
    var_7._id_A7EA = var_5.emblemindex;
    var_7 _meth_8577( var_5._id_A7EC );
    var_7 _meth_83CE( var_1 );
    var_7 _meth_839B( 1 );
    var_7 _meth_8396( "noclip" );
    maps\mp\_vl_avatar::_id_4844( var_7 );
    return var_7;
}
...
{
    if ( var_0 == "idle" && isdefined( level.depotidlestarttime ) && gettime() - level.depotidlestarttime > level.depotstates["nag"].minidletime && gettime() - level.depotstates["nag"].laststatetime > _func_0B5( level.depotstates["nag"].statemintime, level.depotstates["nag"].statemaxtime ) )
        return 1;
...
depotcanswitchtoxover( var_0 )
{
    ...
    if ( var_0 == "idle" && gettime() - level.depotstates["xover"].laststatetime > _func_0B5( level.depotstates["xover"].statemintime, level.depotstates["xover"].statemaxtime ) )
        return 1;
...
depotcanswitchtobroke( var_0 )
{
    ...
    if ( var_0 == "idle" && gettime() - level.depotstates["broke"].laststatetime > _func_0B5( level.depotstates["broke"].statemintime, level.depotstates["broke"].statemaxtime ) )
        return 1;
...
{
    if ( var_0 == "idle" && gettime() - level.depotstates["creditreminder"].laststatetime > _func_0B5( level.depotstates["creditreminder"].statemintime, level.depotstates["creditreminder"].statemaxtime ) && hasabunduntcurrency() )
        return 1;
...
{
    if ( var_0 == "idle" && gettime() - level.depotstates["easteregg"].laststatetime > _func_0B5( level.depotstates["easteregg"].statemintime, level.depotstates["easteregg"].statemaxtime ) )
        return 1;
...
depotswitchingtogreetingfirst( var_0 )
{
    ...
    if ( level._id_1A3E._id_1A13.depotpos != "dealer" )
...
depotswitchingtoidle( var_0 )
{
    ...
    if ( isdefined( level.depotstates[var_0] ) && !maps\mp\_utility::_id_5092( level.depotstates[var_0].idletype ) )
...
depotidleended()
{
    var_0 = gettime() - level.depotstates["idle"].laststatetime > _func_0B5( level.depotstates["idle"].statemintime, level.depotstates["idle"].statemaxtime );
...
depotanimstatemachine()
{
    ...
    for (;;)
    {
        ...
        if ( var_3 != var_0 || level.depotstatefinished && var_3 != "pause" || var_4 )
        {
            ...
            if ( maps\mp\_utility::_id_5092( level.depotstates[var_3].nochecknecessary ) || self [[ level.depotstates[var_3].canswitchtostatefunc ]]( var_0 ) )
            {
...
{
    if ( !maps\mp\_utility::_id_5092( level.showinglackeyprops ) )
    {
...
depotlackeyfidgets()
{
    ...
    var_1 = 30000;
    var_2 = gettime();
    maps\mp\_vl_avatar::_id_4842( level.depotlackey );

    for (;;)
    {
        if ( gettime() - var_2 > _func_0B5( var_0, var_1 ) )
        {
            maps\mp\_vl_avatar::_id_84BF( level.depotlackey, 0 );
            depotshowlackeyprops();
            var_3 = thread agentplaydepotanim( level.depotlackey, "armory_lackey_fidgets" );
            sceneplayanim( level.depotlackey.sceneent, level.depotlackey.sceneent.scriptednode, level.depotprop _meth_83D2( "armory_lackey_fidgets_prop", var_3 ) );
            level.depotlackey maps\mp\agents\_scripted_agent_anim_util::_id_A100( "lackey_fidget", "end", "armory_lackey_fidgets", var_3 );
            maps\mp\_vl_avatar::_id_4842( level.depotlackey );
            var_2 = gettime();
            wait(var_0 / 1000);
        }
...
depotplayscene( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( level.depotagent _meth_8558( var_4 ) )
        {
            ...
            if ( level.depotscene == "lackey" )
            {
                if ( level.depotlackey _meth_8558( var_4 + "_lackey" ) && level.depotlackey _meth_83D4( var_4 + "_lackey" ) > var_3 )
                {
                    maps\mp\_vl_avatar::_id_84BF( level.depotlackey, 0 );
                ...
                if ( level.depotprop _meth_8558( var_4 + "_prop_lackey" ) && level.depotprop _meth_83D4( var_4 + "_prop_lackey" ) > var_3 )
                {
                    depotshowlackeyprops();
                    sceneplayanim( level.depotlackey.sceneent, level.depotlackey.sceneent.scriptednode, level.depotprop _meth_83D2( var_4 + "_prop_lackey", var_3 ) );
                }
            }

            if ( level.depotprop _meth_8558( var_4 + "_prop" ) )
                sceneplayanim( level.depotagent.depotsceneent, level.depotagent.depotsceneent.scriptednode, level.depotprop _meth_83D2( var_4 + "_prop", var_3 ), 0, 1 );

            if ( isdefined( level.depotspecialanimprops[level.depotscene] ) )
            {
                var_5 = [];

                if ( _func_0CE( level.depotspecialanimprops[level.depotscene] ) )
                ...
                foreach ( var_7 in var_5 )
                {
                    ...
                    if ( level.depotprop _meth_8558( var_4 + "_prop_" + var_8 ) && level.depotprop _meth_83D4( var_4 + "_prop_" + var_8 ) > var_3 )
                    {
                        var_7 _meth_8055();

                        if ( isdefined( var_7.animscenenode ) )
                        {
                            var_7 _meth_8487( level.depotprop _meth_83D2( var_4 + "_prop_" + var_8, var_3 ), var_7.animscenenode._id_02E2, var_7.animscenenode.angles );
                            continue;
                        }

                        var_7 _meth_8275( level.depotprop _meth_83D2( var_4 + "_prop_" + var_8, var_3 ) );
                    }
                }
            }
        }
...
agentplaydepotsound( var_0, var_1, var_2 )
{
    ...
    {
        if ( !_func_0CE( var_0.sounds[level.depotscene][var_1] ) )
            var_0 _meth_8433( var_0.sounds[level.depotscene][var_1] );
        else if ( isdefined( var_0.sounds[level.depotscene][var_1][var_2] ) )
            var_0 _meth_8433( var_0.sounds[level.depotscene][var_1][var_2] );
    }
    ...
    if ( isdefined( var_0.propsounds ) && isdefined( var_0.propsounds[level.depotscene] ) && isdefined( var_0.propsounds[level.depotscene][var_1] ) )
    {
        foreach ( var_5, var_4 in var_0.propsounds[level.depotscene][var_1] )
            var_0.props[var_5] _meth_8433( var_4 );
    }
}

agentplaydepotanim( var_0, var_1, var_2, var_3 )
{
    var_4 = var_0 _meth_83D0( var_1, var_2, 1.0, 0.0 );
...
{
    level endon( "depot_state_changed" );
    level.depotagent maps\mp\agents\_scripted_agent_anim_util::_id_A100( var_2, "end", var_0, var_1 );
...
sceneplayanim( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_2 ) )
    {
        ...
        var_0 _meth_8487( var_2, var_1._id_02E2, var_1.angles, "scene_node_anim", var_4 );
...
depotopenlootcrate()
{
    ...
    if ( level._id_1A3E._id_1A13.depotpos != "crate" )
        level._id_1A3E._id_1A13.depotsceneent waittillmatch( "scene_node_anim", "crack_crate" );
    ...
    level.depotcrate _meth_809C( "h1_ui_loot_box_latch" );
    ...
    if ( var_0 != "purchasefail" )
    {
        ...
        if ( var_0 == "purchasewait" )
        {
            ...
            level.depotcrate _meth_8077( "h1_ui_lootbox_rattle" );

            while ( getdvar( "vlDepotState" ) == "purchasewait" )
                waittillframeend;
        }

        level.depotcrate _meth_80AD();
        var_0 = getdvar( "vlDepotState" );
        ...
        if ( var_0 == "purchaseconfirm" )
        {
            ...
            _func_245( &"supply_drop_play_purchase_vo", 0 );
            var_1 = _func_0BC( level.inventoryitemrarity["Common"] );

            for ( var_2 = 0; var_2 < level.depotlootrarities.size && var_2 < level.depotlootcards.size; var_2++ )
            {
                level.depotlootcards[var_2].rarity_fx = level._id_058F[level.raritycardfx[level.inventoryitemrarity["Common"]]._id_3B23];
                playfxontag( level.depotlootcards[var_2].rarity_fx, level.depotlootcards[var_2], "tag_card" );
                var_1 = _func_0BC( _func_0E1( var_1, level.depotlootrarities[var_2] ) );
            }

            level.depotlootprop _meth_8275( "h1_vlobby_armory_loot_flyout", "card_anim" );
            ...
            level.depotcrate _meth_809C( "h1_ui_loot_box_open" );
            level.depotcrate waittillmatch( "crate_anim", "play_fx" );
            thread common_scripts\_exploder::_id_3528( level.raritycardfx[var_1]._id_3528 );

            if ( isdefined( level.raritycardfx[var_1]._id_7675 ) )
                _func_1C7( level.raritycardfx[var_1]._id_7675, self._id_02E2 );

            level.depotlootprop waittillmatch( "card_anim", "cards_off_screen" );
            _func_245( &"supply_drop_ui", 0 );
            level.depotlootrarities = undefined;
            level.depotcrate waittillmatch( "crate_anim", "crate_shut" );
            level.depotcrate _meth_809C( "h1_ui_loot_box_close" );
            thread common_scripts\_exploder::_id_3528( 201 );
            level.depotcrate waittillmatch( "crate_anim", "end" );
            ...
            _func_245( &"supply_drop_allow_skip", 0 );
        }
    }
...
{
    var_1 = level.depotpropents[var_0._id_029C];
    ...
    if ( maps\mp\_utility::_id_5092( var_0.islooping ) )
    {
        ...
        stopfxontag( common_scripts\utility::_id_3FA8( var_0.fxref ), var_1, var_0.tagname );
    }
}
...
depotaddpropnotetrackfx( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    level.depotpropnotetrackfx[var_6]._id_029C = var_0;
...
depotscenelightsoff()
{
    foreach ( var_1 in level.depotscenes )
    {
        ...
        if ( var_4 _meth_81E1() == 0 )
            continue;

        foreach ( var_6 in var_3 )
        {
            if ( !isdefined( var_6.baseintensity ) )
                var_6.baseintensity = var_6 _meth_81E1();
...
depotscenelightson( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
        var_4 _meth_81E2( var_4.baseintensity );
}
...
depotsetupseasonal()
{
    ...
    if ( isdefined( level.inventory_contentpromo ) )
    {
        ...
        if ( isdefined( level.depotlackey ) && ( level.depotlackey._id_01E2 != var_4 || level.depotlackey.bodymodel != var_5 ) )
        {
            level.depotlackey _meth_802A( level.depotlackey._id_01E2 );
            level.depotlackey _meth_80B3( var_5 );
            level.depotlackey _meth_801D( var_4 );
            level.depotlackey._id_01E2 = var_4;
    ...
    if ( level.inventory_contentpromo == 1 )
    {
        ...
        var_2 _meth_80B3( "h1_props_depot_gold_coin_pile_lod0" );
        var_6[var_6.size] = var_2;
        var_2 = spawn( "script_model", ( 13865.5, 1566, -669.5 ) );
        var_2.angles = ( 0, 211.496, 0 );
        var_2 _meth_80B3( "h1_props_vl_depot_bobblehead" );
        var_6[var_6.size] = var_2;
        ...
        if ( isdefined( level.depotlackey ) )
        {
            ...
            level.depotlackey _meth_802A( level.depotlackey._id_01E2 );
            level.depotlackey _meth_801D( var_7 );
            level.depotlackey._id_01E2 = var_7;
        }
    }
...
playbobbleanim()
{
    ...
    {
        level.bobble _meth_8276();
        wait 0.5;
        level.bobble _meth_8275( "h1_vlobby_armory_saa_bobblehead_enter", "bobble_notify" );
    }
}
