...
_id_16D8()
{
    ...
    {
        level._id_4DC7 = level._id_7B74._id_24C8;
        level._id_4DC8 = _func_0C8( level._id_7B74._id_24C8 );
    }

    if ( self._id_04A7 == var_0 && !isdefined( level._id_1A4B ) )
    {
        var_2 = 0;
        ...
        if ( var_2 )
        {
            ...
            badplace_cylinder( "bomb", var_7 / 1000, level._id_7B74._id_24C8, 75, 300, var_0 );
        }
    }

    for (;;)
    {
        wait(_func_0B4( 1, 3 ) * 0.05);
        ...
        if ( self._id_04A7 == var_0 )
        {
            if ( !level._id_5FE2 && isdefined( level._id_1A4B ) && gettime() < level._id_1A4B && !isdefined( level._id_7B74._id_1BAF ) )
            {
                if ( !maps\mp\bots\_bots_util::_id_165E( level._id_7B74._id_24C8 ) )
                {
                    var_8 = _func_0C8( level._id_7B74._id_24C8 );

                    if ( isdefined( var_8 ) )
                    {
                        var_9["nearest_node_to_center"] = var_8;
                        maps\mp\bots\_bots_strategy::_id_16C2( level._id_7B74._id_24C8, 900, var_9 );
                    }
                    else
        ...
        if ( level._id_1545 )
        {
            if ( _func_0F0( self._id_02E2, level._id_7B75._id_02E2 ) > _func_0E8( level._id_703F * 2 ) )
            {
        ...
        {
            if ( !maps\mp\bots\_bots_util::_id_165E( level._id_7B75._id_02E2 ) )
            {
                self _meth_8354();
                maps\mp\bots\_bots_strategy::_id_16C2( level._id_7B75._id_02E2, level._id_703F );
            }
...
_id_0D86()
{
    ...
    if ( isdefined( level._id_7B74 ) && isdefined( level._id_7B74._id_1BAF ) && _func_1A1( level._id_7B74._id_1BAF ) && level._id_7B74._id_1BAF != self )
        wait 0.7;
    ...
    if ( !self._id_50C8 && !level._id_5FE2 )
    {
        if ( isdefined( level._id_7B74 ) )
        {
            if ( !isdefined( self._id_550E ) )
                self._id_550E = level._id_7B74._id_24C8;

            if ( _func_0F0( self._id_550E, level._id_7B74._id_24C8 ) > 4 )
            {
                self _meth_8354();
                self._id_550E = level._id_7B74._id_24C8;
            }
        ...
        if ( self._id_0D85 >= 2 )
        {
            var_1 = _func_0C7( level._id_7B74._id_24C8, 512, 0 );
            var_2 = undefined;
            ...
            if ( isdefined( var_2 ) )
            {
                self _meth_8352( var_2._id_02E2, 20, "critical" );
        ...
        if ( !self _meth_8363() )
        {
            var_6 = 15;
            var_7 = 32;
            var_8 = maps\mp\bots\_bots_util::_id_16C3( "BotGetClosestNavigablePoint", maps\mp\bots\_bots_util::_id_3AE5, level._id_7B74._id_24C8, var_6 + var_7, self );

            if ( isdefined( var_8 ) )
            {
                var_9 = self _meth_8352( level._id_7B74._id_24C8, 0, "critical" );
            ...
            else
            {
                ...
                if ( var_1.size > 0 )
                {
                    self _meth_8352( var_1[0]._id_02E2, 0, "critical" );
                    maps\mp\bots\_bots_util::_id_172E();
                }
    ...
    else
    {
        ...
        if ( !isdefined( level._id_1535 ) )
            level._id_1535 = level._id_1555[_func_0B2( level._id_1555.size )];
        ...
        if ( level._id_0E0F == "rush" )
        {
            ...
            self _meth_8352( var_11._id_02E2, 0, "critical" );
        }
...
_id_1ED9()
{
    ...
    if ( isdefined( level._id_0D84 ) )
    {
        if ( level._id_0E0F == "rush" )
        {
            ...
            if ( _func_0CF( level._id_0D84 ) && isdefined( level._id_0D84._id_1554 ) )
            ...
            if ( !maps\mp\bots\_bots_util::_id_165E( var_1._id_24C8 ) )
            {
                ...
                maps\mp\bots\_bots_strategy::_id_16C2( var_1._id_24C8, level._id_703F, var_0 );
            }
        }
    }
}
...
_id_27A7()
{
    ...
    if ( level._id_1545 )
    {
        ...
        if ( !maps\mp\bots\_bots_util::_id_165E( level._id_7B75._id_02E2 ) )
        {
            ...
            maps\mp\bots\_bots_strategy::_id_16C2( level._id_7B75._id_02E2, level._id_703F, var_0 );
        }
    }
}
...
_id_152B()
{
    ...
    var_1 = common_scripts\utility::_id_3CCB( level._id_7B75._id_02E2, var_0._id_174F );
    var_2 = ( level._id_7B75._id_02E2[0], level._id_7B75._id_02E2[1], var_1[0]._id_02E2[2] );
    ...
    if ( var_4 == "bad_path" )
    {
        ...
        if ( self._id_27BC >= 4 )
        {
            for (;;)
            {
                var_5 = _func_0C7( var_2, 50, 0 );
                var_6 = self._id_27BC - 4;

                if ( var_5.size <= var_6 )
                {
                    var_7 = _func_202( var_2, 50, self );
                    ...
                    self _meth_8352( var_5[var_6]._id_02E2, 20, "critical" );
    ...
    if ( var_4 == "goal" )
    {
        ...
        var_12 = level._id_7B75._id_02E2[2] - self._id_02E2[2];
...
_id_1A36()
{
    ...
    else if ( !maps\mp\bots\_bots_util::_id_165E( level._id_7B74._id_24C8 ) )
    {
        var_0["nearest_node_to_center"] = level._id_7B74._id_6072;
        maps\mp\bots\_bots_strategy::_id_16C2( level._id_7B74._id_24C8, level._id_703F, var_0 );
    }
}
...
_id_27AD()
{
    ...
    if ( !maps\mp\bots\_bots_util::_id_165E( self._id_27A9._id_24C8 ) )
    {
        var_0["score_flags"] = "strict_los";
        var_0["override_origin_node"] = common_scripts\utility::_id_710E( self._id_27A9._id_174F );
        maps\mp\bots\_bots_strategy::_id_16C2( self._id_27A9._id_24C8, level._id_703F, var_0 );
    }
}
...
_id_125B()
{
    ...
    if ( self._id_125A == "1_move_to_midpoint" )
    {
        ...
        var_4 = undefined;
        var_5 = _func_0BC( var_3.size * ( var_3.size + 1 ) * 0.5 );
        var_6 = _func_0B2( var_5 );
    ...
    if ( self._id_125A == "2_move_to_enemy_spawn" )
    {
        ...
        self _meth_8377( "scripted" );
        var_9 = self _meth_8352( var_12._id_02E2, 250, "guard" );
    ...
    if ( self._id_125A == "3_move_to_bombzone" )
    {
        if ( !isdefined( self._id_1553 ) )
            self._id_1553 = _func_0B2( level._id_1555.size );

        self _meth_8377( undefined );
        var_9 = self _meth_8352( common_scripts\utility::_id_710E( level._id_1555[self._id_1553]._id_174F )._id_02E2, 160, "objective" );
...
_id_1BD8( var_0, var_1 )
{
    ...
    while ( _func_0F0( self._id_02E2, var_0 ) > var_2 * var_2 && maps\mp\bots\_bots_util::_id_165D() )
    {
...
_id_847E( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        var_3 = 0;
        var_4 = common_scripts\utility::_id_3D4F( self._id_04A7 );
        ...
        foreach ( var_6 in level._id_0323 )
        {
            ...
            if ( _func_1A1( var_6 ) && var_6._id_04A7 == var_4 )
                var_3 = 1;
        }
        ...
        return _func_0F0( self._id_02E2, self._id_15F2 ) <= var_2 && self _meth_8373();
}
...
_id_3E32( var_0 )
{
    ...
    {
        if ( _func_0CF( var_4 ) && isdefined( var_4._id_759A ) && var_4._id_759A == "defender" )
        {
        ...
        if ( _func_0F0( var_4._id_02E2, var_0._id_24C8 ) < level._id_703F * level._id_703F )
            var_1 = common_scripts\utility::_id_0CDA( var_1, var_4 );
    }
...
_id_376F()
{
    foreach ( var_1 in level._id_1555 )
    {
        ...
        if ( _func_0F0( var_1._id_9345._id_02E2, var_1._id_24C8 ) < 90000 )
            return var_1;
    }
...
_id_3E6B( var_0 )
{
    var_0 = "_" + _func_123( var_0 );

    for ( var_1 = 0; var_1 < level._id_1555.size; var_1++ )
    {
        if ( level._id_1555[var_1]._id_0241 == var_0 )
...
_id_4DDB()
{
    ...
    else
    {
        ...
        if ( self._id_759A == "defender" )
        {
            ...
            if ( _id_46F8( self._id_04A7 ) )
                var_14 = _id_3E15( self._id_04A7 );
...
_id_3989( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        if ( isdefined( var_2 ) )
        {
            var_4 thread _id_16EF( var_1, _func_0B5( 0.0, var_2 ) );
            continue;
        }
...
_id_3E30( var_0 )
{
    ...
    {
        if ( _func_1A1( var_3 ) && maps\mp\_utility::_id_51CE( var_3 ) && isdefined( var_3._id_759A ) && var_3._id_759A == var_0 )
...
_id_16D5()
{
    ...
    level endon( "game_ended" );
    level._id_0A8E = _func_0B2( 3 ) <= 1;
    level._id_0A9C = _func_0B2( 3 ) <= 1;
    level._id_0E0F = "rush";
    level._id_703F = 725;
    level._id_1B4A = 140;
    ...
    for (;;)
    {
        if ( isdefined( level._id_7B74 ) && isdefined( level._id_7B74._id_1BAF ) && !_func_0CF( level._id_7B74._id_1BAF ) )
        ...
        if ( !level._id_1545 )
        {
            ...
            foreach ( var_3 in var_1 )
            {
                if ( var_3._id_50C8 )
                {
                    ...
                    {
                        if ( isdefined( level._id_0D84 ) && _func_1A1( level._id_0D84 ) )
                        {
            ...
            {
                var_5 = _func_0C8( level._id_7B74._id_24C8 );
                ...
                if ( isdefined( var_5 ) )
                {
                    ...
                    foreach ( var_9 in var_7 )
                    {
                        ...
                        if ( var_11 > 0 && var_9._id_759A != "camp_bomb" && isdefined( var_10 ) && _func_204( var_5, var_10, 1 ) )
                        {
                            var_12 = var_9 _meth_8371();

                            if ( common_scripts\utility::_id_A347( var_9._id_02E2, var_9 _meth_8338(), level._id_7B74._id_24C8, var_12 ) )
                            {
                                if ( var_11 >= 2 || _func_0F0( var_9._id_02E2, level._id_7B74._id_24C8 ) < _func_0E8( 700 ) )
                                {
                                    var_6 = 1;
                                    break;
                                }
        ...
        else
        {
            ...
            if ( !isdefined( level._id_152A ) || !_func_1A1( level._id_152A ) )
            {
                var_25 = [];
                ...
                if ( var_25.size > 0 )
                {
                    var_29 = common_scripts\utility::_id_3CCB( level._id_7B75._id_02E2, var_25 );
                ...
                foreach ( var_3 in var_30 )
                {
                    if ( isdefined( var_3._id_759A ) )
                    {
                        ...
                        if ( var_3._id_759A != "defend_planted_bomb" )
                            var_3 thread _id_16EF( "defend_planted_bomb", _func_0B5( 0.0, 3.0 ) );
                    }
                }
            }
        }
