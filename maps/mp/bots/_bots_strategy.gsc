...
_id_15ED()
{
    ...
    if ( isdefined( var_0 ) && var_0.size > 0 )
        return common_scripts\utility::_id_710E( var_0 )._id_02E2;
    ...
    foreach ( var_10 in var_3 )
    {
        foreach ( var_7 in var_5 )
        {
            if ( maps\mp\bots\_bots_util::bot_item_matches_purpose( var_10, var_7 ) )
            {
                ...
                if ( _func_1EA( var_7 ) || _func_2A1( var_7 ) )
...
_id_16E8( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !isdefined( var_4 ) && isdefined( var_1 ) && var_1.size > 0 )
    {
        ...
        foreach ( var_9 in var_1 )
        {
            ...
            if ( _func_0F0( var_9._id_02E2, var_2._id_02E2 ) > 90000 )
            {
                if ( _func_0F6( var_7, _func_114( var_9._id_02E2 - var_2._id_02E2 ) ) < 0.4 )
                    var_6[var_6.size] = var_9;
            }
        }
        ...
        if ( var_6.size > 0 )
        {
            ...
            var_11 = _func_0C6( var_5._id_02E2, 300, 50 );
            var_12 = [];
            ...
            var_11 = var_12;
            var_4 = self _meth_8362( var_11, _func_0BF( var_11.size, 3 ), "node_trap", var_2, var_5 );
        }
    }
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        {
            var_17 = _func_115( var_5._id_02E2 - var_4._id_02E2 );
            var_16 = var_17[1];
        }
        ...
        if ( var_18 )
        {
            ...
            if ( var_19 == "goal" )
            {
                ...
                if ( !isdefined( self._id_0142 ) || !self _meth_836D( self._id_0142 ) )
                {
                    ...
                    if ( isdefined( var_16 ) )
                        self _meth_836B( var_5._id_02E2 + var_20, 3.0, "script_forced" );
                    else
                        self _meth_836B( self._id_02E2 + var_20 + anglestoforward( self _meth_8338() ) * 50, 3.0, "script_forced" );
...
bot_watch_c4_detonate( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            var_3 = self _meth_817A( var_0._id_02E2, 1.0 );
...
_id_15F0( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        {
            if ( _func_0CE( var_3["score_flags"] ) )
        ...
        if ( isdefined( var_3["override_entrances"] ) && var_3["override_entrances"].size > 0 )
        {
            ...
            self._id_27A3 = self._id_02A7 + " " + gettime();

            foreach ( var_8 in self._id_27B4 )
            {
                var_8._id_7020[self._id_27A3] = maps\mp\bots\_bots_util::_id_332B( var_8._id_02E2, maps\mp\bots\_bots_util::_id_27A8(), "prone" );
                wait 0.05;
                var_8._id_2480[self._id_27A3] = maps\mp\bots\_bots_util::_id_332B( var_8._id_02E2, maps\mp\bots\_bots_util::_id_27A8(), "crouch" );
                wait 0.05;
            }
        }
    ...
    if ( !isdefined( self._id_15EE ) )
    {
        ...
        if ( !isdefined( var_10 ) )
            var_10 = _func_0C8( maps\mp\bots\_bots_util::_id_27A8() );

        if ( !isdefined( var_10 ) )
        {
            var_11 = maps\mp\bots\_bots_util::_id_27A8();
            var_12 = _func_0C7( var_11, 256, 0 );

            for ( var_13 = 0; var_13 < var_12.size; var_13++ )
            {
                var_14 = _func_114( var_12[var_13]._id_02E2 - var_11 );
                var_15 = var_11 + var_14 * 15;

                if ( _func_08E( var_15, var_12[var_13]._id_02E2, 0, undefined ) )
                {
                ...
                if ( _func_08E( var_15 + ( 0, 0, 55 ), var_12[var_13]._id_02E2 + ( 0, 0, 55 ), 0, undefined ) )
                {
                    var_10 = var_12[var_13];
                    break;
                }
    ...
    for (;;)
    {
        ...
        var_18 = isdefined( var_3["entrance_points_index"] ) && _func_0CE( var_3["entrance_points_index"] );
        ...
        {
            if ( isdefined( level._id_0886 ) && level._id_0886[self._id_04A7] )
            {
        ...
        {
            if ( var_23 && maps\mp\bots\_bots_util::_id_1662() && !_func_1AD( var_0 ) && isdefined( self._id_27A3 ) )
            {
        ...
        var_30 = _func_0B5( var_21, var_22 );
...
_id_847B( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        return _func_0F0( self._id_02E2, self._id_15F2 ) > var_2 * 0.75 * 0.75;
    }
    else if ( self _meth_8373() && _func_0F0( self._id_02E2, self._id_15F2 ) < var_2 )
    {
...
_id_27AF()
{
    ...
    var_7 = var_6 * var_6;
    var_8 = _func_0C6( self._id_15F2, var_6, 0, 500 );

    if ( var_8.size <= 0 )
        return;

    var_9 = 5 + self _meth_8379( "strategyLevel" ) * 2;
    var_10 = _func_0BC( _func_0BF( var_9, var_8.size ) );
    ...
    var_14 = _func_1F5( 0, gettime() - 60000, 1, "death", 0, self );

    foreach ( var_16 in var_14 )
    {
        if ( _func_0F0( var_16, self._id_15F2 ) < var_7 )
        {
            var_17 = _func_0C8( var_16 );
    ...
    for ( var_23 = 1; var_23 < var_5.size - 2; var_23++ )
    {
        ...
        {
            if ( !common_scripts\utility::_id_A347( self._id_02E2, self _meth_8338(), var_24[var_12]._id_02E2, 0 ) )
                continue;
            ...
            for ( var_26 = 0; var_26 < self._id_57FD.size; var_26++ )
            {
                ...
                if ( _func_204( var_16._id_02BB, var_24[var_12], 1 ) )
                {
        ...
        if ( isdefined( var_27 ) )
        {
            ...
            {
                if ( _func_204( self._id_57FD[var_12]._id_02BB, var_27, 1 ) )
                {
                    if ( _func_225( self._id_57FD[var_12]._id_02E2, var_27._id_02E2 ) > 3600 )
            ...
            if ( var_29 == "goal" )
            {
                ...
                {
                    if ( _func_225( self._id_02E2, var_28[var_12]._id_02E2 ) < 1600 )
                        continue;

                    for ( var_30 = 0; var_28[var_12]._id_3A11 < 18 && var_30 < 3.6; var_30 += 0.25 )
                    {
                        self _meth_836B( var_28[var_12]._id_02E2 + ( 0, 0, self _meth_82EF() ), 0.25, "script_search" );
                        wait 0.25;
                    }
                }
            }
...
_id_5D71()
{
    ...
    for (;;)
    {
        if ( _func_0F0( self._id_02E2, self._id_15F2 ) < var_0 )
...
_id_5D70()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            {
                if ( _func_204( var_1, self._id_57FD[var_3]._id_02BB, 1 ) )
                {
                    var_4 = common_scripts\utility::_id_A347( self._id_02E2, self _meth_8338(), self._id_57FD[var_3]._id_02E2, var_2 );
                    var_5 = !var_4 || self._id_57FD[var_3]._id_3A11 < 17;

                    if ( var_5 && _func_0F0( self._id_02E2, self._id_57FD[var_3]._id_02E2 ) < var_0 )
                    {
                        var_4 = 1;
...
_id_7040()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            ...
            if ( var_7._id_01E6 == 0 && isdefined( var_7._id_2671 ) && var_4 - var_7._id_2671 < 5000 )
            {
                if ( var_4 - var_7._id_5537 > 10000 && var_4 > var_0[var_8] )
                {
                    if ( isdefined( var_7._id_0246 ) && isdefined( var_7._id_0246._id_04A7 ) && var_7._id_0246._id_04A7 == common_scripts\utility::_id_3D4F( self._id_04A7 ) )
                    {
                        if ( _func_0F0( var_7.body._id_02E2, self._id_02E2 ) < var_2 )
                        {
                            self _meth_8375( var_7._id_0246, var_7.body._id_02E2 );
                            var_9 = _func_0C8( var_7.body._id_02E2 );

                            if ( isdefined( var_9 ) )
                            {
                                self._id_27B3 = var_9._id_02E2;
...
_id_27B6()
{
    ...
    if ( maps\mp\bots\_bots_util::_id_165A() )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                if ( _func_204( var_0, var_4, 1 ) )
                    var_1 = common_scripts\utility::_id_0CDA( var_1, var_4 );
            }
        }

        if ( var_1.size == 0 )
            var_1 = _func_212( self._id_02E2 );
    }
    else if ( maps\mp\bots\_bots_util::_id_1662() || maps\mp\bots\_bots_util::_id_1659() )
    {
        var_1 = _id_27B2();

        if ( isdefined( var_0 ) && !_func_120( self _meth_830E(), "riotshield" ) )
        {
            if ( _func_204( var_0, self._id_6122, 1 ) )
...
_id_16A7()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in self._id_A1EA )
        {
            ...
            var_3 = var_2._id_02E2 - self._id_15EE._id_02E2;
            var_3 = _func_114( var_3 );
            var_4 = _func_0F6( var_0, var_3 );
...
_id_332A( var_0 )
{
    var_1 = _func_20B( var_0 );
    var_2 = _func_114( var_0._id_02E2 - self._id_02E2 );

    for ( var_3 = 0; var_3 < level._id_A3EF; var_3++ )
    {
        if ( _func_1F7( var_3, self._id_04A7, "enemy_predict" ) > 0 )
        {
            if ( isdefined( var_1 ) && var_3 == var_1 )
                return 1;
            else
            {
                var_4 = _func_114( _func_20A( var_3 ) - self._id_02E2 );
                var_5 = _func_0F6( var_2, var_4 );
...
_id_6FBD( var_0 )
{
    ...
    for ( var_2 = 0; var_2 < level._id_A3EF; var_2++ )
    {
        ...
        var_3 = _func_114( _func_20A( var_2 ) - self._id_02E2 );

        for ( var_4 = 0; var_4 < var_1.size; var_4++ )
        {
            var_5 = _func_20B( var_1[var_4] );
            var_6 = 0;
            ...
            {
                var_7 = _func_114( var_1[var_4]._id_02E2 - self._id_02E2 );
                var_8 = _func_0F6( var_7, var_3 );
...
_id_332F( var_0, var_1 )
{
    ...
    var_3 = _func_114( var_1._id_02E2 - var_0._id_02E2 );
...
_id_163F( var_0, var_1 )
{
    ...
    {
        if ( !_func_0CF( var_5 ) || var_5 maps\mp\bots\_bots_util::_id_165E( var_0 ) )
...
_id_1640( var_0, var_1 )
{
    ...
    for ( var_4 = 0; var_4 < level._id_669D.size; var_4++ )
    {
        ...
        if ( var_5 != self && isdefined( var_5._id_04A7 ) && var_5._id_04A7 == self._id_04A7 && maps\mp\_utility::_id_51CE( var_5 ) )
        {
            if ( _func_0F0( var_0, var_5._id_02E2 ) < var_2 )
...
_id_27A5( var_0 )
{
    ...
    foreach ( var_3 in level._id_669D )
    {
        ...
        if ( var_3._id_04A7 == self._id_04A7 && var_3 != self && _func_0CF( var_3 ) && var_3 maps\mp\bots\_bots_util::_id_165D() && var_3._id_24BD == var_0 )
        {
...
_id_5D82()
{
    ...
    for (;;)
    {
        ...
        self._id_15F2 = self._id_15EE._id_02E2;
        ...
        if ( self _meth_835B() != "none" )
        {
            ...
            var_7 = _func_0F3( var_6 );

            if ( var_7 > 100 )
            {
                var_0 = 0;

                if ( _func_0F0( var_2, self._id_15EE._id_02E2 ) > var_1 * var_1 )
                {
                    var_2 = self._id_15EE._id_02E2;
                    var_4 = 1;
                    var_8 = _func_114( var_5 - self._id_15EE._id_02E2 );
                    var_9 = _func_114( var_6 );

                    if ( _func_0F6( var_8, var_9 ) < 0.1 )
                    {
                        self notify( "defend_force_node_recalculation" );
                        wait 0.25;
                    }
            ...
            else
            {
                ...
                if ( var_0 > 0.5 )
                {
                    var_10 = _func_0F0( var_5, self._id_15F2 );
            ...
            if ( _func_0BE( self._id_15EE._id_02E2[2] - var_5[2] ) >= 50 )
            {
                self notify( "defend_force_node_recalculation" );
                wait 0.25;
            }
...
_id_375F()
{
    ...
    if ( isdefined( var_1 ) )
    {
        if ( isdefined( var_0 ) )
        {
            var_2 = _func_114( var_0 - var_1._id_02E2 );
            self._id_24BA = _func_115( var_2 );
        }
        else
        {
            var_3 = _func_114( var_1._id_02E2 - maps\mp\bots\_bots_util::_id_27A8() );
            self._id_24BA = _func_115( var_3 );
        }
...
_id_3762()
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_1 = _func_114( maps\mp\bots\_bots_util::_id_27A8() - var_0._id_02E2 );
        self._id_24BA = _func_115( var_1 );
        self._id_24BB = var_0;
    }
    else
...
{
    var_0 = undefined;
    var_1 = _func_0C6( maps\mp\bots\_bots_util::_id_27A8(), self._id_15F5, 0 );
...
_id_1648( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_2 = _func_114( var_0 - self._id_24BC );
        self._id_24BA = _func_115( var_2 );
    }
    else if ( isdefined( var_1 ) )
    {
        var_2 = _func_114( self._id_24BC - var_1 );
        self._id_24BA = _func_115( var_2 );
    }
}
...
_id_15D5( var_0, var_1, var_2, var_3 )
{
    for ( var_4 = 0; var_4 < level._id_669D.size; var_4++ )
    {
        ...
        if ( var_5._id_04A7 == self._id_04A7 && var_5 != self )
        {
            if ( _func_0CF( var_5 ) )
            {
                if ( var_2 )
                {
                    if ( _func_0F0( var_0, var_5._id_02E2 ) < 441 )
                        return 1;
                }
...
_id_15D3()
{
    ...
    if ( isdefined( self._id_15F3 ) )
    {
        ...
        {
            var_3 = _func_0EE( self._id_15F2, var_2._id_02E2 );
            var_0 = _func_0E1( var_3, var_0 );
        }
    }
    ...
    for (;;)
    {
        if ( self._id_90AF.size > 0 && !maps\mp\bots\_bots_util::_id_1664() )
        {
            ...
            if ( !isdefined( var_0._id_06BA ) )
            {
                ...
                self _meth_8352( var_0._id_424F, var_0._id_4250, var_1, var_0._id_01C1, var_0._id_62F3, var_0.short_term_goal );
...
bot_get_active_tactical_goals_of_type( var_0 )
{
    ...
    if ( isdefined( self._id_90AF ) )
    {
        foreach ( var_3 in self._id_90AF )
        {
            if ( !maps\mp\_utility::_id_5092( var_3._id_06BA ) && var_3._id_04D9 == var_0 )
...
_id_15F9()
{
    ...
    {
        if ( var_1._id_04D9 != "map_interactive_object" )
            var_1._id_06BA = 1;
    }
}
...
_id_16A0()
{
    ...
    if ( !isdefined( self._id_553E ) || var_0 - self._id_553E > 1000 )
    {
        ...
        var_3 = _func_1F9( var_2, self._id_04A7, 1, "enemy_predict", ">", 0 );

        if ( !isdefined( var_3 ) )
            return 0;

        var_4 = _func_0C6( self._id_02E2, 500, 0 );
