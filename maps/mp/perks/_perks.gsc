...
{
    return _func_1BB( "mp/perktable.csv", 1, var_0, 13 );
}

perktablelookupcount( var_0 )
{
    return _func_0BC( _func_1BB( "mp/perktable.csv", 1, var_0, 6 ) );
}

perktablelookupslot( var_0 )
{
    return _func_0BC( _func_1BB( "mp/perktable.csv", 1, var_0, 12 ) );
}

perktablelookuplocalizedname( var_0 )
{
    return _func_1BD( "mp/perktable.csv", 1, var_0, 2 );
}

perktablelookupimage( var_0 )
{
    return _func_1BB( "mp/perktable.csv", 1, var_0, 3 );
}
...
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) || !_func_1AD( var_1 ) || !maps\mp\_utility::_id_4FA6() && !_func_1AD( var_0 ) )
        return var_2;

    if ( var_1._id_03BC != "playing" || !isdefined( var_2 ) || !isdefined( var_3 ) )
        return var_2;
    ...
    if ( isdefined( var_1 ) && var_1 maps\mp\_utility::_id_05CB( "specialty_bulletdamage" ) && maps\mp\_utility::_id_50CD( var_3 ) )
    {
        if ( isdefined( var_0 ) && _func_1AD( var_0 ) && var_0 maps\mp\_utility::_id_05CB( "specialty_armorvest" ) )
            var_10 = var_9;
        else
            var_10 += var_2 * level._id_18AB;
    }
    else if ( isdefined( var_1 ) && var_1 maps\mp\_utility::_id_05CB( "specialty_explosivedamage" ) && _func_188( var_3 ) )
    {
        if ( isdefined( var_0 ) && _func_1AD( var_0 ) && var_0 maps\mp\_utility::_id_05CB( "specialty_armorvest" ) )
            var_10 = var_9;
        else
    ...
    else if ( isdefined( var_0 ) && _func_1AD( var_0 ) && var_0 maps\mp\_utility::_id_05CB( "specialty_armorvest" ) )
...
_id_41E3()
{
    ...
    maps\mp\_utility::_id_067B( "specialty_blindeye" );
    self._id_89F9 = 0;
}
...
_id_0CAF()
{
    ...
    if ( maps\mp\_utility::_id_05CB( "specialty_extended_battery" ) )
        maps\mp\_utility::_id_41F8( "specialty_exo_slamboots", 0 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_lowprofile" ) )
        maps\mp\_utility::_id_41F8( "specialty_radarimmune", 0 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_flakjacket" ) )
    {
        ...
        if ( isdefined( level._id_46CA ) && level._id_46CA )
            self._id_8A39 = maps\mp\_utility::_id_3FDB( "perk_blastShieldScale_HC", 50 ) / 100;
    }

    if ( maps\mp\_utility::_id_05CB( "specialty_class_lightweight" ) )
        maps\mp\_utility::_id_41F8( "specialty_lightweight", 0 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_dangerclose" ) )
        maps\mp\_utility::_id_41F8( "specialty_explosivedamage", 0 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_blindeye" ) )
    {
        maps\mp\_utility::_id_41F8( "specialty_blindeye", 0 );
        maps\mp\_utility::_id_41F8( "specialty_plainsight", 0 );
    }

    if ( maps\mp\_utility::_id_05CB( "specialty_class_coldblooded" ) )
    {
    ...
    if ( maps\mp\_utility::_id_05CB( "specialty_class_peripherals" ) )
    {
        maps\mp\_utility::_id_41F8( "specialty_moreminimap", 0 );
        maps\mp\_utility::_id_41F8( "specialty_silentkill", 0 );
    }

    if ( maps\mp\_utility::_id_05CB( "specialty_class_fasthands" ) )
    {
    ...
    if ( maps\mp\_utility::_id_05CB( "specialty_class_dexterity" ) )
        maps\mp\_utility::_id_41F8( "specialty_sprintfire", 0 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_hardwired" ) )
    {
    ...
    if ( maps\mp\_utility::_id_05CB( "specialty_class_toughness" ) )
        self _meth_8306( 0.2 );

    if ( maps\mp\_utility::_id_05CB( "specialty_class_scavenger" ) )
    {
        self._id_0B7B = 0.2;
    ...
    if ( maps\mp\_utility::_id_05CB( "specialty_class_hardline" ) )
...
get_specialtydata( var_0, var_1, var_2 )
{
    ...
    if ( var_1 == "specialty1" )
    {
        if ( _func_120( var_3, "grenade" ) )
        {
            ...
            if ( var_0 == "specialty_specialgrenade" && isdefined( var_2._id_02D6 ) && var_2._id_02D6 != "h1_smokegrenade_mp" )
...
giveperkinventory()
{
    ...
    if ( isdefined( var_0 ) && var_0 != "" )
    {
        ...
        self _meth_8305( 3, "weapon", var_0 );
    }
    else
...
{
    if ( _func_1E8( var_0 ) )
        self _meth_82F3( var_0, var_1 );
    else
    {
        self _meth_82F3( var_0, var_1 );
        var_2 = var_1 - self _meth_82F5( var_0 );
        self _meth_82F4( var_0, var_2 );
    }
}
