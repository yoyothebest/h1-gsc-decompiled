...
_id_40D7( var_0 )
{
    ...
    if ( var_1["primary"].size )
    {
        ...
        level.badspawncount[self._id_04A7] = 0;
    }
    ...
    else
    {
        ...
        level.badspawncount[self._id_04A7]++;
    }
...
_id_7C62( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) && var_2 && var_1.size > 1 )
    {
        ...
        var_5 = _func_0BC( _func_0BF( level.badspawncount[self._id_04A7] / 2 + 1, var_1.size - 1 ) );
        var_3 = var_1[_func_0B2( var_5 )];
        var_3._id_5188 = 1;
    }
    else
        var_4 = var_1.size;
