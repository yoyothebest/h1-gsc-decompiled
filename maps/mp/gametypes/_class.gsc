...
_id_1985( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "weaponSetups", var_1, "weapon" );
    else
...
_id_1989( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "weaponSetups", var_1, "camo" );
    else
...
_id_198A( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "weaponSetups", var_1, "reticle" );
    else
...
cac_getweaponattachkitid( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        var_3 = self _meth_8446( level._id_39B1, var_0, "weaponSetups", var_1, "kit", "attachKit" );
    else
...
cac_getweaponfurniturekitid( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        var_3 = self _meth_8446( level._id_39B1, var_0, "weaponSetups", var_1, "kit", "furnitureKit" );
    else
...
cac_getweaponfurniturekit( var_0, var_1, var_2 )
{
    ...
    var_4 = _func_1BB( "mp/furniturekits.csv", 0, common_scripts\utility::_id_93F2( var_3 ), 1 );
    return var_4;
}
...
cac_getmeleeweapon( var_0, var_1 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "meleeWeapon" );
    else
...
_id_1984( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "perkSlots", var_1 );
    else
...
_id_197F( var_0, var_1, var_2 )
{
    if ( usevirtuallobbyfunction() )
        ...
        return self _meth_8446( level._id_39B1, var_0, "equipment", var_1 );
    else
...
_id_1B0F( var_0, var_1 )
{
    if ( maps\mp\_utility::_id_4FA6() && isdefined( var_1 ) )
        ...
        return self _meth_8226( common_scripts\utility::getstatsgroup_common(), "globalCostume", var_0 );
}
...
_id_1B10( var_0, var_1, var_2 )
{
    if ( maps\mp\_utility::_id_4FA6() && isdefined( var_2 ) )
        ...
        return self _meth_8226( common_scripts\utility::getstatsgroup_common(), "costumes", var_1, var_0 );
}

_id_1B17( var_0, var_1 )
{
    return self _meth_8243( common_scripts\utility::getstatsgroup_common(), "globalCostume", var_0, var_1 );
}

_id_1B18( var_0, var_1, var_2 )
{
    return self _meth_8243( common_scripts\utility::getstatsgroup_common(), "costumes", var_2, var_0, var_1 );
}
...
_id_1B0D( var_0 )
{
    if ( maps\mp\_utility::_id_4FA6() && isdefined( var_0 ) )
        ...
        return self _meth_8226( common_scripts\utility::getstatsgroup_common(), "activeCostume" );
}
...
cao_getcharactercamoindex( var_0 )
{
    if ( maps\mp\_utility::_id_4FA6() && isdefined( var_0 ) )
        ...
        return self _meth_8226( common_scripts\utility::getstatsgroup_common(), "characterCamoIndex" );
}
...
cac_setlastteam( var_0 )
{
    ...
    self _meth_8243( common_scripts\utility::getstatsgroup_common(), "lastGame", "team", var_1 );
}
...
cac_setlastgrouplocation( var_0 )
{
    ...
    self _meth_8243( common_scripts\utility::getstatsgroup_common(), "lastGame", "classLocation", var_0 );
}
...
cac_setlastclassindex( var_0 )
{
    ...
    self _meth_8243( common_scripts\utility::getstatsgroup_common(), "lastGame", "classIndex", var_0 );
}
...
cac_setlastenvironment( var_0 )
{
    ...
    self _meth_8243( common_scripts\utility::getstatsgroup_common(), "lastGame", "environment", var_1 );
}
...
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimary", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondary", var_1 + 1 );
}

_id_90A6( var_0, var_1, var_2 )
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimaryBuff", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondaryBuff", var_1 + 1 );
}

_id_90A7( var_0, var_1, var_2 )
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimaryCamo", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondaryCamo", var_1 + 1 );
}

_id_90A8( var_0, var_1, var_2 )
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimaryReticle", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondaryReticle", var_1 + 1 );
}

table_getweaponattachkit( var_0, var_1, var_2 )
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimaryAttachKit", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondaryAttachKit", var_1 + 1 );
}

table_getweaponfurniturekit( var_0, var_1, var_2 )
{
    if ( var_2 == 0 )
        return _func_1BB( var_0, 0, "loadoutPrimaryFurnitureKit", var_1 + 1 );
    else
        return _func_1BB( var_0, 0, "loadoutSecondaryFurnitureKit", var_1 + 1 );
}
...
_id_90A2( var_0, var_1, var_2 )
{
    ...
    return _func_1BB( var_0, 0, var_3, var_1 + 1 );
}

_id_909C( var_0, var_1 )
{
    return _func_1BB( var_0, 0, "loadoutEquipment", var_1 + 1 );
}

_id_90A3( var_0, var_1 )
{
    return _func_1BB( var_0, 0, "loadoutTeamPerk", var_1 + 1 );
}

_id_90A0( var_0, var_1 )
{
    return _func_1BB( var_0, 0, "loadoutOffhand", var_1 + 1 );
}

attachkitnametoid( var_0 )
{
    var_1 = _func_1BB( "mp/attachkits.csv", 1, var_0, 0 );
...
_id_1FCA()
{
    ...
    if ( var_1 == "copycat" )
    {
        var_1 = self._id_0308["copyCatLoadout"]["className"];

        if ( var_1 == "callback" )
            var_2 = self._id_0308["copyCatLoadout"]["classCallbackFunc"];
    }

    if ( _func_120( var_1, "axis" ) )
        var_0 = "axis";
    else if ( _func_120( var_1, "allies" ) )
        var_0 = "allies";
    ...
    if ( var_0 != "none" )
    {
        ...
        var_5 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 0, "weapon" );
        var_6 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 0, "kit", "attachKit" );
        var_7 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 0, "kit", "furnitureKit" );
        var_8 = _func_1BB( "mp/attachkits.csv", 0, common_scripts\utility::_id_93F2( var_6 ), 1 );
        var_9 = _func_1BB( "mp/furniturekits.csv", 0, common_scripts\utility::_id_93F2( var_7 ), 1 );
        var_10 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 0, "camo" );
        var_11 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 0, "reticle" );
        var_12 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 1, "weapon" );
        var_6 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 1, "kit", "attachKit" );
        var_7 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 1, "kit", "furnitureKit" );
        var_13 = _func_1BB( "mp/attachkits.csv", 0, common_scripts\utility::_id_93F2( var_6 ), 1 );
        var_14 = _func_1BB( "mp/furniturekits.csv", 0, common_scripts\utility::_id_93F2( var_7 ), 1 );
        var_15 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 1, "camo" );
        var_16 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "weaponSetups", 1, "reticle" );
        var_17 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "equipment", 0 );
        var_18 = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "equipment", 1 );

        for ( var_19 = 0; var_19 < 3; var_19++ )
            var_3[var_19] = _func_13D( "defaultClasses", var_0, "defaultClass", var_4, "class", "perkSlots", var_19 );
...
_id_4009( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( self._id_0308["copyCatLoadout"] ) && self._id_0308["copyCatLoadout"]["inUse"] && var_2 )
    {
        var_10 = 1;
        var_9 = 0;
        var_6 = maps\mp\_utility::_id_3F32( "copycat" );
        var_14 = self._id_0308["copyCatLoadout"];
    ...
    else if ( var_13 != "none" )
    {
        ...
        var_15 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 0, "weapon" );
        ...
        {
            var_30 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 0, "kit", "attachKit" );
            var_31 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 0, "kit", "furnitureKit" );
            var_16 = _func_1BB( "mp/attachkits.csv", 0, common_scripts\utility::_id_93F2( var_30 ), 1 );
            var_17 = _func_1BB( "mp/furniturekits.csv", 0, common_scripts\utility::_id_93F2( var_31 ), 1 );
        }

        var_18 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 0, "camo" );
        var_19 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 0, "reticle" );
        var_20 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 1, "weapon" );
        var_30 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 1, "kit", "attachKit" );
        var_31 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 1, "kit", "furnitureKit" );
        var_21 = _func_1BB( "mp/attachkits.csv", 0, common_scripts\utility::_id_93F2( var_30 ), 1 );
        var_22 = _func_1BB( "mp/furniturekits.csv", 0, common_scripts\utility::_id_93F2( var_31 ), 1 );
        var_23 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 1, "camo" );
        var_24 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "weaponSetups", 1, "reticle" );
        var_25 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "equipment", 0 );
        var_26 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "equipment", 1 );

        for ( var_27 = 0; var_27 < 3; var_27++ )
            var_11[var_27] = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "perkSlots", var_27 );

        var_28 = _func_13D( "defaultClasses", var_13, "defaultClass", var_29, "class", "meleeWeapon" );
    ...
    {
        var_34 = self._id_0308["gamemodeLoadout"];
    ...
    var_36 = _func_120( var_1, "custom" ) || _func_120( var_1, "lobby" );
    var_37 = _func_120( var_1, "recipe" );
    var_38 = 0;

    if ( !var_12 && !var_37 && !level.oldschool && !( isdefined( self._id_0308["copyCatLoadout"] ) && self._id_0308["copyCatLoadout"]["inUse"] && var_2 ) )
    {
        if ( !_id_51F3( var_15, 1 ) || level._id_7137 && var_36 && !var_38 && !self _meth_8225( var_15 ) )
        {
        ...
        if ( !_id_51E7( var_18, 1 ) || level._id_7137 && var_36 && !var_38 && !_id_50D6( var_15, var_18 ) )
            var_18 = _id_90A7( level._id_1E3D, 10, 0 );

        if ( !_id_51F4( var_19, 1 ) )
            var_19 = _id_90A8( level._id_1E3D, 10, 0 );

        if ( !isvalidattachkit( var_16, var_15, 1 ) || level._id_7137 && var_36 && !var_38 && !isattachkitunlocked( var_15, var_16 ) )
            var_16 = table_getweaponattachkit( level._id_1E3D, 10, 0 );

        if ( !isvalidfurniturekit( var_17, var_15, 1 ) || level._id_7137 && var_36 && !var_38 && !isfurniturekitunlocked( var_15, var_17 ) )
        ...
        if ( !_id_51F5( var_20, var_40, 1 ) || level._id_7137 && var_36 && !var_38 && !self _meth_8225( var_20 ) )
        {
        ...
        if ( !_id_51E7( var_23, 1 ) || level._id_7137 && var_36 && !var_38 && !_id_50D6( var_20, var_23 ) )
            var_23 = _id_90A7( level._id_1E3D, 10, 1 );

        if ( !_id_51F4( var_24, 1 ) )
            var_24 = _id_90A8( level._id_1E3D, 10, 1 );

        if ( !isvalidattachkit( var_21, var_20, 1 ) || level._id_7137 && var_36 && !var_38 && !isattachkitunlocked( var_20, var_21 ) )
            var_21 = table_getweaponattachkit( level._id_1E3D, 10, 1 );

        if ( !isvalidfurniturekit( var_22, var_20, 1 ) || level._id_7137 && var_36 && !var_38 && !isfurniturekitunlocked( var_20, var_22 ) )
            var_22 = table_getweaponfurniturekit( level._id_1E3D, 10, 1 );

        if ( !_id_51EA( var_25, 1 ) || level._id_7137 && var_36 && !var_38 && !self _meth_8225( var_25 ) )
    ...
    {
        var_42 = self _meth_8226( common_scripts\utility::getstatsgroup_common(), "emblemPatchIndex" );

        if ( _func_0CF( self ) )
        {
            var_43 = self._id_0308["shouldApplyEmblemToWeapon"];
            var_44 = self._id_0308["shouldApplyEmblemToCharacter"];
        }
        else
        {
            var_43 = self _meth_8226( common_scripts\utility::getstatsgroup_common(), "applyEmblemToWeapon" );
            var_44 = self _meth_8226( common_scripts\utility::getstatsgroup_common(), "applyEmblemToCharacter" );
        }
    }
    ...
    if ( maps\mp\_utility::_id_4FA6() )
        ...
        var_46 = self _meth_8226( common_scripts\utility::getstatsgroup_common(), "characterCamoIndex" );

    var_33 = spawnstruct();
    var_33._id_1E2E = var_1;
    ...
    var_33._id_0336 = var_15;
    var_33._id_033B = var_16;
    var_33._id_033D = var_17;
    var_33._id_033C = var_18;
    var_33._id_033F = var_19;
    var_18 = _func_0BC( _func_1BB( "mp/camoTable.csv", 1, var_33._id_033C, 0 ) );
    var_19 = _func_0BC( _func_1BB( "mp/reticleTable.csv", 1, var_33._id_033F, 0 ) );
    var_33._id_6F84 = _id_188C( var_33._id_0336, var_33._id_033B, var_33._id_033D, var_18, var_19, var_45 );
    var_33._id_03AA = var_20;
    var_33._id_03AE = var_21;
    var_33._id_03B0 = var_22;
    var_33._id_03AF = var_23;
    var_33._id_03B2 = var_24;
    var_23 = _func_0BC( _func_1BB( "mp/camoTable.csv", 1, var_33._id_03AF, 0 ) );
    var_24 = _func_0BC( _func_1BB( "mp/reticleTable.csv", 1, var_33._id_03B2, 0 ) );
    var_33._id_7BFA = _id_188C( var_33._id_03AA, var_33._id_03AE, var_33._id_03B0, var_23, var_24, var_45 );
    var_33._id_0155 = var_25;
    var_33._id_02D6 = var_26;
    var_33._id_0306 = var_11;
...
_id_0CAE()
{
    ...
    self._id_57DF = var_0._id_0336;
    self._id_57E0 = _func_0BC( _func_1BB( "mp/camoTable.csv", 1, var_0._id_033C, 0 ) );
    self._id_57E2 = var_0._id_03AA;
    self._id_57E3 = _func_0BC( _func_1BB( "mp/camoTable.csv", 1, var_0._id_03AF, 0 ) );

    if ( !_func_120( var_0._id_0336, "iw5" ) && !_func_120( var_0._id_0336, "h1_" ) )
        self._id_57E0 = 0;

    if ( !_func_120( var_0._id_03AA, "iw5" ) && !_func_120( var_0._id_03AA, "h1_" ) )
        self._id_57E3 = 0;

    self._id_57E1 = _func_0BC( _func_1BB( "mp/reticleTable.csv", 1, var_0._id_033F, 0 ) );
    self._id_57E4 = _func_0BC( _func_1BB( "mp/reticleTable.csv", 1, var_0._id_03B2, 0 ) );
    ...
    self _meth_8341( var_0._id_0155 );

    if ( var_0._id_0155 != "specialty_null" && self _meth_8311( var_0._id_0155 ) )
    {
        var_3 = self _meth_82F5( var_0._id_0155 );
        self _meth_82F3( var_0._id_0155, var_3 + 1 );
    }
    else
        _id_41F5( var_0._id_0155 );

    if ( var_0._id_0155 != "specialty_null" && isdefined( self.perkscustom["grenades_count"] ) )
    {
        var_4 = self.perkscustom["grenades_count"];
        self _meth_82F3( var_0._id_0155, var_4 );
    }
    ...
    if ( !_func_0CF( self ) && !maps\mp\_utility::ishodgepodgemm() )
        self _meth_8312( var_5 );

    if ( var_0._id_7FF5 )
        self _meth_824B( maps\mp\_utility::_id_3E67( var_0 ) );

    self._id_0308["primaryWeapon"] = maps\mp\_utility::_id_3F11( var_5 );
    self._id_57DD = var_0._id_02D6;
    self _meth_8316( var_0._id_02D6 );

    if ( !level.oldschool )
        _id_41F5( var_0._id_02D6 );

    if ( level.oldschool )
        self _meth_82F3( var_0._id_02D6, 0 );

    if ( var_0._id_02D6 != "specialty_null" && isdefined( self.perkscustom["specialgrenades_count"] ) )
    {
        var_4 = self.perkscustom["specialgrenades_count"];
        self _meth_82F3( var_0._id_02D6, var_4 );
    }
    ...
    self._id_51AB = _func_1B8( self._id_0340 ) == "sniper";
    ...
    {
        self _meth_832F( var_5 );

        if ( var_2 != "none" )
            self _meth_832F( var_2 );
    }

    if ( !_func_120( var_0._id_1E2E, "juggernaut" ) )
    {
        if ( isdefined( self._id_5589 ) && self._id_5589 != "" && self._id_5589 != self._id_1E2E )
            self notify( "changed_class" );

        self._id_0308["lastClass"] = self._id_1E2E;
        self._id_5589 = self._id_1E2E;
    }

    if ( isdefined( self._id_3BF3 ) )
    {
        self._id_0308["class"] = self._id_3BF3;
        self._id_0308["lastClass"] = self._id_3BF3;
        self._id_1E2E = self._id_3BF3;

        if ( !isdefined( self.gamemode_carrierclass ) )
            self._id_5589 = self._id_3BF3;
    ...
    if ( !isdefined( level.iszombiegame ) || !level.iszombiegame )
    {
        ...
        if ( maps\mp\_utility::_id_4FA6() && isdefined( level.vl_cac_getfactionteam ) && isdefined( level.vl_cac_getfactionenvironment ) )
        {
            ...
            maps\mp\gametypes\_teams::applycostume( var_6, self._id_04A7 );

        _id_5843();
        self _meth_857C( var_0._id_A7ED );
    }

    switch ( _func_1B8( var_6 ) )
    {
        case "rifle":
            self _meth_81E4( 0.95 );
            break;
        case "pistol":
            self _meth_81E4( 1.0 );
            break;
        case "mg":
            self _meth_81E4( 0.875 );
            break;
        case "smg":
            self _meth_81E4( 1.0 );
            break;
...
_id_5843()
{
    ...
    if ( !isdefined( self._id_223A ) )
    {
        ...
        _func_12F( "players", self._id_1F0F, "costume", "gender", var_0 );
        _func_12F( "players", self._id_1F0F, "costume", "head", var_1 );
        _func_12F( "players", self._id_1F0F, "costume", "shirt", var_3 );
        _func_12F( "players", self._id_1F0F, "costume", "gloves", var_4 );
        self._id_223A = 1;
    }
}

_id_41E0( var_0, var_1, var_2, var_3 )
{
    _id_41F1( var_0, var_1, var_2, var_3 );
    _id_0CAE();
}
...
_id_41E5()
{
    ...
    if ( !maps\mp\_utility::_id_05CB( "specialty_blindeye" ) && self._id_11FC > 0 )
...
_id_728C()
{
    if ( isdefined( self ) && isdefined( self._id_0308 ) && isdefined( self._id_0308["validationInfractions"] ) )
        self._id_0308["validationInfractions"] += 1;
}
...
_id_57D9( var_0 )
{
    ...
    self._id_57DE = var_1;
    self._id_57DB = var_0._id_0155;
}

_id_5101( var_0 )
{
    if ( _func_120( var_0, "_exoxmg" ) )
        return 1;
...
{
    var_2 = maps\mp\_utility::_id_4167( var_0 ) == "weapon_sniper";

    if ( var_2 && !_id_0C97( var_1 ) && !_func_120( var_0, "h1_" ) )
        return 1;
...
_id_07CD( var_0, var_1 )
{
    ...
    if ( _id_6083( var_3, var_1 ) )
    {
        ...
        if ( _func_120( var_3, "iw5_" ) || _func_120( var_3, "iw6_" ) || _func_120( var_3, "h1_" ) )
        {
            var_5 = var_3.size;
            var_4 = _func_122( var_3, 4, var_5 );
        }
...
_id_3F10( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        {
            if ( _func_123( var_0[var_5] ) != _func_123( var_4[var_1] ) )
            {
                var_5 -= var_1;
                var_1 = 0;
                continue;
        ...
        if ( var_1 == var_4.size )
        {
            var_0 = _func_122( var_0, 0, var_5 - var_1 + 1 );
            break;
            continue;
        }
...
_id_188C( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( _func_120( var_0, "iw5_" ) || _func_120( var_0, "h1_" ) )
    {
        var_7 = var_0 + "_mp";
        var_8 = var_0.size;

        if ( _func_120( var_0, "h1_" ) )
            var_6 = _func_122( var_0, 3, var_8 );
        else
            var_6 = _func_122( var_0, 4, var_8 );
    }
    else
    {
        var_7 = var_0;
    ...
    if ( !var_10 )
    {
        var_11 = _func_1BF( "mp/furniturekits/base.csv", 0, var_7 );
    ...
    if ( _func_120( var_7, "iw5_" ) || _func_120( var_7, "h1_" ) )
    {
...
_id_7403()
{
    ...
    for ( var_3 = 0; var_3 < var_2.size; var_3++ )
    {
        ...
        self _meth_82F3( var_4, 9999 );

        if ( var_4 == "h1_claymore_mp" || var_4 == "claymore_detonator_mp" )
            self _meth_82F4( var_4, 2 );
    }

    if ( self _meth_8183( level._id_1E35[var_1]["primary"]["type"] ) < level._id_1E35[var_1]["primary"]["count"] )
        self _meth_82F3( level._id_1E35[var_1]["primary"]["type"], level._id_1E35[var_1]["primary"]["count"] );

    if ( self _meth_8183( level._id_1E35[var_1]["secondary"]["type"] ) < level._id_1E35[var_1]["secondary"]["count"] )
        self _meth_82F3( level._id_1E35[var_1]["secondary"]["type"], level._id_1E35[var_1]["secondary"]["count"] );
}
...
_id_64D1()
{
    for (;;)
    {
        ...
        if ( !isdefined( var_0._id_0308["class"] ) )
            var_0._id_0308["class"] = "";

        if ( !isdefined( var_0._id_0308["lastClass"] ) )
            var_0._id_0308["lastClass"] = "";

        var_0._id_1E2E = var_0._id_0308["class"];
        var_0._id_5589 = var_0._id_0308["lastClass"];
        var_0._id_2992 = 0;
        var_0._id_154C = [];
        var_0._id_154D = [];
    }
...
_id_1EE7()
{
    self._id_0308["copyCatLoadout"]["inUse"] = 0;
}
...
isattachkitunlocked( var_0, var_1 )
{
    ...
    var_2 = _func_1BB( "mp/attachkits.csv", 1, var_1, 7 );

    if ( !self _meth_8225( var_2 ) )
        return 0;

    var_3 = _id_3F10( var_0 );
    var_4 = var_3 + " " + var_1;

    if ( !self _meth_8225( var_4 ) )
        return 0;
...
isvalidattachkit( var_0, var_1, var_2 )
{
    ...
    {
        var_4 = _func_1BC( "mp/attachkits.csv", var_3, 7 );
        var_5 = _func_2E9( var_4 );
    ...
    var_6 = _func_1BC( "mp/attachkits.csv", var_3, 6 );

    if ( var_6 == "" )
        return 1;

    var_7 = maps\mp\_utility::_id_4167( var_1 );
    var_8 = "";
...
isvalidfurniturekit( var_0, var_1, var_2 )
{
    ...
    var_4 = _func_1BC( "mp/furniturekits.csv", var_3, 6 );
...
_id_50D6( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !maps\mp\_utility::_id_4FA6() )
    {
        if ( !self _meth_8225( var_5, var_2 ) )
            return 0;
    }
    else if ( !self _meth_8225( var_5, var_2, var_3 ) )
        return 0;
...
_id_51FC( var_0, var_1 )
{
    if ( !isdefined( level._id_A2E5 ) )
    {
        ...
        foreach ( var_3 in level._id_A2DD )
