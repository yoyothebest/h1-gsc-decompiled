...
main()
{
    ...
    _func_182( 1000, 17300, 0.0, 0.0, 0.0, 0, 0, 0 );
    ...
    common_scripts\utility::_id_0D13( _func_1F2(), maps\_ac130::vehicle_thermal_models );
...
start_church()
{
    ...
    level._id_06CE._id_02E2 = getent( "ac130_waypoint_fight1", "targetname" )._id_02E2;
...
start_field()
{
    ...
    level._id_06CE._id_02E2 = getent( "ac130_waypoint_field1", "targetname" )._id_02E2;
    common_scripts\utility::_id_383F( "clear_to_engage" );
    common_scripts\utility::_id_383F( "allow_context_sensative_dialog" );
...
start_hijack()
{
    ...
    level._id_06CE._id_02E2 = getent( "ac130_waypoint_hijack", "targetname" )._id_02E2;
    common_scripts\utility::_id_383F( "clear_to_engage" );
    common_scripts\utility::_id_383F( "allow_context_sensative_dialog" );
    wait 0.05;
...
start_junkyard()
{
    ...
    level._id_06CE._id_02E2 = getent( "ac130_waypoint_junkyard1", "targetname" )._id_02E2;
    common_scripts\utility::_id_383F( "clear_to_engage" );
    common_scripts\utility::_id_383F( "allow_context_sensative_dialog" );
    wait 0.05;
...
gameplay_hijack()
{
    ...
    if ( getdvar( "ac130_gameplay_enabled" ) == "1" )
    {
        ...
        {
            if ( var_3._id_9D45._id_04A6 == "getaway_vehicle_1" )
                level.getaway_vehicle_1 = var_3;

            if ( var_3._id_9D45._id_04A6 == "getaway_vehicle_2" )
        ...
        _func_1EC( "vehicle_hijack_start_stop", "script_noteworthy" ) waittill( "trigger" );
        level.getaway_vehicle_1 _meth_827F( 0, 10 );
        level.getaway_vehicle_2 _meth_827F( 0, 10 );
        ...
        for ( var_5 = 0; var_5 < level.friendlies.size; var_5++ )
        {
            ...
            if ( !_func_1A1( level.friendlies[var_5] ) )
                continue;
    ...
    if ( getdvar( "ac130_gameplay_enabled" ) == "1" )
    {
        level.getaway_vehicle_1 _meth_828D( 5 );
        wait 1.3;
        level.getaway_vehicle_2 _meth_828D( 5 );
    }
}
...
gameplay_ambush()
{
    ...
    _func_1EC( "stop_at_junkyard", "script_noteworthy" ) waittill( "trigger" );
...
gameplay_junkyard1()
{
    ...
    {
        maps\ac130_code::resetplayerkillcount();
        common_scripts\utility::_id_0D13( _func_0D9( "axis" ), _id_A5A4::_id_7C71 );
...
clear_to_engage( var_0 )
{
    ...
    common_scripts\utility::_id_383F( "clear_to_engage" );
    common_scripts\utility::_id_0D13( _func_0D9(), ::_id_2D39, 0 );
}
...
dialog_opening()
{
    ...
    common_scripts\utility::_id_0D13( _func_0D9(), ::_id_2D39, 1 );
    wait 2;
