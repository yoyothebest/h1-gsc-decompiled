...
{
    var_0 _meth_801D( "weapon_saw", "tag_weapon_right" );
...
drop_pistol( var_0 )
{
    ...
    wait 0.2;
    var_3 = spawn( "script_model", var_0 _meth_8184( var_1 ) );
    var_3 _meth_80B3( "weapon_colt1911_white" );
    var_3.angles = var_0 _meth_8184( var_1 );
    var_3 _meth_82BE( var_3._id_02E2 + ( 0, 0, 0 ), _id_A5A4::vector_multiply( var_3._id_02E2 - var_2, 25 ) );
}
...
precache_crash_models()
{
    ...
    var_0 = _func_1D3( level.jeepride_crash_model );
...
animated_palm_trees_setup()
{
    level._id_0BEC["foliage_sequoia_tree_cut_12_animated"]["still"] = %foliage_sequoia_cut_12_still;
    level._id_0BEC["foliage_sequoia_tree_cut_12_animated"]["strong"] = %foliage_sequoia_cut_12_sway;
    level._id_0BEC["foliage_sequoia_tree_cut_12_animated"]["heli"] = %foliage_sequoia_cut_12_heliwash;
    level._id_0BEC["h1_foliage_jr_pine_01_animated"]["still"] = %jr_pine_01_still;
    level._id_0BEC["h1_foliage_jr_pine_01_animated"]["strong"] = %jr_pine_01_sway;
    level._id_0BEC["h1_foliage_jr_pine_01_animated"]["heli"] = %jr_pine_01_heliwash;
    level._id_0BEC["h1_foliage_jr_pine_02_animated"]["still"] = %jr_pine_02_still;
    level._id_0BEC["h1_foliage_jr_pine_02_animated"]["strong"] = %jr_pine_02_sway;
    level._id_0BEC["h1_foliage_jr_pine_02_animated"]["heli"] = %jr_pine_02_heliwash;
}
