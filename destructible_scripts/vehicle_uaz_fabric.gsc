...
main()
{
    common_scripts\_destructible::_id_2906( "vehicle_uaz_fabric", "tag_body", 250, undefined, 32, "no_melee" );
    ...
    common_scripts\_destructible::_id_2931( undefined, "vehicle_uaz_fabric_dsr", undefined, 32, "no_melee" );
