...
_id_3DE2( var_0 )
{
    if ( isdefined( self._id_04A7 ) && self._id_04A7 == "neutral" )
        return;
    ...
    if ( isdefined( self._id_79EE ) )
    {
        ...
        self._id_02A7 = self._id_79EE;
        _id_40AB( self._id_02A7 );
...
_id_3DE3( var_0 )
{
    ...
    if ( _func_0CF( self ) && self _meth_813F() )
        self._id_0986 = var_3;
    else
        self._id_02A7 = var_3;
}
