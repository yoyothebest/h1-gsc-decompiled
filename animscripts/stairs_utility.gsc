...
{
    var_2 = self _meth_83E3( var_0, var_1, 0, 0, 1, 1 );

    if ( var_2["fraction"] < 1 )
    {
        var_3 = _func_117( var_0, var_1, var_2["fraction"] );
        var_4["pos"] = var_3;
...
{
    return _func_0F6( var_0, var_2 ) + var_1;
}
...
findstaircorner( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_13 += var_10;
    var_14 = -1 * _func_0F6( var_3, var_2 );
    var_12["position"] = sweptspherecast( var_7, var_13, var_6, var_3, var_14 );
    var_12["position"] -= ( 0, 0, var_6 );
    var_12["stairEdgeDirection"] = _func_0F7( var_3, var_5 );
    var_12["stairEdgeDirection"] = _func_114( var_12["stairEdgeDirection"] );
    return var_12;
}
...
getcurrentanimdisplacement( var_0, var_1, var_2 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( var_6 < var_3 )
            var_8 = _func_092( var_0, var_4, var_7 );
        else
        {
            var_9 = var_6 - var_3;
            var_10 = var_9 / var_3;
            var_8 = _func_092( var_0, var_4, 1 );
            var_8 += _func_092( var_0, 0, var_10 );
        }
    }
    else
    {
        var_6 = _func_0BF( var_6, var_3 );
        var_7 = var_6 / var_3;
        var_8 = _func_092( var_0, var_4, var_7 );
    }
...
getstairanimtranslationtoedge( var_0 )
{
    ...
    return _func_092( var_0, 0, var_1[0] );
}

distancebetweentwolines( var_0, var_1, var_2, var_3 )
{
    var_4 = var_0 - var_2;
    var_5 = _func_0F6( var_1, var_1 );
    var_6 = _func_0F6( var_1, var_3 );
    var_7 = _func_0F6( var_3, var_3 );
    var_8 = _func_0F6( var_1, var_4 );
    var_9 = _func_0F6( var_3, var_4 );
    ...
    var_14["distance"] = _func_0F1( var_13 );
...
stairupdatepos( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 = _func_0F1( var_2["trans"] );

    if ( isdefined( var_2["startTime"] ) )
    {
        var_9 = var_2["startTime"];
        var_10 = _func_092( var_0, 0, var_9 );
        var_8 -= _func_0F1( var_10 );
    }
    else
        var_9 = 0;
    ...
    for (;;)
    {
        if ( var_4 )
        {
            ...
            {
                var_11 = _func_114( ( self._id_0258[0], self._id_0258[1], 0 ) );
                var_12 = distancebetweentwolines( self._id_02E2, var_11, var_6, var_7 );
        ...
        if ( var_13 >= var_3 )
        {
            ...
            var_15 = _func_092( var_0, var_3, var_13 );
            var_16 = var_15[0] * var_14 + ( 0, 0, var_15[2] );
            var_17 = self.stairstransition["wantedPos"] + var_16;
            self._id_7A3F = _func_0F1( var_17 - self._id_02E2 );
            return;
        }

        var_18 = self.stairstransition["wantedPos"] - self._id_02E2;
        var_19 = 0.001;

        if ( _func_0F6( var_18, self._id_0258 ) > var_19 )
        {
            var_20 = _func_092( var_0, var_9, var_13 );
            var_21 = _func_0F1( var_20 ) / var_8;
            var_22 = _func_0F1( self.stairstransition["wantedPos"] - var_1 );
            var_23 = _func_0F1( var_18 );
            var_24 = _func_092( var_0, var_9, var_3 );
            var_25 = _func_0F1( var_24 );
            var_26 = var_25 / var_8;
            var_27 = var_23 / var_22;
            var_28 = var_26 / var_27 * var_22;
            var_29 = var_21 * var_28;
            self._id_7A3F = _func_0BF( var_29, var_23 );
        }
        else
            self._id_7A3F = 0;
...
waitforstairedge( var_0, var_1 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        var_6 = _func_092( var_0, var_1, var_3 );
        var_7 = var_6[0] * var_5 + ( 0, 0, var_6[2] );
        var_8 = var_4 + var_7;

        if ( _func_0F3( self._id_02E2 - var_8 ) < _func_0E8( 20 ) )
        {
            var_9 = self._id_02E2 + ( 0, 0, 15 );
            var_10 = var_8 + ( 0, 0, 15 );
            var_11 = self _meth_83E3( var_9, var_10, 15, 30, 0, 1 );
...
preparedetectedstairstransition()
{
    ...
    self._id_5F65 = _func_0E9( self.stairstransition["moveplaybackrate"], 1, 2 );
}

getanimstarttime( var_0, var_1, var_2 )
{
    var_3 = 0.01;
    var_4 = _func_0F1( var_1 );
    var_5 = getnotetracktimes( self.stairstransition["transitionAnim"], "stair_edge" );

    if ( var_4 < 1 )
        return var_5[0];

    var_6 = _func_0F1( var_2 );
    var_7 = _func_0F1( var_1 ) / var_6;
    ...
    for (;;)
    {
        var_12 = _func_092( var_0, 0, var_9 );
        var_13 = _func_0F1( var_12 ) / var_6;
...
checktransition_up_in( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_0["stairs"] ) )
    {
        ...
        if ( _func_0F6( var_10["normal"], var_3 ) > 0 )
            return undefined;

        var_9 = var_10["pos"];
        var_11 = findstaircorner( self._id_0258, self._id_0259, var_9, var_0["normal"], self._id_02E2, ( 0, 0, 1 ), 15 );
    ...
    if ( var_1 < self._id_0259 )
        return undefined;

    if ( var_1 - self._id_0259 > 15 )
        var_4 -= var_3 * 15;
    else
    {
        var_13 = ( var_1 + self._id_0259 ) * 0.5;
        var_4 -= var_3 * var_13;
    }
...
checktransition_down_in( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = self _meth_83E3( var_6, var_7, 0, 48, 1, 1 );
    ...
    var_9 = gettracecontactpos( var_6, var_7, var_8, 0, 48 );
    var_14 = findstaircorner( self._id_0258, self._id_0259, var_9, var_10, self._id_02E2, ( 0, 0, 1 ), 15 );
    ...
    {
        var_16 = ( self._id_0258[0], self._id_0258[1], 0 );
        var_16 = _func_114( var_16 );

        if ( _func_0F6( var_10, var_16 ) > 0 )
        {
            var_17 = ( var_10[0], var_10[1], 0 );
            var_17 = _func_114( var_17 );
...
{
    var_1 = getprecisegroundnear( self._id_02E2 );
    var_2 = getstairtypefromtraceresult( var_1, self._id_02E2 );
    ...
    var_7 = var_5 * 1.333;
    var_8 = var_0 * 15;
    var_9 = self._id_02E2 + var_5 * var_0 + var_8;
    var_10 = var_9 + ( 0, 0, var_7 + var_6 );
    var_11 = var_9 - ( 0, 0, var_6 );
    var_12 = self _meth_83E3( var_10, var_11, 0, 0, 1, 1 );

    if ( var_12["fraction"] <= 0 || var_12["fraction"] >= 1 )
        return undefined;

    if ( isdefined( var_12["stairs"] ) && _func_0BE( var_12["normal"][2] ) < 0.9962 )
        return undefined;

    var_13 = _func_117( var_10, var_11, var_12["fraction"] );

    if ( var_1["normal"][2] > 0.9962 )
    {
        var_1 = getprecisegroundnear( self._id_02E2 - var_0 );

        if ( var_1["normal"][2] > 0.9962 )
            return undefined;
    }

    if ( _func_0F6( var_1["normal"], var_0 ) > 0 )
        return undefined;

    var_14 = findstaircorner( self._id_0258, self._id_0259, var_1["pos"], var_1["normal"], var_13, ( 0, 0, 1 ), 15 );
    var_15["wantedPos"] = var_14["position"];
    var_15["stairEdgeDir"] = var_14["stairEdgeDirection"];
...
checktransition_down_out( var_0 )
{
    ...
    var_7 = 22;
    var_8 = var_5 * 1.333;
    var_9 = self._id_02E2 + var_5 * var_0;
    var_10 = var_9;
...
getexpectedstairstransition( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_4 ) )
    {
        var_13 = _func_0F1( var_4["trans"] );

        if ( var_13 <= 0 )
            return undefined;

        var_14 = var_4["wantedPos"] - self._id_02E2;
        var_4["stairs_old_moveplaybackrate"] = self._id_5F65;
        var_4["moveplaybackrate"] = _func_0F1( var_14 ) / var_13;
...
shouldstairstransitionnow()
{
    ...
    var_3 = var_2 * var_1;
    var_3 -= _func_0E2( var_3 / var_0["updateTime"] ) * var_0["updateTime"];
...
isonstairs()
{
    return self._id_03F1 != "none" && using_h1_stairs_system();
}
...
{
    var_0 = getprecisegroundnear( self._id_02E2 );
    var_1 = getstairtypefromtraceresult( var_0, self._id_02E2 );
    return "stairs_" + self._id_03F1 + "_" + var_1;
}
