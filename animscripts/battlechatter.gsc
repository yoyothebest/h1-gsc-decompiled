...
_id_4D5E()
{
    ...
    for ( var_1 = 0; var_1 < anim._id_8ACE.size; var_1++ )
        var_0 thread _id_4DA3( anim._id_8ACE[var_1]._id_03EF );
...
_id_854E()
{
    ...
    for ( var_1 = 0; var_1 < anim._id_8ACE.size; var_1++ )
        var_0 _id_854F( anim._id_8ACE[var_1]._id_03EF );
...
_id_6A2E()
{
    ...
    if ( anim._id_51D0[self._id_04A7] )
        return;
...
_id_6DE3()
{
    ...
    if ( !_func_1A1( var_0 ) || isdefined( var_0._id_1A07 ) && isdefined( var_0._id_1A07[self._id_8AB0._id_03EF] ) )
        return;
    ...
    {
        case "infantry":
            if ( var_0 == level._id_0318 || !isdefined( var_0 _meth_8198() ) )
                _id_932B( var_0 );
    ...
    var_0._id_1A07[self._id_8AB0._id_03EF] = spawnstruct();
    var_0._id_1A07[self._id_8AB0._id_03EF]._id_8A97 = self;
    var_0._id_1A07[self._id_8AB0._id_03EF]._id_9333 = self._id_1CA6["threat"]._id_33DD;
    var_0._id_1A07[self._id_8AB0._id_03EF]._id_351C = gettime() + 3000;

    if ( isdefined( var_0._id_8AB0 ) )
        self._id_8AB0._id_8AD0[var_0._id_8AB0._id_03EF]._id_1A07 = 1;
}
...
_id_932B( var_0, var_1 )
{
    ...
    if ( self._id_9F32 == "british" )
    {
        ...
        {
            var_3 = _id_3F5A( self._id_02E2, var_0._id_02E2 );
    ...
    else
    {
        ...
        if ( var_2 addlocationalias( 1.0, var_0 ) )
        {
            ...
            else if ( _func_0B3( 1 ) > 0.3 )
                var_2 adddirectionalias( 1.0, "side", var_0, var_2.locationent _meth_8097() );
            else
            {
                var_2 addareaalias( 0.5, var_0 );
                var_2 _id_081A( 1.0, "attack", "infantry" );
...
_id_932E( var_0 )
{
    ...
    if ( addlocationalias( 0.5, var_0 ) )
        adddirectionalias( 0.5, "side", var_0, self.locationent _meth_8097() );
...
_id_657E( var_0, var_1 )
{
    ...
    if ( var_0 == "follow" )
    {
        ...
        for ( var_4 = 0; var_4 < var_3.size; var_4++ )
        {
            ...
            if ( _func_0EE( self._id_02E2, var_3[var_4]._id_02E2 ) > 500 && var_3[var_4].a._id_8D56 == "move" && var_3[var_4] _id_1ADD( "response" ) )
                var_1 = var_3[var_4];
        }
...
_id_4C64( var_0, var_1 )
{
    ...
    if ( var_1 == "coverme" && _func_1A1( var_0 ) && isdefined( var_0._id_1342 ) && _id_1ADE( var_0._id_1342 ) )
    {
        if ( var_0 == level._id_0318 || self._id_2243 != "US" )
            var_1 = "generic";
        else
        {
...
_id_6A3B()
{
    ...
    anim thread _id_5808( self, self._id_24C5._id_04D9, 1 );
...
_id_6DD0( var_0, var_1 )
{
    ...
    for ( var_2 = 0; var_2 < var_0._id_88A9.size; var_2++ )
    {
        ...
        if ( var_0._id_59D8 && self._id_04A7 == "allies" )
        {
            ...
            self _meth_8076( var_0._id_88A9[var_2], var_0._id_88A9[var_2], 1 );
            thread _id_A510::_id_0BC4( var_0._id_88A9[var_2], var_0._id_025D );
            self waittill( var_0._id_88A9[var_2] );
            continue;
        }

        self _meth_809C( var_0._id_88A9[var_2], var_0._id_88A9[var_2], 1 );
        thread _id_A510::_id_0BC4( var_0._id_88A9[var_2], var_0._id_025D );
        self waittill( var_0._id_88A9[var_2] );
    }
...
_id_9B0A( var_0, var_1 )
{
    if ( gettime() - self._id_8AD0[var_0]._id_558C > 10000 )
    {
        ...
        {
            if ( self._id_5BA6[var_3] != var_1 && _func_1A1( self._id_5BA6[var_3]._id_0142 ) && isdefined( self._id_5BA6[var_3]._id_0142._id_8AB0 ) && self._id_5BA6[var_3]._id_0142._id_8AB0._id_03EF == var_0 )
                var_2 = 1;
        }
...
_id_4108( var_0 )
{
    ...
    {
        if ( isdefined( var_1._id_5BA6[var_3]._id_0142 ) && var_1._id_5BA6[var_3]._id_0142 == var_0 )
    ...
    return common_scripts\utility::_id_3F33( self._id_02E2, var_2 );
}
...
_id_51EB( var_0 )
{
    if ( !self._id_8AB0._id_5151[var_0] && !anim._id_51CF[self._id_04A7][var_0] && gettime() < self._id_1CA6[var_0]._id_351C && gettime() > self._id_8AB0._id_60DB[var_0] )
    {
...
_id_1340()
{
    ...
    return animscripts\utility::_id_51AC( self._id_0513 );
}
...
_id_5103()
{
    ...
    if ( var_0._id_04D9[0] == "C" && var_0._id_04D9[1] == "o" && var_0._id_04D9[2] == "v" )
        return 0;
...
getarea()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        if ( self _meth_80AB( var_0[var_1] ) && isdefined( var_0[var_1]._id_793E ) )
            return var_0[var_1];
    }
...
_id_400A()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        if ( self _meth_80AB( var_0[var_1] ) && isdefined( var_0[var_1]._id_7A27 ) )
            return var_0[var_1];
    }
...
getlandmark()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        if ( self _meth_80AB( var_0[var_1] ) && isdefined( var_0[var_1]._id_7A20 ) )
            return var_0[var_1];
    }
...
{
    var_3 = _func_115( var_2 - var_0 );
    var_4 = _func_115( var_1 - var_0 );
    var_5 = var_3[1] - var_4[1];
    var_5 += 360;
    var_5 = _func_0BC( var_5 ) % 360;
    ...
    if ( var_5 > 2 && var_5 < 45 )
        ...
        var_6 = "left";
    else if ( _func_0EE( var_0, var_1 ) < _func_0EE( var_0, var_2 ) )
        var_6 = "front";
    else
        var_6 = "rear";
...
_id_0802( var_0 )
{
    self._id_88A9[self._id_88A9.size] = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_name_" + var_0;
}

_id_0822( var_0 )
{
    self._id_88A9[self._id_88A9.size] = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_rank_" + var_0;
}
...
addareaalias( var_0, var_1 )
{
    ...
    self.area = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_area_" + var_2;
...
addlocationalias( var_0, var_1 )
{
    ...
    self._id_57F4 = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_location_" + var_2;
...
addlandmarkalias( var_0, var_1 )
{
    ...
    var_3 = getdirectionreferenceside( self._id_02E5._id_02E2, var_1._id_02E2, self.landmarkent._id_02E2 );

    if ( var_3 == "rear" && _func_1CA( self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_landmark_behind_" + var_2 ) )
        var_2 = "behind_" + var_2;
    else if ( _func_1CA( self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_landmark_near_" + var_2 ) )
        var_2 = "near_" + var_2;
    else
        return 0;

    self.landmark = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_landmark_" + var_2;
...
{
    self._id_88A9[self._id_88A9.size] = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_" + var_1 + "_" + var_2 + "_" + var_3;
...
adddirectionalias( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        case "side":
            var_5 = getdirectionreferenceside( self._id_02E5._id_02E2, var_2._id_02E2, var_3 );
        ...
        case "relative":
            if ( isdefined( var_4 ) )
            {
                if ( var_4 == "clock" )
                    ...
                    var_6 = _func_0B4( 0, 3 ) - 1;
            }
            else if ( _func_0EE( self._id_02E5._id_02E2, var_2._id_02E2 ) > 2048 )
                var_6 = 2;
            else if ( _func_0EE( self._id_02E5._id_02E2, var_2._id_02E2 ) > 800 )
                var_6 = 0;
            else
                var_6 = 1;

            if ( var_6 == 0 )
                var_5 = _id_3F5A( self._id_02E5._id_02E2, var_2._id_02E2 );
            else if ( var_6 == 1 )
                return 0;
            else
                var_5 = _id_3F5A( self._id_02E5._id_02E2, var_2._id_02E2 );
    ...
    self._id_2A6D = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_direction_" + var_5;
...
{
    var_1 = getdirectionreferenceside( level._id_0318._id_02E2, var_0._id_02E2, anglestoforward( level._id_0318.angles ) );
    var_1 = "relative_" + var_1;
    self._id_2A6D = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_direction_" + var_1;
    return self._id_2A6D;
}

_id_0837( var_0, var_1, var_2 )
{
    self._id_9317 = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_threat_" + var_1 + "_" + var_2;
...
{
    self.inform = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_inform_" + var_1 + "_" + var_2;
...
{
    self.response = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_response_" + var_1 + "_" + var_2;
...
{
    self._id_717C = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_reaction_" + var_1 + "_" + var_2;
...
{
    self._id_717C = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_taunt";
    self._id_88A9[self._id_88A9.size] = self._id_717C;
    return 1;
}
...
{
    self.order = self._id_02E5._id_2243 + "_" + self._id_02E5._id_6252 + "_order_" + var_1 + "_" + var_2;
...
_id_132E()
{
    if ( getdvar( "debug_bcprint" ) == self._id_04A7 || getdvar( "debug_bcprint" ) == "all" )
        return 1;
...
battlechatter_print_internal( var_0, var_1 )
{
    ...
    if ( var_0 != "" )
        var_2 = common_scripts\utility::_id_9294( self._id_04A7 == "allies", "^5", "^6" ) + "BC: ";
...
threattracker()
{
    for (;;)
    {
        ...
        {
            if ( !level._id_0318 _id_6E26( var_0[var_3]._id_02E2 ) )
                continue;

            if ( _func_0EE( level._id_0318._id_02E2, var_0[var_3]._id_02E2 ) > 2048 )
                continue;
            ...
            {
                if ( isdefined( var_1[var_7]._id_0142 ) && var_1[var_7]._id_0142 == var_0[var_3] )
                    var_6 = 1;
            }
...
_id_133D()
{
    for ( var_0 = 0; var_0 < anim.areas.size; var_0++ )
    {
        ...
        thread _id_2DD3( "Area:     " + anim.areas[var_0]._id_793E, anim.areas[var_0] _meth_8097(), ( 0, 0, 16 ), ( 1, 1, 1 ) );
    }
    ...
    for ( var_0 = 0; var_0 < anim.locations.size; var_0++ )
    {
        ...
        thread _id_2DD3( "Location: " + anim.locations[var_0]._id_7A27, anim.locations[var_0] _meth_8097(), ( 0, 0, 8 ), ( 1, 1, 1 ) );
    }
    ...
    for ( var_0 = 0; var_0 < anim.landmarks.size; var_0++ )
    {
        ...
        thread _id_2DD3( "Landmark: " + anim.landmarks[var_0]._id_7A20, anim.landmarks[var_0] _meth_8097(), ( 0, 0, 0 ), ( 1, 1, 1 ) );
        thread _id_2DD2( anim.landmarks[var_0] _meth_8097(), ( 0, 0, 8 ), ( 1, 1, 0 ) );
    }
    ...
    for ( var_0 = 0; var_0 < var_1.size; var_0++ )
    {
        ...
        anim._id_5F63._id_02E2 = var_1[var_0]._id_02E2;
        anim._id_5F63._id_02E2 += ( 0, 0, 10 );
        var_2 = anim._id_5F63 _id_400A();

        if ( isdefined( var_2 ) )
        {
            thread _id_2DD3( var_1[var_0]._id_7A27 + " @ " + var_2._id_7A27, var_1[var_0]._id_02E2, ( 0, 0, 0 ), ( 0, 1, 0 ) );
            continue;
        }

        thread _id_2DD3( var_1[var_0]._id_7A27 + " @ undefined", var_1[var_0]._id_02E2, ( 0, 0, 0 ), ( 1, 0, 0 ) );
    }
...
_id_2DD3( var_0, var_1, var_2, var_3 )
{
    for (;;)
    {
        if ( _func_0EE( level._id_0318._id_02E2, var_1 ) > 2048 )
        {
            wait 0.1;
            continue;
        }
...
_id_2DD2( var_0, var_1, var_2 )
{
    for (;;)
    {
        if ( _func_0EE( level._id_0318._id_02E2, var_0 ) > 2048 )
        {
            wait 0.1;
            continue;
        }

        var_3 = _id_3F5A( level._id_0318._id_02E2, var_0 );
        wait 0.05;
    }
}
...
_id_3F38( var_0 )
{
    ...
    var_2 = common_scripts\utility::_id_3F33( self._id_02E2, var_1 );
    return var_2;
}
