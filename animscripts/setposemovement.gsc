...
_id_6A30( var_0, var_1, var_2, var_3 )
{
    ...
    if ( _func_0CE( var_0 ) )
        var_0 = var_0[_func_0B2( var_0.size )];

    self _meth_8111( "blendTransition", var_0, %body, 1, var_1, 1 );
...
_id_14A4()
{
    ...
    if ( self.a._id_5F5B != "stop" && self._id_03F1 == "none" )
        var_2 = 0.5;
...
_id_6DE8( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    self _meth_8112( "transAnimDone2", var_0, %body, 1, 0.2, var_4 );
