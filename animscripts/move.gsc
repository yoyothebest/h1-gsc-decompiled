...
_id_9B3C( var_0 )
{
    if ( var_0 != self._id_6F6F || _id_0CC8() )
    {
        ...
        else
        {
            ...
            if ( ( self.combatmode == "ambush" || self.combatmode == "ambush_nodes_only" ) && ( isdefined( self._id_02F8 ) && _func_0F0( self._id_02E2, self._id_02F8 ) > _func_0E8( 100 ) ) )
            {
                self._id_855F = 1;
...
_id_5F58( var_0 )
{
    ...
    self.a._id_76D4 = _func_0B2( 10000 );
    self._id_6F6F = "none";
    self._id_6F6E = "none";
...
_id_5A61()
{
    ...
    {
        if ( !animscripts\utility::_id_50E9() && self._id_0175 )
            return 0;
    }
...
_id_841B()
{
    ...
    if ( isdefined( self._id_0513 ) && animscripts\utility::_id_A2CF() )
...
_id_66D9()
{
    ...
    for (;;)
    {
        ...
        if ( !self._id_0175 && !self _meth_8195() )
        {
        ...
        self notify( "stop_move_anim_update" );
        self._id_9AC9 = undefined;
        var_3 = _func_115( var_1 );
        var_4 = _func_0EB( self.angles[1] - var_3[1] );
        var_5 = _func_0EB( self.angles[0] - var_3[0] );
...
_id_66D7( var_0, var_1 )
{
    ...
    if ( var_0 < 0 )
    {
        if ( !var_8 && var_0 > -45 + var_7 )
            ...
            var_9 = _func_0BC( _func_0E3( ( var_0 + 180 - var_7 ) / 45 ) );
    }
        ...
        var_9 = _func_0BC( _func_0E2( ( var_0 + 180 + var_7 ) / 45 ) );
    ...
    if ( var_0 < -60 )
    {
        var_11 = _func_0BC( _func_0E3( ( var_0 + 180 ) / 45 ) );
    ...
    {
        var_11 = _func_0BC( _func_0E2( ( var_0 + 180 ) / 45 ) );
...
_id_66D4( var_0 )
{
    ...
    var_2 = var_1[0];
    var_3 = _func_092( var_0, 0, var_2 );
    var_4 = self _meth_81B4( var_3 );

    if ( isdefined( self._id_0D28 ) && _func_0E8( self._id_0D28 ) > _func_0F0( self._id_02F8, var_4 ) )
        return 0;

    var_3 = _func_092( var_0, 0, 1 );
    var_5 = self _meth_81B4( var_3 );
    var_5 = var_4 + _func_114( var_5 - var_4 ) * 20;
    var_6 = !self._id_0424;
    ...
    if ( var_10.size > 0 )
    {
        var_3 = _func_092( var_0, 0, var_10[0] );
        var_11 = self _meth_81B4( var_3 );
    ...
    var_7 = self _meth_81C8( self._id_02E2, var_9, var_6, 1 );
    return var_7;
}
...
_id_66D6()
{
    ...
    self._id_04CA = 1;
    self _meth_8115( "turnAnim", var_0, 1, var_1, self._id_5F65 );
...
_id_595D( var_0, var_1, var_2 )
{
    ...
    var_5 = self._id_02E2;
    var_6 = self.angles;
    var_5 = _func_06F( var_5, var_6, var_0 );
    var_6 = _func_070( var_5, var_6, var_0 );
    var_7 = getanimlength( var_0 ) * var_4[0];
    var_8 = _func_0BC( _id_A5A4::_id_7612( var_7 * 20, 0, 0 ) );
    ...
    for (;;)
    {
        ...
        var_14 = _func_092( var_0, 0, var_12 );
        var_15 = _func_226( var_0, 0, var_12 );
        var_16 = _func_11D( var_5, var_6, ( 0, 0, 0 ), ( 0, 0, 0 ), var_14, var_15 );
        var_17 = var_16["origin"];
        var_18 = var_16["angles"];
        var_19 = self._id_0258;
        var_20 = _func_115( self._id_0258 )[1];
        var_21 = var_18[1];
        var_22 = _func_0EB( var_20 - var_21 );
        var_23 = var_22 * var_13;
        var_23 = _func_0BE( _func_0E9( var_23, -1 * var_3, var_3 ) );
        var_19 = _func_117( anglestoforward( var_18 ), self._id_0258, var_23 / var_3 * var_13 );
...
_id_2C2D()
{
    ...
    self _meth_8115( "dodgeAnim", self._id_2513, 1, 0.2, 1 );
...
{
    var_2 = ( self._id_0258[1], -1 * self._id_0258[0], 0 );
    var_3 = self._id_0258 * var_1[0];
    var_4 = var_2 * var_1[1];
    var_5 = self._id_02E2 + var_3 - var_4;
    self _meth_81A7( 1 );
...
_id_0C6A()
{
    ...
    for (;;)
    {
        ...
        var_2 = _func_114( var_1 - self._id_02E2 );

        if ( self._id_0258[0] * var_2[1] - var_2[0] * self._id_0258[1] > 0 )
        {
...
_id_5B80()
{
    ...
    for (;;)
    {
        if ( isdefined( self._id_0142 ) && ( _func_0CF( self._id_0142 ) || isdefined( self._id_5B8D ) ) )
        {
            if ( _func_0BE( self _meth_8194() ) <= 135 )
...
_id_18B2()
{
    ...
    for (;;)
    {
        ...
        if ( self._id_02A2 != "run" || !self._id_0175 || self.a._id_6E5A != "stand" || isdefined( self._id_717B ) )
            continue;
        ...
        if ( !isdefined( self._id_0142 ) && !self._id_01FB && self _meth_817C() != "oblivious" && isdefined( var_0._id_04A7 ) && isenemyteam( self._id_04A7, var_0._id_04A7 ) )
        {
            self._id_A316 = var_0;
        ...
        if ( self._id_025A || self._id_0259 < 100 || self._id_0259 < anim.longestrunwizby )
            continue;

        if ( isdefined( self._id_02F8 ) && _func_0F0( self._id_02E2, self._id_02F8 ) < 10000 )
        {
            wait 0.2;
            continue;
        }
...
_id_829F( var_0, var_1, var_2 )
{
    ...
    else if ( var_4 == "Cover Stand" && var_1._id_04D9 == var_4 )
    {
        if ( var_0 )
        {
...
{
    if ( self.a._id_6E5A == "stand" && ( var_1._id_04D9 != "Cover Stand" || var_0._id_04D9 != "Cover Stand" ) )
    {
...
_id_5F49( var_0 )
{
    if ( self.a._id_6E5A == "crouch" && var_0._id_04D9 == "Cover Stand" )
    {
...
_id_5F48()
{
    ...
    if ( !isdefined( self._id_02BB ) || !isdefined( var_0 ) || self._id_02BB != var_0 )
        return;
    ...
    var_11 = _func_0F1( _func_092( var_7, 0, var_10 ) );
    var_12 = _func_0F1( _func_092( var_8, 0, 1 ) );
    var_13 = _func_0F1( _func_092( var_9, 0, 1 ) );
    var_14 = _func_0EE( self._id_02E2, var_2._id_02E2 );

    if ( var_14 > var_11 )
    {
        self _meth_8193( "face angle", animscripts\utility::_id_404B( var_1 ) );
        self _meth_8115( "shuffle_start", var_7, 1, var_6 );
    ...
    var_17 = _func_0E2( var_17 * 20 ) * 0.05;
    self _meth_8113( "shuffle", var_8, 1, var_6 );
    ...
    if ( var_15 )
    {
        ...
        self _meth_8113( "shuffle_end", var_9, 1, var_6 );
        animscripts\shared::_id_2D06( "shuffle_end" );
    }

    self _meth_81CB( var_2._id_02E2 );
...
_id_5F4D( var_0, var_1, var_2 )
{
    ...
    if ( var_1._id_04D9 == "Cover Right" && var_2._id_04D9 == "Cover Left" && !var_0 )
        var_3 = %corner_standr_door_r2l;
    else if ( var_1._id_04D9 == "Cover Left" && var_2._id_04D9 == "Cover Right" && var_0 )
    ...
    self _meth_8192( "zonly_physics", 0 );
    self _meth_8193( "face current" );
    self _meth_8115( "sideToSide", var_3, 1, 0.2 );
    animscripts\shared::_id_2D06( "sideToSide", ::_id_467E );
    var_4 = self _meth_8151( var_3 );
    var_5 = var_2._id_02E2 - var_1._id_02E2;
    var_5 = _func_114( ( var_5[0], var_5[1], 0 ) );
    var_6 = _func_092( var_3, var_4, 1 );
    var_7 = var_2._id_02E2 - self._id_02E2;
    var_7 = ( var_7[0], var_7[1], 0 );
    var_8 = _func_0F6( var_7, var_5 ) - _func_0BE( var_6[1] );

    if ( var_8 > 2 )
    {
        var_9 = getnotetracktimes( var_3, "slide_end" )[0];
        var_10 = ( var_9 - var_4 ) * getanimlength( var_3 );
        var_11 = _func_0BC( _func_0E3( var_10 / 0.05 ) );
...
_id_8625( var_0, var_1 )
{
    ...
    while ( var_1 > 0 )
    {
        self _meth_81CB( self._id_02E2 + var_0 );
        var_1--;
        wait 0.05;
    }
}
...
_id_5F7C( var_0, var_1 )
{
    ...
    if ( !var_2 && isdefined( self._id_7409 ) && gettime() - self._id_7409 < 100 && isdefined( self._id_76B1 ) && _func_0B3( 1 ) < var_3 )
        ...
        if ( !isdefined( var_4 ) )
        {
            if ( _func_0CE( var_0 ) )
            {
                if ( isdefined( self._id_76AE ) )
                    ...
                    var_4 = var_0[_func_0B2( var_0.size )];
            }
            else
                var_4 = var_0;
        }
...
getexpectedcurrentmoveanim()
{
    ...
    else if ( self._id_02A2 == "walk" || self.a._id_5F5B == "walk" )
    {
