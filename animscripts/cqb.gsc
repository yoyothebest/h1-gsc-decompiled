...
cqb_animate( var_0, var_1, var_2 )
{
    ...
    if ( !animscripts\stairs_utility::isonstairs() )
    {
        ...
        self _meth_8111( "runanim", var_0, var_5, 1, var_2, self._id_5F65 * self.cqb_slowdown_scale, 1 );
...
_id_22D7()
{
    ...
    self _meth_8112( var_0, var_1, %body, 1, 0.25, self._id_5F65 * self.cqb_slowdown_scale );
    _id_22D5( var_1 );
    animscripts\run::_id_7FB7( animscripts\utility::_id_5863( "cqb", "move_b" ), animscripts\utility::_id_5863( "cqb", "move_l" ), animscripts\utility::_id_5863( "cqb", "move_r" ) );
    thread animscripts\run::_id_7F3E( "cqb" );
...
_id_8308()
{
    ...
    {
        level._id_22DE[var_1] = var_0[var_1]._id_02E2;
        var_0[var_1] delete();
    }
}
...
_id_377E()
{
    ...
    for (;;)
    {
        ...
        {
            if ( _func_1A1( var_3 ) && var_3 animscripts\utility::_id_50E9() && !isdefined( var_3._id_2A8B ) )
            {
                var_4 = var_3.a._id_5F5B != "stop";
                var_5 = ( var_3._id_02E2[0], var_3._id_02E2[1], var_3 _meth_8099()[2] );
                var_6 = var_5;
                var_7 = anglestoforward( var_3.angles );

                if ( var_4 )
                {
                    var_8 = _func_06B( var_6, var_6 + var_7 * 128, 0, undefined );
                ...
                for ( var_11 = 0; var_11 < level._id_22DE.size; var_11++ )
                {
                    ...
                    var_13 = _func_0F0( var_12, var_6 );

                    if ( var_13 < var_10 )
                    {
                        if ( var_4 )
                        {
                            if ( _func_0F0( var_12, var_5 ) < 4096 )
                                continue;

                            var_14 = _func_0F6( _func_114( var_12 - var_5 ), var_7 );
                        ...
                        if ( !_func_08E( var_6, var_12, 0, undefined ) )
                            continue;
