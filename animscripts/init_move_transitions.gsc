...
getmoveend( var_0 )
{
    ...
    {
        var_6 = _func_092( var_0, var_1, 1 );

        if ( _func_0F4( var_6 ) < 1 )
        {
            var_3 = var_1;
            continue;
        }
...
_id_4E2F( var_0 )
{
    ...
    for ( var_2 = 1; var_2 <= 6; var_2++ )
    {
        ...
        for ( var_3 = 0; var_3 < var_1.size; var_3++ )
        {
            ...
            {
                anim._id_0CCA[var_0]["cover_trans_dist"][var_4][var_2] = _func_092( anim._id_0CCA[var_0]["cover_trans"][var_4][var_2], 0, 1 );
                anim._id_0CCA[var_0]["cover_trans_angles"][var_4][var_2] = _func_093( anim._id_0CCA[var_0]["cover_trans"][var_4][var_2], 0, 1 );
            ...
            if ( isdefined( anim._id_0CCA[var_0]["cover_exit"][var_4] ) && isdefined( anim._id_0CCA[var_0]["cover_exit"][var_4][var_2] ) )
            {
                ...
                anim._id_0CCA[var_0]["cover_exit_dist"][var_4][var_2] = _func_092( anim._id_0CCA[var_0]["cover_exit"][var_4][var_2], 0, var_5 );
                anim._id_0CCA[var_0]["cover_exit_angles"][var_4][var_2] = _func_093( anim._id_0CCA[var_0]["cover_exit"][var_4][var_2], 0, 1 );
            }
        }
    }
    ...
    for ( var_3 = 0; var_3 < var_1.size; var_3++ )
    {
        ...
        for ( var_2 = 1; var_2 <= 6; var_2++ )
        {
            ...
            var_6 = _func_0F3( anim._id_0CCA[var_0]["cover_trans_dist"][var_4][var_2] );

            if ( anim._id_0CCA[var_0]["CoverTransLongestDist"][var_4] < var_6 )
                anim._id_0CCA[var_0]["CoverTransLongestDist"][var_4] = var_6;
        }

        anim._id_0CCA[var_0]["CoverTransLongestDist"][var_4] = _func_0E7( anim._id_0CCA[var_0]["CoverTransLongestDist"][var_4] );
    }
    ...
    foreach ( var_4, var_8 in anim._id_3594 )
    {
        ...
        for ( var_2 = 1; var_2 <= 9; var_2++ )
        {
            ...
            var_10 = _func_0F1( anim._id_0CCA[var_0]["cover_trans_dist"][var_4][var_2] );
...
getsplitdeltas( var_0, var_1 )
{
    ...
    var_3 = spawnstruct();
    var_3.predist = _func_092( var_0, 0, var_1 );
    var_3.postdist = _func_092( var_0, 0, var_2 ) - var_3.predist;
    var_3.angledelta = _func_093( var_0, 0, 1 );
    return var_3;
}
...
findbestsplittime( var_0, var_1, var_2 )
{
    ...
    for ( var_9 = 0; var_9 < var_5; var_9++ )
    {
        ...
        var_11 = _func_092( var_0, 0, var_10 );
        ...
        var_12 = _func_0BF( var_11[0] - 32, var_11[1] );
