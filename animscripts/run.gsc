...
_id_40BD()
{
    ...
    {
        var_2 = _func_0BE( self _meth_8194() );
...
_id_76D6( var_0 )
{
    ...
    if ( !var_0 || _func_0E8( var_1 ) > var_3 * var_3 )
    {
        self _meth_8144( %add_fire, 0 );

        if ( _func_0E8( self._id_76DA ) < var_5 * var_5 )
        {
            self._id_76DA = 0;
            self._id_76D6 = undefined;
            return 0;
    ...
    if ( var_0 && _func_1AD( self._id_0142 ) )
        self _meth_81ED();
...
runngun_animate( var_0, var_1 )
{
    ...
    else
    {
        ...
        {
            var_9 = _func_0E9( var_3 / var_0, 0, 1 );
...
_id_71D1()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( self._id_02F8 ) || _func_0F0( self._id_02F8, self._id_02E2 ) < _func_0E8( 80 ) )
        {
            _id_31C1();
...
_id_76E3()
{
    ...
    anim._id_55D5 = var_1;
    var_2 = var_0[var_1];
    self _meth_810F( "reactanim", var_2, 1, 0.5, 1 );
    _id_76B3( var_2 );
    thread _id_71D1();
...
_id_2568()
{
    ...
    self._id_717B = 1;
    self _meth_8193( "face motion" );
    var_0 = _func_0B2( self._id_76B1.size );
    var_1 = self._id_76B1[var_0];
    self _meth_810F( "reactanim", var_1, 1, 0.5, 1.0 );
    _id_76B3( var_1 );
    thread _id_71D1();
    animscripts\shared::_id_2D06( "reactanim" );
    _id_31C1();
...
_id_84B1()
{
    ...
    if ( isdefined( self._id_01CA ) && isdefined( self._id_0142 ) && self._id_01AA == 1 )
        return _func_0F0( self._id_02E2, self._id_0142._id_02E2 ) > 90000;
...
_id_84B2()
{
    ...
    if ( !self._id_0175 || animscripts\stairs_utility::isonstairs() )
        return 0;
    ...
    if ( _func_0B2( 100 ) < 25 && self _meth_81C4( self._id_0142 ) + 2000 > var_0 )
    {
        self._id_25F1 = var_0 + 2000 + _func_0B2( 1000 );
        return 1;
    }
...
_id_8B12()
{
    ...
    else if ( isdefined( self._id_0142 ) && animscripts\move::_id_5A61() )
    {
        _id_800D( 1 );

        if ( !var_1 && !self._id_0175 )
            thread _id_35B6();
...
_id_40E5( var_0, var_1, var_2 )
{
    ...
    var_4 = isdefined( self._id_0142 ) && animscripts\utility::_id_5124() && !isdefined( self._id_6163 ) && _id_1AE9() && isdefined( self._id_8415 ) && self._id_8415 != "none";
    var_3 = var_3 + "_" + var_2;
...
_id_1AE9()
{
    if ( ( !isdefined( self._id_76DA ) || self._id_76DA == 0 ) && _func_0BE( self _meth_8194() ) > self._id_5A52 )
        return 0;
...
_id_1AE8()
{
    if ( 180 - _func_0BE( self _meth_8194() ) >= 45 )
        return 0;

    var_0 = _id_4098( 0.2 );

    if ( _func_0BE( var_0 ) > 30 )
        return 0;
...
_id_1AE7()
{
    return animscripts\move::_id_5A61() && isdefined( self._id_0142 ) && ( _id_1AE9() || _id_1AE8() );
}
...
_id_4098( var_0 )
{
    ...
    var_1 += ( _func_0B7( var_2 ), _func_0B6( var_2 ), 0 ) * _func_0F1( self._id_0500 ) * var_0;
    var_3 = self.angles[1] - _func_116( self._id_0142._id_02E2 - var_1 );
...
_id_5F06()
{
    ...
    if ( var_7 == "turn_L90" || var_7 == "turn_R90" )
    {
        ...
        var_8 = _func_0BF( var_6, 0.1 );

    self _meth_8144( %body, var_8 );
    self _meth_8112( "runanim", var_2, %body, 1, var_8, var_3 );
    _id_76B3( var_2 );

    if ( isdefined( self.stairstransition["startTime"] ) )
        self _meth_8119( var_2, self.stairstransition["startTime"] );

    var_9 = isdefined( var_1["inStairTransitionIn"] ) && var_1["inStairTransitionIn"];
    var_10 = 0.05 * var_3 / var_5;
    childthread animscripts\stairs_utility::stairupdatepos( var_2, self._id_02E2, self.stairstransition, var_4[0], var_9, var_10 );
...
_id_8B13()
{
    ...
    if ( self._id_024A > 0 && self._id_024A < 0.998 )
        var_3 = 1;
    else if ( self._id_024A < 0 && self._id_024A > -0.998 )
        var_3 = -1;

    var_4 = _func_0E1( 0.2, var_2 );
...
{
    self endon( "movemode" );
    self _meth_8111( "runanim", self._id_2485, %body, 1, 0.4, self._id_5F65 );
...
_id_2486()
{
    ...
    self _meth_8111( "runanim", %crouchrun, %body, 1, 0.2, self._id_5F65 );
    _id_76B3( undefined );
    animscripts\notetracks::_id_2D0B( 0.2, "runanim" );
}
...
_id_8B11()
{
    ...
    var_0 = var_0 || isdefined( self._id_0142 ) && _func_0F0( self._id_02E2, self._id_0142._id_02E2 ) < 65536;
    ...
    if ( !isdefined( self._id_02F8 ) || _func_0F0( self._id_02E2, self._id_02F8 ) < 65536 )
        return 0;

    var_1 = getdvarfloat( "ai_runReload_minLookahead", 320 );

    if ( var_1 > 0 && self._id_0259 < var_1 )
        return 0;

    var_2 = _func_0EB( self _meth_8194() );

    if ( _func_0BE( var_2 ) > 25 )
        return 0;
...
_id_8B14()
{
    ...
    if ( _func_0CE( var_1 ) )
        var_1 = var_1[_func_0B2( var_1.size )];

    self _meth_8112( var_0, var_1, %body, 1, 0.25 );
    _id_76B3( var_1 );
    self._id_9ACA = 1;
    _id_7FB7( animscripts\utility::_id_402D( "move_b" ), animscripts\utility::_id_402D( "move_l" ), animscripts\utility::_id_402D( "move_r" ) );
    thread _id_7F3E( "run" );
...
{
    if ( self._id_0175 && !animscripts\utility::_id_848B() && !isdefined( self._id_9ACA ) && !( isdefined( self._id_5A7A ) && self._id_5A7A ) )
    {
...
_id_8B10()
{
    ...
    var_1 = animscripts\utility::_id_51A3( self._id_0513 );
    ...
    else
    {
        ...
        if ( animscripts\utility::_id_51A3( self._id_0340 ) )
            return 0;
    }
    ...
    if ( var_0 )
        _id_8445( "shotgunPullout", animscripts\utility::_id_5863( "cqb", "shotgun_pullout" ), "gun_2_chest", "none", self._id_03B3, "shotgun_pickup" );
    else
        _id_8445( "shotgunPutaway", animscripts\utility::_id_5863( "cqb", "shotgun_putaway" ), "gun_2_back", "back", self._id_0340, "shotgun_pickup" );
...
_id_A259( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    animscripts\shared::_id_6869( self._id_0513, var_2 );
