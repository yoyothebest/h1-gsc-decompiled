...
main()
{
    ...
    if ( !var_0 )
    {
        if ( self.a._id_A2E2["right"] == "none" && self.a._id_A2E2["left"] == "none" )
            var_0 = 1;
        else if ( _func_0EB( self _meth_81BD()[0] ) > 20 )
            var_0 = 1;
    }

    if ( self._id_0424 && !isdefined( self._id_0142 ) )
    {
        var_1 = animscripts\exit_node::_id_3F8B();

        if ( isdefined( var_1 ) )
        {
            self _meth_8112( "idle", self._id_255D["stand"], %body, 1, 0.5, self._id_0C78 );
...
_id_993C( var_0 )
{
    ...
    var_6 = _func_0BE( var_2 ) / self._id_04CB;
    var_6 /= 1000;
    var_7 = var_5 / var_6;
    self _meth_8193( "face angle", var_0 );
    self _meth_8115( "swim_turn", var_4, 1, 0.2, var_7 * self._id_5F65 );
...
_id_7608( var_0, var_1 )
{
    ...
    while ( _func_0EA( var_0 - self.angles[1] ) > var_1 )
        wait 0.1;
}
...
_id_8A30()
{
    ...
    for (;;)
    {
        ...
        self _meth_8115( "special_idle", var_2, 1, 0.2, self._id_0C78 );
...
_id_971F( var_0, var_1 )
{
    ...
    {
        if ( self._id_02BB _meth_8037() )
            var_2 = 1;

        if ( self._id_02BB _meth_8564() )
            var_2 = 0;
    }
    ...
    {
        var_4 = var_3[var_0];
        self _meth_8112( "idle_transition", var_4, %body, 1, 0.2, self._id_0C78 );
...
_id_6DAA( var_0, var_1 )
{
    ...
    {
        if ( _func_0CE( self._id_255D[var_0] ) )
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        self _meth_8112( "idle", var_3, %add_idle, 1, var_11, self._id_0C78 );
    }
    else
        self _meth_8112( "idle", var_4, %body, 1, var_11, self._id_0C78 );
...
_id_7028()
{
    ...
    {
        if ( self._id_0335 == "move" && isdefined( self.movetransitionanimation ) && isdefined( self.movetransitionendpose ) && self.movetransitionendpose == "prone" )
        {
    ...
    if ( _func_0B2( 10 ) < 3 )
    {
        ...
        self _meth_8111( "prone_idle", var_5, %exposed_modern, 1, 0.2 );
    }
    else
    {
