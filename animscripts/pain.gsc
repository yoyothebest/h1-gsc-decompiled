...
main()
{
    ...
    if ( self._id_00FD == "helmet" )
        animscripts\death::_id_4820();
    else if ( _id_A1C4() && _func_0B2( 2 ) == 0 )
        animscripts\death::_id_4820();
...
_id_4DF7()
{
    level._id_058F["crawling_death_blood_smear"] = loadfx( "vfx/blood/blood_smear_decal" );
}
...
_id_A1C4()
{
    ...
    if ( gettime() - anim._id_5583 <= 50 )
    {
        ...
        if ( _func_0F0( self._id_02E2, anim._id_5580 ) < var_0 )
        {
            var_1 = var_0 * 0.5 * 0.5;
            self._id_5A5D = _func_0F0( self._id_02E2, anim._id_5581 ) < var_1;
            return 1;
        }
    }
...
_id_3F4B()
{
    ...
    if ( isdefined( self._id_0246 ) && isdefined( self._id_0246._id_04A7 ) && self._id_0246._id_04A7 == self._id_04A7 )
        return;

    if ( !isdefined( self._id_25AF ) || gettime() - self.a._id_55C7 > 1500 )
        self._id_25AF = _func_0B4( 2, 3 );

    if ( isdefined( self._id_0246 ) && _func_0F0( self._id_02E2, self._id_0246._id_02E2 ) < _func_0E8( 512 ) )
        self._id_25AF = 0;
...
_id_4079()
{
    ...
    if ( self._id_0100 && !isdefined( self._id_2B03 ) )
    {
        var_0 = _id_3F4B();
    ...
    if ( self.a._id_6E5A == "stand" )
    {
        var_1 = isdefined( self._id_02BB ) && _func_0F0( self._id_02E2, self._id_02BB._id_02E2 ) < 4096;

        if ( !var_1 && self.a._id_5F5B == "run" && _func_0BE( self _meth_8194() ) < 60 )
            return _id_40BF();
...
removeblockedanims( var_0 )
{
    ...
    {
        var_3 = _func_092( var_0[var_2], 0, 1 );
        var_4 = self _meth_81B4( var_3 );
...
_id_40BF()
{
    ...
    if ( self _meth_81C7( self _meth_81B4( ( 300, 0, 0 ) ) ) )
    {
        var_2 = 1;
        var_1 = 1;
    }
    else if ( self _meth_81C7( self _meth_81B4( ( 200, 0, 0 ) ) ) )
        var_1 = 1;
    ...
    else if ( self _meth_81C7( self _meth_81B4( ( 120, 0, 0 ) ) ) )
...
getstandpainanim_preh1()
{
    ...
    {
        var_1 = self._id_0101 / self._id_0271;
...
_id_40E9()
{
    ...
    if ( !self._id_0100 && !self.a._id_2B18 )
    {
        var_2 = _func_0B2( var_0.size + var_1.size );
...
playpainanim_preh1( var_0 )
{
    ...
    self _meth_8112( "painanim", var_0, %body, 1, 0.1, var_1 );
...
_id_238E()
{
    if ( self.a._id_2B18 || self._id_011F || self._id_0100 )
        return 0;
    ...
    if ( self._id_01E6 > 100 )
        return 0;

    if ( var_0 && self._id_01E6 < self._id_0271 * 0.4 )
    {
    ...
    {
        if ( _func_0F0( self._id_02E2, var_2._id_02E2 ) < 30625 )
            return 0;
    }
...
_id_7F42( var_0 )
{
    ...
    self.a._id_2390 = var_1[_func_0B2( var_1.size )];
...
_id_2391()
{
    ...
    {
        if ( !( isdefined( level.crewchief ) && self._id_0142 == level.crewchief ) )
            self _meth_8202( self._id_0142 );
    }
    ...
    self._id_28B7 = gettime() + _func_0B4( 4000, 20000 );
    ...
    self._id_2652 = var_5[_func_0B2( var_5.size )];
    _id_53B7();
    self.a._id_8A1A = "none";
    self._id_8A2C = undefined;
}
...
_id_8484( var_0 )
{
    ...
    else
    {
        ...
        if ( 45 < self._id_0103 && self._id_0103 < 135 )
            var_5 = "l";
        else if ( -135 < self._id_0103 && self._id_0103 < -45 )
            var_5 = "r";
        else if ( -45 < self._id_0103 && self._id_0103 < 45 )
            return;
    }
    ...
    switch ( var_5 )
    {
        case "b":
            ...
            var_7 = self._id_02E2 - var_6 * var_3;
            break;
        case "l":
            var_8 = anglestoright( self.angles );
            var_7 = self._id_02E2 - var_8 * var_3;
            break;
        case "r":
            var_8 = anglestoright( self.angles );
            var_7 = self._id_02E2 + var_8 * var_3;
    ...
    var_11 = _func_0B2( var_9[var_10].size );
...
_id_8F6F()
{
    ...
    var_0 = _func_092( self.a._id_8F70[2] );
    var_1 = getanimlength( self.a._id_8F70[2] ) * 1000;

    for ( var_2 = _func_0B2( 2 ) + 1; var_2 > 0; var_2-- )
    {
        var_3 = anglestoforward( self.angles );
        var_4 = self._id_02E2 + var_3 * var_0;
...
crawling_stab_achievement()
{
    ...
    if ( !isdefined( self ) || !isdefined( var_0 ) || !_func_1AD( var_0 ) )
        return;
...
_id_2FD3()
{
    if ( !isdefined( self._id_39C2 ) )
    {
        ...
        if ( self.a._id_5F5B == "stop" )
        {
            ...
            else if ( _func_0BE( self._id_0103 ) > 90 )
                return 1;
        }
        else if ( _func_0BE( self _meth_8194() ) > 90 )
            return 1;
    }
...
_id_2FD6()
{
    ...
    var_2 = "tag_origin";
    var_3 = 0.25;
    var_4 = level._id_058F["crawling_death_blood_smear"];

    if ( isdefined( self.a._id_238A ) )
        var_3 = self.a._id_238A;

    if ( isdefined( self.a._id_2389 ) )
        var_4 = level._id_058F[self.a._id_2389];

    while ( var_3 )
    {
        var_5 = self _meth_8184( var_1 );
        var_6 = self _meth_8185( var_2 );
...
_id_2FD5()
{
    ...
    for (;;)
    {
        ...
        var_2 = _func_0EB( var_1 - var_0 );

        if ( _func_0BE( var_2 ) > 3 )
            var_2 = common_scripts\utility::_id_856D( var_2 ) * 3;

        var_1 = _func_0EB( var_0 + var_2 );
...
_id_0977()
{
    ...
    var_2 = _func_115( var_0 - self _meth_81BC() );
    var_3 = animscripts\utility::_id_06C4( var_1[1] - var_2[1] );

    if ( var_3 > anim._id_6663 )
    {
        if ( _func_0F0( self _meth_80AA(), var_0 ) > anim._id_6661 || var_3 > anim._id_6662 )
            return 0;
    }
...
_id_32B1( var_0 )
{
    ...
    if ( common_scripts\utility::_id_382E( "_cloaked_stealth_enabled" ) )
        var_1 = animscripts\combat_utility::_id_3DB2( self._id_0142 );
    else
        var_1 = self._id_0142 _meth_8099();

    var_2 = _func_114( var_1 - self _meth_80AA() );
    return _func_0F6( var_2, var_0 ) > 0.5;
}
...
_id_6F52( var_0 )
{
    ...
    if ( var_0 == "crawling" )
    {
        ...
        if ( isdefined( level._id_0318 ) && _func_0F0( self._id_02E2, level._id_0318._id_02E2 ) < 1048576 )
        {
            anim._id_629A = _func_0B4( 10, 30 );
            anim._id_60C7 = gettime() + _func_0B4( 15000, 60000 );
        }
        else
        {
            anim._id_629A = _func_0B4( 5, 12 );
            anim._id_60C7 = gettime() + _func_0B4( 5000, 25000 );
        }

        anim._id_60C8 = gettime() + _func_0B4( 7000, 13000 );
    }
    else if ( var_0 == "corner_grenade" )
    {
        wait 1.0;

        if ( isdefined( level._id_0318 ) && _func_0F0( self._id_02E2, level._id_0318._id_02E2 ) < 490000 )
        {
            anim._id_6299 = _func_0B4( 10, 30 );
            anim._id_60C6 = gettime() + _func_0B4( 15000, 60000 );
        }
        else
        {
            anim._id_6299 = _func_0B4( 5, 12 );
            anim._id_60C6 = gettime() + _func_0B4( 5000, 25000 );
        }
    }
}
...
_id_9897()
{
    ...
    if ( _func_0EE( self._id_02E2, level._id_0318._id_02E2 ) < 175 )
        return 0;
...
_id_2229()
{
    ...
    var_1 = gettime() + _func_0B4( 25000, 60000 );
    ...
    _id_2224( var_5, _func_0B5( 2.0, 3.0 ) );
    wait 0.05;
...
{
    var_2 = self _meth_8184( "tag_inhand" );
    var_3 = var_2 + ( 0, 0, 20 );
    var_4 = var_2 - ( 0, 0, 20 );
...
_id_6DDB( var_0, var_1 )
{
    ...
    var_2 _meth_809C( var_0, "sounddone" );
...
_id_53B7()
{
    if ( isdefined( self._id_551A ) )
        self _meth_8054( self._id_02E2, self._id_551A );
    else
        self _meth_8054();
}
...
_id_32AF()
{
    ...
    if ( _func_0F0( self._id_02E2, self._id_0142._id_02E2 ) > 147456 )
        return 0;

    if ( _func_0F0( self._id_02E2, self._id_0142._id_02E2 ) < 16384 )
        return 1;

    var_0 = self._id_0142._id_02E2 + self._id_32CC * 3.0;
    var_1 = self._id_0142._id_02E2;

    if ( self._id_0142._id_02E2 != var_0 )
        var_1 = _func_0ED( self._id_0142._id_02E2, var_0, self._id_02E2 );

    if ( _func_0F0( self._id_02E2, var_1 ) < 16384 )
        return 1;
...
_id_07F0( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    else
    {
        ...
        var_7 = var_8[_func_0B2( var_8.size )];
    }
...
_id_664E( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    self _meth_810F( var_0, var_1, var_2, var_3, var_4 );
    self._id_35C5 = animscripts\face::_id_6D9B( var_1, "pain", self._id_35C5 );
}
...
_id_664D( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    self _meth_8112( var_0, var_1, var_2, var_3, var_4, var_5 );
    self._id_35C5 = animscripts\face::_id_6D9B( var_1, "pain", self._id_35C5 );
}
