...
main()
{
    ...
    self._id_07F5 = %saw_gunner_prone_idle;
    self._id_07F4 = %saw_gunner_prone_firing;
...
_id_99B4( var_0 )
{
    ...
    self._id_07F5 = %saw_gunner_prone_idle_mg;
    self._id_07F4 = %saw_gunner_prone_firing_mg;
    self endon( "death" );
