...
_id_2222( var_0, var_1 )
{
    ...
    var_2._id_0362 = ::_id_2228;
    var_2._id_5667 = ::_id_8E29;
    var_2._id_0256 = ::_id_5860;
    var_2._id_367E = ::_id_367E;
    var_2._id_4B63 = ::_id_4B63;
    var_2._id_01CA = ::_id_98A5;
...
_id_8488()
{
    ...
    if ( !isdefined( self._id_1C82 ) )
        self._id_1C82 = gettime() + _func_0B4( 5000, 20000 );
...
_id_590A()
{
    ...
    if ( self.a._id_6E5A == "crouch" )
    {
        ...
        {
            if ( self._id_038E == "cover_right" )
                var_1 = "crouch_r";
            else if ( self._id_038E == "cover_left" )
                var_1 = "crouch_l";
        }

        if ( self._id_22BA _meth_8036( "stand" ) )
        {
            if ( !self._id_22BA _meth_8036( "crouch" ) || _id_8488() )
                var_1 = "stand";
        }
    }
    else if ( self._id_22BA _meth_8036( "crouch" ) )
    {
        if ( !self._id_22BA _meth_8036( "stand" ) || _id_8488() )
        {
            var_1 = "crouch";
...
_id_8410()
{
    ...
    if ( self.a._id_2227 == "over" )
        return var_0 < self._id_024D || self._id_037C < var_0;
...
_id_3F3D( var_0, var_1 )
{
    ...
    if ( isdefined( var_0 ) && self.a._id_6E5A == "crouch" && ( var_3 > self._id_024D && self._id_037C > var_3 ) )
    ...
    if ( self._id_2225 == "up" )
    {
        if ( animscripts\utility::_id_51B0() )
        {
            ...
            if ( isdefined( var_1 ) )
            {
                ...
                var_5 = animscripts\combat_utility::_id_4083( var_1, self _meth_80AA() + ( var_6[0] * 12, var_6[1] * 12, var_6[2] * 12 ) );
            }
...
_id_3F18()
{
    ...
    else if ( self._id_012E && isdefined( self._id_840F ) )
        var_0 = self._id_22BA animscripts\utility::_id_4176( self._id_840F );
...
_id_8E27()
{
    ...
    var_5 = _id_8E28();
    self._id_034C = 0;
    self _meth_8112( "stepout", var_3, %animscript_root, 1, 0.2, var_5 );
    _id_2221( var_3 );
    ...
    if ( var_4 )
    {
        self._id_8E2A = self.angles[1] + _func_093( var_3, 0, 1 );
...
_id_7104()
{
    ...
    if ( !self _meth_81C7( var_5, !self._id_0424 ) )
        return 0;
    ...
    self _meth_8112( "rambo", var_4, %body, 1, 0, 1 );
    _id_2221( var_4 );
...
_id_1ADB( var_0 )
{
    ...
    if ( var_0 )
    {
        ...
        return self _meth_81C8( var_2, self._id_22BA._id_02E2, var_1 );
    }
    else
        return self _meth_81C7( self._id_22BA._id_02E2, var_1 );
}
...
_id_74E1()
{
    ...
    if ( self.a._id_2227 != "lean" && var_0 && animscripts\utility::_id_0C4F( var_1 + "_reload" ) && _func_0B3( 100 ) < 75 )
    {
    ...
    self _meth_8115( "hide", var_2, 1, 0.1, var_4 );
    _id_2221( var_2 );
...
_id_14AB()
{
    ...
    self _meth_8112( "blindfire", var_0, %body, 1, 0, 1 );
    _id_2221( var_0 );
...
_id_5860( var_0 )
{
    ...
    self _meth_8112( "looking_end", var_1, %body, 1, 0.1, 1.0 );
    _id_2221( var_1 );
...
_id_5171()
{
    ...
    if ( self._id_04A7 == "allies" && level._id_0318 _id_A5A4::_id_50A9() )
    {
        if ( _id_A5A4::_id_6B91( var_1, 0.95, undefined, level._id_0318 ) )
            return 0;
    }

    var_4 = var_1 + anglestoforward( var_0 ) * 30;
    return _func_08E( var_1, var_4, 1, self );
}
...
_id_67B9()
{
    ...
    self _meth_8111( "looking_start", var_0, %body, 1, 0.2, 1 );
    _id_2221( var_0 );
...
_id_1AEE()
{
    return self _meth_81C7( self._id_22BA._id_02E2, !self._id_0424 );
}
...
_id_2228()
{
    ...
    if ( animscripts\utility::_id_51A3( self._id_0513 ) && animscripts\utility::_id_0C4F( "shotgun_reload" ) )
        var_0 = "shotgun_reload";

    var_1 = animscripts\utility::_id_0C51( var_0 );
    self _meth_810F( "cornerReload", var_1, 1, 0.2 );
    _id_2221( var_1 );
...
_id_4097( var_0 )
{
    ...
    if ( var_3 == "cover_swim_up" )
    {
        ...
        return self._id_22BA._id_02E2 + var_4 * var_0;
    }
    ...
    return self._id_22BA._id_02E2 + ( var_2[0], var_2[1], 0 );
}
...
_id_4B63()
{
    ...
    {
        behaviorstransitiontocorrectpose();
        var_0 = _func_0B2( 2 ) == 0 && isdefined( self.a._id_0CD8["alert_idle_twitch"] ) && animscripts\utility::_id_0C4F( "alert_idle_twitch" );
...
{
    if ( var_1 )
        self _meth_8112( "idle", var_0, %body, 1, 0.1, 1 );
    else
        self _meth_8111( "idle", var_0, %body, 1, 0.1, 1 );
...
_id_9720( var_0 )
{
    ...
    self _meth_8112( "changeStance", var_1, %body );
    _id_2221( var_1 );
    _id_7DBC( var_0 );
...
_id_4281( var_0, var_1, var_2 )
{
    ...
    self _meth_8112( "coveranim", var_0, %body, 1, var_1 );
    _id_2221( var_0 );
...
_id_7EC0()
{
    if ( self._id_0424 && isdefined( self._id_02BB ) )
    {
        _id_7ECC();
        return;
    }
