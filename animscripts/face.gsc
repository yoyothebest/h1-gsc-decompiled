...
_id_6D9A( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            self _meth_806C( var_1, "animscript facesound" + var_3, 1 );
            thread _id_A01C( var_3 );
        }
    }
    else
        self _meth_806C( var_1 );
    ...
    else
    {
        ...
        else
        {
            if ( var_2 >= self.a._id_2510 )
            {
                ...
                {
                    _id_A510::_id_2B04();
                    self _meth_810F( "animscript faceanim", var_0, 1, 0.1, 1 );
                    self.a._id_35C4 = 0;
                    thread _id_A01D();
                }
                else
                ...
                if ( isdefined( var_1 ) )
                {
                    self _meth_806C( var_1, "animscript facesound", 1 );
                    self.a._id_35C8 = 0;
                    thread _id_A01C();
                }
...
_id_6D9B( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        if ( isdefined( var_2 ) && var_2 >= 0 && var_2 < anim._id_35C1[var_1].size )
            ...
            var_3 = _func_0B2( anim._id_35C1[var_1].size );
...
_id_312E( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
        var_1 = _func_0E9( var_0, var_2 + 0.5, var_1 + var_2 ) - var_2;
...
_id_3D66()
{
    ...
    var_0 = self _meth_8185( "tag_eye" );
    var_1 = self _meth_8185( "jnt_eyelid_TR" );
    var_2 = self _meth_8185( "jnt_eyelid_TL" );
    var_3 = _func_0EB( _func_0BE( var_0[0] - var_1[0] ) );
    var_4 = _func_0EB( _func_0BE( var_0[0] - var_2[0] ) );
    ...
    if ( _func_0EB( var_3 - self._id_6F3D ) > 5 || _func_0EB( var_4 - self._id_6F3E ) > 5 )
    {
        self._id_6F3D = var_3;
        self._id_6F3E = var_4;
    }
    ...
    if ( isdefined( self._id_35B0 ) && self._id_35B0 > 4 && isdefined( self._id_038E ) && self._id_038E != "scripted" && self._id_038E != "death" )
    {
