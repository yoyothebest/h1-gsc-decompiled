...
init()
{
    ...
    {
        _func_0D6( "ai_grenadeReturn_minDistSqr", _func_0E8( 0 ) );
        _func_0D6( "ai_grenadeReturn_orientToToss", 1 );
    }

    var_0 = should_use_mw_cover_moveup_behaviour();
    _func_0D6( "ai_useCoverMoveUpBehaviour", var_0 );
    var_1 = should_use_cover_suppression_behaviour();
    _func_0D6( "ai_suppressionAffectsCover", var_1 );
    ...
    _func_0D6( "xanim_disableFootIK", !var_2 );
...
{
    orient_to_point_until_flags( var_0._id_02E2, var_1 );
}
...
{
    if ( isdefined( var_2 ) && isdefined( self._id_029C ) && !_id_A5A4::_id_4749( self._id_029C, var_2 ) )
    {
...
_id_0D56( var_0, var_1 )
{
    ...
    if ( var_2 || var_3 )
    {
        if ( var_2 )
        {
            var_4 = _func_1D3( level._id_78AC[var_1] );
        ...
        if ( var_3 )
        {
            var_4 = _func_1D3( level._id_78BA[var_1] );
    ...
    var_10 = _func_1D3( level._id_78AC );
    var_10 = common_scripts\utility::_id_0CDD( var_10, _func_1D3( level._id_78BA ) );
...
_id_0BC6( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    else
    {
        ...
        if ( _func_0CE( level._id_78AC[var_5][var_1] ) )
        {
            var_0 _meth_8145( level._id_78AC[var_5][var_1][0], 1, 0, 0 );
            var_0 _meth_8119( level._id_78AC[var_5][var_1][0], 0 );
        }
        else
        {
            var_0 _meth_8145( level._id_78AC[var_5][var_1], 1, 0, 0 );
            var_0 _meth_8119( level._id_78AC[var_5][var_1], 0 );
        }
    }
}
...
{
    if ( _func_0CF( var_0 ) && var_0 _id_A5A4::_id_2CE7() )
        return;
    ...
    for (;;)
    {
        ...
        foreach ( var_34, var_5 in var_0 )
        {
            ...
            if ( isdefined( level._id_78B0[var_31] ) && isdefined( level._id_78B0[var_31][var_11 + var_1] ) )
                var_6 _meth_809C( level._id_78B0[var_31][var_11 + var_1] );

            if ( isdefined( level._id_78AC[var_31] ) && isdefined( level._id_78AC[var_31][var_1] ) && ( !_func_0CF( var_6 ) || !var_6 _id_A5A4::_id_2CE7() ) )
                var_27 = 1;
...
{
    if ( isdefined( var_3 ) && !_func_2C2( var_3 ) )
    {
        var_6 = var_3;
        var_3 = undefined;
    }
...
_id_0C1D( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    foreach ( var_31, var_8 in var_0 )
    {
        ...
        if ( isdefined( level._id_78AC[var_26] ) && isdefined( level._id_78AC[var_26][var_1] ) && ( !_func_0CF( var_8 ) || !var_8 _id_A5A4::_id_2CE7() ) )
            var_22 = 1;

        if ( isdefined( level._id_78B0[var_26] ) && isdefined( level._id_78B0[var_26][var_1] ) )
            var_8 _meth_809C( level._id_78B0[var_26][var_1] );
        ...
        if ( var_22 )
        {
            ...
            if ( _func_1AD( var_8 ) )
            {
                ...
                var_8 _meth_8113( var_18, var_29, 1, var_27 );
            }
...
_id_61BD( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    for (;;)
    {
        ...
        var_29 = _func_122( var_20, 0, 3 );

        if ( var_29 == "ps_" )
        {
            var_30 = _func_122( var_20, 3 );
        ...
        if ( var_29 == "fx_" )
        {
            var_31 = _func_124( _func_123( _func_122( var_20, 3 ) ), ",() " );
            ...
            if ( var_31.size == 2 )
            {
                ...
                {
                    playfxontag( level._id_058F[var_31[0]], var_0, var_31[1] );
                    continue;
                }
            }
            else if ( var_31.size == 3 )
            {
                ...
                {
                    playfxontag( level._id_058F[var_31[1]], var_0, var_31[2] );
                    continue;
                }
                else if ( var_31[0] == "stopfxontag" )
                {
                    stopfxontag( level._id_058F[var_31[1]], var_0, var_31[2] );
                    continue;
                }
                else if ( var_31[0] == "killfxontag" )
                {
                    killfxontag( level._id_058F[var_31[1]], var_0, var_31[2] );
                    continue;
                }
            }
            else if ( var_31.size == 11 )
            {
                var_32 = ( _func_0BD( var_31[2] ), _func_0BD( var_31[3] ), _func_0BD( var_31[4] ) );
                var_33 = ( _func_0BD( var_31[5] ), _func_0BD( var_31[6] ), _func_0BD( var_31[7] ) );
                var_34 = ( _func_0BD( var_31[8] ), _func_0BD( var_31[9] ), _func_0BD( var_31[10] ) );
                playfx( level._id_058F[var_31[1]], var_32, var_33, var_34 );
            }
        }

        var_29 = _func_122( var_20, 0, 4 );

        if ( var_29 == "psr_" )
        {
            var_30 = _func_122( var_20, 4 );
...
_id_0BD6( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0["playersound"] ) )
        level._id_0318 _meth_809C( var_0["playersound"] );
    ...
    if ( isdefined( var_0["selftag"] ) )
    {
        if ( isdefined( var_0["effect"] ) )
        {
            ...
            playfxontag( level._id_058F[var_0["effect"]], var_1, var_0["selftag"] );
        ...
        if ( isdefined( var_0["stop_effect"] ) )
            stopfxontag( level._id_058F[var_0["stop_effect"]], var_1, var_0["selftag"] );

        if ( isdefined( var_0["swap_part_to_efx"] ) )
        {
            playfxontag( level._id_058F[var_0["swap_part_to_efx"]], var_1, var_0["selftag"] );
            var_1 _meth_804A( var_0["selftag"] );
        }
    ...
    if ( isdefined( var_0["tag"] ) && isdefined( var_0["effect"] ) )
        playfxontag( level._id_058F[var_0["effect"]], var_3, var_0["tag"] );

    if ( isdefined( var_0["selftag"] ) && isdefined( var_0["effect_looped"] ) )
        playfxontag( level._id_058F[var_0["effect_looped"]], var_1, var_0["selftag"] );

    if ( isdefined( var_0["lui_notify"] ) )
        _func_245( var_0["lui_notify"], 0 );
...
_id_9492( var_0, var_1, var_2, var_3 )
{
    ...
    var_6 = 0;
    var_7 = spawnstruct();
    var_7._id_554A = self _meth_8184( var_0 );
    var_7._id_491F = 0;
...
_id_487D( var_0, var_1 )
{
    ...
    while ( self _meth_8184( var_1 )[2] > var_0 )
        wait 0.05;

    self _meth_804A( var_1 );
}
...
_id_92AD( var_0 )
{
    ...
    var_0._id_24F5 = self _meth_8184( var_0._id_6699 );
    ...
    if ( var_0._id_24F5 != var_0._id_554A )
    {
        ...
        if ( !_func_08D( var_0._id_554A, var_0._id_24F5, 0, self ) )
        {
            var_2 = _func_06B( var_0._id_554A, var_0._id_24F5, 0, self );
...
_id_0BA8( var_0, var_1 )
{
    ...
    var_0._id_7B42[var_2] _meth_80B3( var_1["create model"] );
    var_0._id_7B42[var_2]._id_02E2 = var_0 _meth_8184( var_1["selftag"] );
    var_0._id_7B42[var_2].angles = var_0 _meth_8185( var_1["selftag"] );
}
...
_id_0C05( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < var_0._id_7B42.size; var_2++ )
    {
        if ( isdefined( var_1["explosion"] ) )
        {
            ...
            var_3 *= 120;
            var_3 += var_0._id_7B42[var_2]._id_02E2;
            playfx( level._id_058F[var_1["explosion"]], var_0._id_7B42[var_2]._id_02E2 );
            _func_189( var_0._id_7B42[var_2]._id_02E2, 350, 700, 50 );
        }
...
_id_445B( var_0 )
{
    ...
    var_1 = self _meth_8184( var_0["tag"] );
    var_2 = self _meth_8185( var_0["tag"] );
    var_3 = 0;

    if ( isdefined( var_0["suspend"] ) )
        var_3 = var_0["suspend"];

    var_4 = spawn( "weapon_" + self._id_0513, var_1, var_3 );
    var_4.angles = var_2;
    self._id_445E = var_4;
...
_id_3CCA( var_0, var_1 )
{
    ...
    {
        var_2 = var_1 _meth_8184( var_0 );
        var_3 = var_1 _meth_8185( var_0 );
    }
    else
    {
...
_id_5D4C( var_0 )
{
    ...
    for (;;)
    {
        ...
        {
            var_6 = var_5._id_01C3;

            if ( isdefined( var_5._id_716E ) )
                var_6 = var_5._id_716E;

            var_7 = _func_0EE( var_5._id_02E2, var_6 );
...
_id_0BF2( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_4 ) && !_func_2C2( var_4 ) )
    {
        var_6 = var_4;
        var_3 = var_5;
        var_4 = undefined;
...
_id_0C03( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    foreach ( var_16 in var_0 )
    {
        ...
        {
            if ( _func_0CE( level._id_78AC[var_17][var_1] ) )
                var_18 = _func_06F( var_10, var_11, level._id_78AC[var_17][var_1][0] );
            else
                var_18 = _func_06F( var_10, var_11, level._id_78AC[var_17][var_1] );
        }
        else
            var_18 = var_10;
...
_id_0BFA( var_0, var_1, var_2 )
{
    ...
    {
        if ( _func_1A1( var_4 ) && var_4._id_0C00 )
        {
            var_4._id_01C4 = var_4._id_63CC;
            var_4._id_03A8 = undefined;
            var_4._id_0411 = 0;
        }
...
_id_0C42( var_0, var_1, var_2 )
{
    ...
    foreach ( var_7 in var_0 )
    {
        var_8 = _func_06F( var_4, var_5, level._id_78AC[var_7._id_0C72][var_1] );
        var_9 = _func_070( var_4, var_5, level._id_78AC[var_7._id_0C72][var_1] );
...
_id_0BE4( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_11 = _func_06F( var_7, var_8, level._id_78AC[var_10._id_0C72][var_1] );
        var_12 = _func_070( var_7, var_8, level._id_78AC[var_10._id_0C72][var_1] );

        if ( _func_0CF( var_10 ) )
            continue;

        var_10 _meth_82AA( var_11, var_3, var_4, var_5 );
        var_10 _meth_82B1( var_12, var_3, var_4, var_5 );
    }
}
...
_id_0BD3( var_0, var_1, var_2 )
{
    ...
    var_4 = var_3["origin"];
    var_5 = var_3["angles"];
    var_6 = _func_06F( var_4, var_5, level._id_78AC["generic"][var_1] );
    var_7 = _func_070( var_4, var_5, level._id_78AC["generic"][var_1] );

    if ( _func_0CF( var_0 ) )
        var_0 _meth_81C9( var_6 );
    else
    {
        var_0._id_02E2 = var_6;
        var_0.angles = var_7;
    }
}
...
_id_0C34( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_4["origin"];
    var_6 = var_4["angles"];
    var_7 = _func_06F( var_5, var_6, level._id_78AC[var_1][var_2] );
    var_8 = _func_06F( var_5, var_6, level._id_78AC[var_1][var_2] );
    var_9 = spawn( "script_model", var_7 );
    var_9 _meth_80B3( var_0 );
    var_9.angles = var_8;
    return var_9;
}
...
_id_0C36( var_0, var_1, var_2 )
{
    ...
    foreach ( var_8 in var_0 )
    {
        var_9 = _func_06F( var_4, var_5, level._id_78AC[var_8._id_0C72][var_1] );
        var_8._id_02E2 = var_9;
    }
}
...
_id_716D( var_0, var_1, var_2 )
{
    ...
    var_4 = _func_1A1( self ) && _func_0F0( self._id_02E2, var_1 ) <= 2500;
...
_id_136D( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( self.a.animreachcustomradius ) )
        self._id_01C4 = self.a.animreachcustomradius;
...
_id_7172( var_0 )
{
    ...
    self._id_63DD = self._id_02F6;
    self._id_63DE = self._id_02F7;
    self._id_02F6 = 128;
    self._id_02F7 = 128;
...
{
    _id_0BB0( 0 );
    self._id_017D = self._id_382C;
    self._id_382C = undefined;
    self._id_02F6 = self._id_63DD;
    self._id_02F7 = self._id_63DE;
...
{
    if ( _func_2C2( var_3 ) || _func_2C2( var_4 ) )
    {
...
_id_0BF4( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( _func_0CE( level._id_78AC[var_9][var_1] ) )
            var_10 = level._id_78AC[var_9][var_1][0];
        else
            var_10 = level._id_78AC[var_9][var_1];

        var_7 = _func_06F( var_7, var_8, var_10 );
    }
    ...
    if ( isdefined( var_3 ) )
        var_11._id_04D9 = var_3;
    else
        var_11._id_04D9 = self._id_04D9;

    if ( isdefined( var_4 ) )
        var_11._id_0D27 = var_4;
    else
        var_11._id_0D27 = self _meth_8035();

    var_0._id_03A8 = var_11;
...
anim_reach_and_arrive_facing_anim_solo( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( _func_0CE( level._id_78AC[var_4][var_1] ) )
            var_8 = level._id_78AC[var_4][var_1][0];
        else
            var_8 = level._id_78AC[var_4][var_1];

        var_6 = _func_06F( var_6, var_7, var_8 );
        var_7 = _func_070( var_6, var_7, var_8 );
    }
...
get_to_transition_point( var_0, var_1, var_2, var_1, var_3, var_4 )
{
    ...
    while ( _func_0F0( self._id_02E2, var_1 ) > var_6 )
        wait 0.05;
    ...
    var_6 = _func_0F3( animscripts\utility::_id_5868( "cover_trans_dist", var_3, var_1.approach_number ) );
...
calculate_approach_number( var_0, var_1, var_2, var_3 )
{
    ...
    var_4 = _func_114( var_1 - var_0._id_02E2 );
    var_5 = spawnstruct();
...
{
    if ( isstring( var_4 ) || _func_2B6( var_5 ) )
    {
...
_id_73BC( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !isdefined( var_5 ) || !_func_0CE( var_5 ) || var_5.size < 1 )
        return;
...
_id_0BC2( var_0, var_1, var_2 )
{
    ...
    var_0 _meth_810F( "face_done_" + var_1, var_2, 1, 0, 1 );
...
_id_0BC4( var_0, var_1 )
{
    ...
    if ( !isdefined( var_1 ) && isdefined( self._id_025D ) )
        var_1 = self._id_025D;
...
_id_7EC3( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    else if ( _func_0CE( level._id_78AC[var_5][var_0] ) )
    ...
    if ( _func_0CF( self ) )
    {
        var_7 = _func_06F( var_1, var_2, var_6 );
        var_8 = _func_070( var_1, var_2, var_6 );
        ...
        self _meth_8278( _func_06F( var_1, var_2, var_6 ), _func_070( var_1, var_2, var_6 ) );
    else
    {
        self._id_02E2 = _func_06F( var_1, var_2, var_6 );
        self.angles = _func_070( var_1, var_2, var_6 );
    }
}
...
_id_0C12( var_0, var_1, var_2 )
{
    ...
    self _meth_8113( "single anim", var_4, 1, 0, var_1 );
}
