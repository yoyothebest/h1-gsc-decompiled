...
_id_1188( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    self._id_586A._id_588F[var_10._id_02A7] = var_10;
...
_id_118A( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11._id_86D9 = [];
    var_11 _id_11D6();
    self._id_6497._id_64A2[var_11._id_02A7] = var_11;
...
_id_1186( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    self._id_13A3._id_13A6[var_6._id_02A7] = var_6;
...
_id_1180( var_0 )
{
    ...
    if ( isstring( var_0 ) )
    {
        if ( _func_123( var_0 ) == "all" )
            var_1._id_588F[0] = "all";
        else if ( _func_123( var_0 ) == "none" )
...
_id_11DB( var_0, var_1 )
{
    ...
    var_0 = _func_0E9( var_0, 0, 1 );
    var_1 = _func_0E9( _id_A5DC::_id_0F30( 1, var_1 ), 0, 60 );
    var_5 = var_3;
    var_2 notify( var_5 );
    var_2 endon( var_5 );
    ...
    for (;;)
    {
        if ( var_9 < 0 )
        {
            if ( var_2._id_59D9 > var_0 )
                var_2._id_59D9 = _func_0E1( 0, var_2._id_59D9 + var_9 );
            else
                break;
        }
        else if ( var_9 > 0 )
        {
            if ( var_2._id_59D9 < var_0 )
                var_2._id_59D9 = _func_0BF( 1.0, var_2._id_59D9 + var_9 );
            else
                break;
        }
...
_id_9ED8( var_0 )
{
    ...
    if ( isstring( var_0 ) )
    {
        ...
        if ( isdefined( var_3 ) & _func_0CE( var_3._id_4E88 ) )
...
_id_11AC( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_8 in var_5._id_586A._id_588F )
    {
        ...
        var_9._id_86D9 = [];
        var_9._id_9F3C = 1.0;
        var_6._id_5876[var_8._id_02A7] = var_9;
    }
    ...
    foreach ( var_8 in var_5._id_6497._id_64A2 )
    {
        ...
        var_9._id_24CF = var_6 _id_11AD( var_8 );
        var_9._id_86D9 = [];
        var_6._id_649A[var_8._id_02A7] = var_9;
    }
    ...
    foreach ( var_8 in var_5._id_13A3._id_13A6 )
    {
        ...
        var_9._id_704A = var_8;
        var_9._id_24CF = var_6 _id_11AD( var_8 );
        var_6._id_13A4[var_8._id_02A7] = var_9;
    }
...
_id_11EA( var_0 )
{
    if ( !isdefined( self._id_5085 ) )
    {
        ...
        var_0 = _func_0E1( 0.01, _id_A5DC::_id_0F30( var_1._id_35F5, var_0 ) );
...
_id_11EF()
{
    ...
    for (;;)
    {
        ...
        var_3 = gettime();
        var_8 = _func_0EF( var_0._id_9C78._id_02E2, level._id_0318._id_02E2 );
...
_id_11ED( var_0 )
{
    ...
    foreach ( var_7, var_3 in var_0._id_24CF._id_67F7 )
    {
        if ( var_7 == "volume" )
        {
            ...
            {
                var_0._id_35E0 = _func_0BF( var_0._id_35E0 + var_0._id_35DE, 1.0 );
...
_id_11A5( var_0, var_1, var_2 )
{
    ...
    var_7 = _func_0E1( 1, var_2 / _id_11A1() );
    var_8 = var_6 / var_7;
    ...
    for (;;)
    {
        if ( var_2 < 0 )
        {
            if ( var_0._id_9F3C > var_1 )
                var_0._id_9F3C = _func_0E1( 0, var_0._id_9F3C + var_2 );
            else
                break;
        }
        else if ( var_2 > 0 )
        {
            if ( var_0._id_9F3C < var_1 )
                var_0._id_9F3C = _func_0BF( 1.0, var_0._id_9F3C + var_2 );
            else
                break;
        }
...
_id_11E5( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_12 = 0;
        var_11 = gettime();
        var_24 = _func_0EF( var_3._id_9C78._id_02E2, level._id_0318._id_02E2 );
...
{
    var_1 = self;
    var_0 = _func_0E1( 0.01, _id_A5DC::_id_0F30( 0.05, var_0 ) );
...
{
    var_0 = _id_11CA();
    return _func_0EF( var_0._id_02E2, level._id_0318._id_02E2 );
}

_id_4E47()
{
    var_0 = _id_11CA();
    return _func_0EE( var_0._id_02E2, level._id_0318._id_02E2 );
}

_id_4E57()
{
    var_0 = _id_11CA();
    return var_0 _meth_8286();
}

_id_4E55()
{
    var_0 = _id_11CA();
    var_1 = _func_0F1( var_0 _meth_8283() * 0.0568182 );
    return var_1;
}
...
_id_4E54()
{
    ...
    var_3 = var_1 - var_2;
    var_4 = _func_0F1( var_3 ) * 0.0568182;
    return var_4;
}
...
{
    var_0 = _id_11CA();
    return _func_0F1( var_0 _id_A57B::_id_3D3B() ) * 0.00125;
}

_id_4E4C()
{
    var_0 = _id_11CA();
    return _func_0F1( var_0 _id_A57B::_id_3D3C() ) * 0.00125;
}

_id_4E49()
{
    var_0 = _id_11CA();
    return _func_24C( var_0._id_02E2, var_0 _meth_8283(), level._id_0318._id_02E2, level._id_0318 _meth_8336() );
}

_id_4E4A()
{
    var_0 = _id_11CA();
    return _func_24C( var_0._id_02E2, var_0 _meth_8283(), level._id_0318._id_02E2, level._id_0318 _meth_8336(), 2, 5 );
}

_id_4E4B()
{
    var_0 = _id_11CA();
    return _func_24C( var_0._id_02E2, var_0 _meth_8283(), level._id_0318._id_02E2, level._id_0318 _meth_8336(), 1, 0.5 );
}
...
_id_1192( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    {
        var_7 = var_1 - var_3;
        var_8 = _func_114( var_7 );
        var_9 = var_2 - var_0;
        var_10 = var_8 * _func_0F6( var_8, var_9 );
        var_11 = var_9 - var_10;
        var_2 = var_0 + var_10 + var_11 / var_4;
    }

    var_12 = _func_114( var_0 - var_2 );
    var_13 = _func_0F6( var_1, var_12 );
    var_14 = _func_0F6( var_3, var_12 );
    var_15 = ( var_6 + var_14 ) / ( var_6 + var_13 );
    var_15 = _func_1F3( var_15, var_5 );
    var_15 = _func_0E9( var_15, 0.1, 1.99 );
    return var_15;
}
...
{
    var_0 = _id_11CA();
    return _func_0E1( _func_0BE( _func_0EB( var_0.angles[0] ) ), _func_0BE( _func_0EB( var_0.angles[2] ) ) );
}

_id_4E46()
{
    var_0 = _id_11CA();
    return _func_0BA( anglestoup( var_0.angles )[2] );
}
...
_id_4E53()
{
    ...
    if ( _id_11CC() )
    {
        ...
        if ( var_3 > var_1._id_0B91 + var_2 )
        {
            ...
            var_4 = _func_06B( var_1._id_02E2, var_1._id_02E2 - ( 0, 0, 360 ), 0 );
        ...
        var_0 = _func_0E9( var_1._id_0B92, 0, 1.0 );
    }
...
_id_4E77()
{
    ...
    var_1 = _func_0BE( var_1 );
    var_1 = _func_0E9( var_1, 0, 90 );
    var_1 = _id_11D3( var_1, 0, 90 );
    var_2 = level._id_0318 _meth_830A();
    var_3 = _func_0BE( var_2[0] );
    return 0;
}
...
_id_4E78()
{
    ...
    var_2 = _func_0BE( var_2 );
    var_3 = _func_0F2( ( var_1, var_2, 0 ) );
    var_3 = _func_0E9( var_3, 0, 135 );
    var_4 = _id_11D3( var_3, 0, 135 );
    var_5 = level._id_0318 _meth_830A();
    var_6 = _func_0F2( var_5 );
    return var_4 * var_6;
}
...
_id_4E65()
{
    var_0 = _id_4E64();
    var_1 = _id_4E56();
    var_2 = var_1 + _func_0BE( var_0 ) * 0.1;
    return var_1 + _func_0BE( var_0 ) * 0.1;
}

_id_4E7C()
{
    var_0 = level._id_0318 _meth_830A();
    var_1 = _func_0BE( var_0[0] );
    var_2 = _func_0BE( var_0[1] );
...
_id_11E3( var_0, var_1 )
{
    ...
    if ( isstring( var_5 ) )
    {
        ...
        var_4 = spawn( "script_origin", var_6._id_02E2 );
        var_4 _meth_804F( var_6, "tag_origin", var_2._id_88A1, ( 0, 0, 0 ) );
        var_4 _meth_8071( 0 );
...
_id_11CB( var_0 )
{
    ...
    var_1 _id_11A8( var_2._id_02A7 );
    var_1 _id_11F0( var_0 );
    var_1 _id_11D8( var_2._id_02A7 );
}
...
_id_11F0( var_0 )
{
    ...
    if ( isdefined( var_3._id_2FB4 ) )
    {
        ...
        for ( var_8 = var_3._id_02A7; _id_11AA( var_0._id_86D9 ) && var_6 < var_7; var_6 += 0.1 )
        {
...
_id_11CF( var_0, var_1 )
{
    ...
    if ( isdefined( var_3._id_3335 ) )
        ...
        var_4 = _func_24D( var_0, var_3._id_3332 );
...
_id_11E2( var_0 )
{
    ...
    for ( var_9 = 0; var_9 < var_5; var_9++ )
    {
        ...
        var_11 = spawn( "script_origin", var_3._id_02E2 );
        var_11 _meth_804F( var_3, "tag_origin", var_6, ( 0, 0, 0 ) );
        var_11 _meth_8071( 0 );
...
{
    var_1 = self;
    var_0 = _func_0E1( 0.05, _id_A5DC::_id_0F30( 0.05, var_0 ) );

    if ( isdefined( var_1 ) )
    {
        var_1 _meth_8070( 0, var_0 );
        wait(var_0);
